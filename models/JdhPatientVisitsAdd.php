 ...
 * Page class
 */
class JdhPatientVisitsAdd extends JdhPatientVisits
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "JdhPatientVisitsAdd";
        ...
        switch ($this->CurrentAction) {
            case "copy": // Copy an existing record
                if (!$rsold) { // Record not loaded
                    ...
                    $this->terminate("jdhpatientvisitslist"); // No matching record, return to list
                    return;
                }
                break;
            case "insert": // Add new record
                ...
                if ($this->addRow($rsold)) { // Add successful
                    ...
                    if (GetPageName($returnUrl) == "jdhpatientvisitslist") {
                        $returnUrl = $this->addMasterUrl($returnUrl); // List page, return to List page with correct master key if necessary
                    } elseif (GetPageName($returnUrl) == "jdhpatientvisitsview") {
                    ...
                    if ($this->IsModal && $this->UseAjaxActions) {
                        ...
                        if (GetPageName($returnUrl) != "jdhpatientvisitslist") {
                            ...
                            $returnUrl = "jdhpatientvisitslist"; // Return list page content
                        }
                    }
    ...
    public function renderRow()
    {
        ...
        // visit_date
        $this->visit_date->RowCssClass = "row";
    ...
    protected function getAddRow()
    {
        ...
        // visit_description
        $this->visit_description->setDbValueDef($rsnew, $this->visit_description->CurrentValue, false);
    ...
    protected function restoreAddFormFromRow($row)
    {
        ...
        if (isset($row['visit_description'])) { // visit_description
            $this->visit_description->setFormValue($row['visit_description']);
        }
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("jdhpatientvisitslist"), "", $this->TableVar, true);
