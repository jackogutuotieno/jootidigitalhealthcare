...
class JdhServices extends DbTable
{
    ...
    public function __construct()
    {
        ...
        $this->service_id->SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"];
        ...
        $this->category_id->Lookup = new Lookup('category_id', 'jdh_service_category', false, 'category_id', ["category_name","","",""], '', '', [], ["x_subcategory_id"], [], [], [], [], '', '', "`category_name`");
        ...
        // service_description $tbl, $fldvar, $fldname, $fldexp, $fldbsexp, $fldtype, $fldsize, $flddtfmt, $upload, $fldvirtualexp, $fldvirtual, $forceselect, $fldvirtualsrch, $fldviewtag = "", $fldhtmltag
    ...
    {
        global $Language;
        if ($pageName == "jdhservicesview") {
            return $Language->phrase("View");
        } elseif ($pageName == "jdhservicesedit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "jdhservicesadd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "JdhServicesView";
            case Config("API_ADD_ACTION"):
                return "JdhServicesAdd";
            case Config("API_EDIT_ACTION"):
                return "JdhServicesEdit";
            case Config("API_DELETE_ACTION"):
                return "JdhServicesDelete";
    ...
    public function getDeleteUrl()
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("jdhservicesdelete");
        }
    }
