 ...
 * Page class
 */
class JdhPatientServicesDelete extends JdhPatientServices
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "JdhPatientServicesDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "jdhpatientservicesdelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("jdhpatientserviceslist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("jdhpatientserviceslist"); // Return to list
                return;
            }
        }
    ...
    protected function deleteRows()
    {
        ...
        foreach ($rsold as $row) {
            ...
            $thisKey .= $row['patient_service_id'];
