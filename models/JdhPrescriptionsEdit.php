 ...
 * Page class
 */
class JdhPrescriptionsEdit extends JdhPrescriptions
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "JdhPrescriptionsEdit";
    ...
    // CSS class/style
    public $CurrentPageName = "jdhprescriptionsedit";
    ...
    public function run()
    {
        ...
        if (IsApi()) {
            // Load key values
            $loaded = true;
            if (($keyValue = Get("prescription_id") ?? Key(0) ?? Route(2)) !== null) {
                $this->prescription_id->setQueryStringValue($keyValue);
                $this->prescription_id->setOldValue($this->prescription_id->QueryStringValue);
            } elseif (Post("prescription_id") !== null) {
                $this->prescription_id->setFormValue(Post("prescription_id"));
                $this->prescription_id->setOldValue($this->prescription_id->FormValue);
            } else {
