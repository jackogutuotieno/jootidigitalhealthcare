 ...
 * Page class
 */
class Dashboard2 extends ReportTable
{
    use MessagesTrait;
    ...
    public $CurrentPageName = "dashboard2";
     ...
     * Render item
     *
     * @param PhpRenderer $view PHP-View renderer
     * @param int $id Item index
     * @return string HTML
     */
    public function renderItem($view, $id)
    {
        global $Page;
        $content = "";
        if ($this->LoadOnInit) {
