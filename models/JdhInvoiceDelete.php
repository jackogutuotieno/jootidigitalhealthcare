 ...
 * Page class
 */
class JdhInvoiceDelete extends JdhInvoice
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "JdhInvoiceDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "jdhinvoicedelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("jdhinvoicelist"); // Prevent SQL injection, return to list
            return;
        }
