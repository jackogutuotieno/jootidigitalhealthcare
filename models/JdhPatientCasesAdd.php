 ...
 * Page class
 */
class JdhPatientCasesAdd extends JdhPatientCases
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "JdhPatientCasesAdd";
    ...
    // CSS class/style
    public $CurrentPageName = "jdhpatientcasesadd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($rsold)) {
                    ...
                    } elseif (GetPageName($returnUrl) == "jdhpatientcasesview") {
    ...
    protected function addRow($rsold = null)
    {
        ...
        // symtoms
        $this->symtoms->setDbValueDef($rsnew, $this->symtoms->CurrentValue, "", false);

        // fasting_blood_sugar
        $this->fasting_blood_sugar->setDbValueDef($rsnew, $this->fasting_blood_sugar->CurrentValue, null, false);
