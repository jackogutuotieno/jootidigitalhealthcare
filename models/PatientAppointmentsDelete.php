 ...
 * Page class
 */
class PatientAppointmentsDelete extends PatientAppointments
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PatientAppointmentsDelete";
    ...
    public $CurrentPageName = "patientappointmentsdelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("patientappointmentslist"); // Prevent SQL injection, return to list
            return;
        }
