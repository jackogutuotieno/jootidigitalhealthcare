 ...
 * Page class
 */
class JdhServicesView extends JdhServices
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "JdhServicesView";
    ...
    // CSS class/style
    public $CurrentPageName = "jdhservicesview";
    ...
    public function __construct()
    {
        ...
        if (($keyValue = Get("service_id") ?? Route("service_id")) !== null) {
            $this->RecKey["service_id"] = $keyValue;
        }
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("service_id") ?? Route("service_id")) !== null) {
            ...
            $this->RecKey["service_id"] = $this->service_id->FormValue;
        } elseif (IsApi() && ($keyValue = Key(0) ?? Route(2)) !== null) {
            $this->service_id->setQueryStringValue($keyValue);
            $this->RecKey["service_id"] = $this->service_id->QueryStringValue;
        } elseif (!$loadCurrentRecord) {
            $returnUrl = "jdhserviceslist"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "jdhserviceslist"; // No matching record, return to list
                    }
                break;
        }
    ...
    protected function getExportTag($type, $custom = false)
    {
        ...
        if (SameText($type, "excel")) {
            ...
            return '<button type="button" class="btn btn-default ew-export-link ew-email" title="' . $Language->phrase("ExportToEmail", true) . '" data-caption="' . $Language->phrase("ExportToEmail", true) . '" form="fjdh_servicesview" data-ew-action="email" data-hdr="' . $Language->phrase("ExportToEmail", true) . '" data-key="' . ArrayToJsonAttribute($this->RecKey) . '" data-exported-selected="false"' . $url . '>' . $Language->phrase("ExportToEmail") . '</button>';
