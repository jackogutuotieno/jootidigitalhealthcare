 ...
 * Page class
 */
class UsersSummary extends Users
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "UsersSummary";
    ...
    public function loadRowValues($record)
    {
        ...
        $data["national_id"] = $record['national_id'];
        $data["email_address"] = $record['email_address'];
        $data["phone"] = $record['phone'];
        $data["department_id"] = $record['department_id'];
        $data["_password"] = $record['password'];
        $data["registration_date"] = $record['registration_date'];
        $data["role_id"] = $record['role_id'];
        $this->Rows[] = $data;
        $this->user_id->setDbValue($record['user_id']);
        ...
        $this->national_id->setDbValue($record['national_id']);
        ...
        $this->_password->setDbValue($record['password']);
        $this->biography->setDbValue($record['biography']);
        $this->registration_date->setDbValue($record['registration_date']);
        $this->role_id->setDbValue($record['role_id']);
    }
    ...
    public function renderRow()
    {
        ...
        if ($this->RowType == ROWTYPE_TOTAL && $this->RowTotalSubType == ROWTOTAL_FOOTER && $this->RowTotalType == ROWTOTAL_PAGE) { // Get Page total
            ...
            if ($rsagg) {
                $this->registration_date->Count = $this->TotalCount;
                $this->role_id->Count = $this->TotalCount;
                $this->role_id->CntValue = $rsagg["cnt_role_id"];
                $hasSummary = true;
            }
            ...
            if (!$hasCount || !$hasSummary) {
                ...
                $this->role_id->getCnt($this->DetailRecords);
            }
        }
        ...
        if ($this->RowType == ROWTYPE_SEARCH) { // Search row
            ...
            // role_id
            if (strval($this->role_id->CntValue) != "") {
                $this->role_id->CntViewValue = $this->role_id->optionCaption($this->role_id->CntValue);
            } else {
                $this->role_id->CntViewValue = null;
            }
            $this->role_id->CellAttrs["class"] = ($this->RowTotalType == ROWTOTAL_PAGE || $this->RowTotalType == ROWTOTAL_GRAND) ? "ew-rpt-grp-aggregate" : "ew-rpt-grp-summary-" . $this->RowGroupLevel;
            ...
            $this->registration_date->CellCssClass = ($this->RecordCount % 2 != 1 ? "ew-table-alt-row" : "");
            ...
            $this->role_id->CellCssClass = ($this->RecordCount % 2 != 1 ? "ew-table-alt-row" : "");
        ...
        if ($this->RowType == ROWTYPE_TOTAL) {
            // role_id
            $currentValue = $this->role_id->CntValue;
            $viewValue = &$this->role_id->CntViewValue;
            $viewAttrs = &$this->role_id->ViewAttrs;
            $cellAttrs = &$this->role_id->CellAttrs;
            $hrefValue = &$this->role_id->HrefValue;
            $linkAttrs = &$this->role_id->LinkAttrs;
            $this->cellRendered($this->role_id, $currentValue, $viewValue, $viewAttrs, $cellAttrs, $hrefValue, $linkAttrs);
        } else {
            // registration_date
            $currentValue = $this->registration_date->CurrentValue;
            $viewValue = &$this->registration_date->ViewValue;
            $viewAttrs = &$this->registration_date->ViewAttrs;
            $cellAttrs = &$this->registration_date->CellAttrs;
            $hrefValue = &$this->registration_date->HrefValue;
            $linkAttrs = &$this->registration_date->LinkAttrs;
            $this->cellRendered($this->registration_date, $currentValue, $viewValue, $viewAttrs, $cellAttrs, $hrefValue, $linkAttrs);

            // role_id
            $currentValue = $this->role_id->CurrentValue;
            $viewValue = &$this->role_id->ViewValue;
            $viewAttrs = &$this->role_id->ViewAttrs;
            $cellAttrs = &$this->role_id->CellAttrs;
            $hrefValue = &$this->role_id->HrefValue;
            $linkAttrs = &$this->role_id->LinkAttrs;
    ...
    protected function setupFieldCount()
    {
        ...
        if ($this->registration_date->Visible) {
            $this->DetailColumnCount += 1;
        }
        if ($this->role_id->Visible) {
            $this->DetailColumnCount += 1;
        }
    }
