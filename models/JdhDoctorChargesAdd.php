 ...
 * Page class
 */
class JdhDoctorChargesAdd extends JdhDoctorCharges
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "JdhDoctorChargesAdd";
    ...
    // CSS class/style
    public $CurrentPageName = "jdhdoctorchargesadd";
        ...
        switch ($this->CurrentAction) {
            case "copy": // Copy an existing record
                if (!$rsold) { // Record not loaded
                    ...
                    $this->terminate("jdhdoctorchargeslist"); // No matching record, return to list
                    return;
                }
                break;
            case "insert": // Add new record
                ...
                if ($this->addRow($rsold)) { // Add successful
                    ...
                    if (GetPageName($returnUrl) == "jdhdoctorchargeslist") {
                        $returnUrl = $this->addMasterUrl($returnUrl); // List page, return to List page with correct master key if necessary
                    } elseif (GetPageName($returnUrl) == "jdhdoctorchargesview") {
                    ...
                    if ($this->IsModal && $this->UseAjaxActions) {
                        ...
                        if (GetPageName($returnUrl) != "jdhdoctorchargeslist") {
                            ...
                            $returnUrl = "jdhdoctorchargeslist"; // Return list page content
                        }
                    }
