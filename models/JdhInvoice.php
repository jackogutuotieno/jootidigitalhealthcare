 ...
 */
class JdhInvoice extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("jdhinvoicelist");
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("jdhinvoiceview", $parm);
        } else {
            $url = $this->keyUrl("jdhinvoiceview", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("jdhinvoicelist", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("jdhinvoicelist", "action=copy");
        return $this->addMasterUrl($url);
    }
