 ...
 * Page class
 */
class JdhWardsAdd extends JdhWards
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "JdhWardsAdd";
    ...
    // CSS class/style
    public $CurrentPageName = "jdhwardsadd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($rsold)) {
                    ...
                    } elseif (GetPageName($returnUrl) == "jdhwardsview") {
    ...
    protected function addRow($rsold = null)
    {
        ...
        // ward_name
        $this->ward_name->setDbValueDef($rsnew, $this->ward_name->CurrentValue, "", false);
