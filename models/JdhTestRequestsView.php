 ...
 * Page class
 */
class JdhTestRequestsView extends JdhTestRequests
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "JdhTestRequestsView";
    ...
    // CSS class/style
    public $CurrentPageName = "jdhtestrequestsview";
    ...
    public function __construct()
    {
        ...
        if (($keyValue = Get("request_id") ?? Route("request_id")) !== null) {
            $this->RecKey["request_id"] = $keyValue;
        }
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("request_id") ?? Route("request_id")) !== null) {
            ...
            $this->RecKey["request_id"] = $this->request_id->QueryStringValue;
        } elseif (Post("request_id") !== null) {
            $this->request_id->setFormValue(Post("request_id"));
            $this->RecKey["request_id"] = $this->request_id->FormValue;
        } elseif (IsApi() && ($keyValue = Key(0) ?? Route(2)) !== null) {
            $this->request_id->setQueryStringValue($keyValue);
            $this->RecKey["request_id"] = $this->request_id->QueryStringValue;
        } elseif (!$loadCurrentRecord) {
            $returnUrl = "jdhtestrequestslist"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "jdhtestrequestslist"; // No matching record, return to list
                    }
                break;
        }
    ...
    protected function getExportTag($type, $custom = false)
    {
        ...
        if (SameText($type, "excel")) {
            ...
            return '<button type="button" class="btn btn-default ew-export-link ew-email" title="' . $Language->phrase("ExportToEmail", true) . '" data-caption="' . $Language->phrase("ExportToEmail", true) . '" form="fjdh_test_requestsview" data-ew-action="email" data-hdr="' . $Language->phrase("ExportToEmail", true) . '" data-key="' . ArrayToJsonAttribute($this->RecKey) . '" data-exported-selected="false"' . $url . '>' . $Language->phrase("ExportToEmail") . '</button>';
