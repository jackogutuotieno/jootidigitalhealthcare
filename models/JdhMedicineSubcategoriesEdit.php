 ...
 * Page class
 */
class JdhMedicineSubcategoriesEdit extends JdhMedicineSubcategories
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "JdhMedicineSubcategoriesEdit";
    ...
    // CSS class/style
    public $CurrentPageName = "jdhmedicinesubcategoriesedit";
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    if (!$loaded) { // Load record based on key
                        ...
                        $this->terminate("jdhmedicinesubcategorieslist"); // No matching record, return to list
                        return;
                    }
                break;
            case "update": // Update
                $returnUrl = $this->getReturnUrl();
                if (GetPageName($returnUrl) == "jdhmedicinesubcategorieslist") {
                ...
                if ($this->editRow()) {
                    ...
                    if ($this->UseAjaxActions && GetPageName($returnUrl) != "jdhmedicinesubcategorieslist") {
                        Container("flash")->addMessage("Return-Url", $returnUrl); // Save return URL
                        $returnUrl = "jdhmedicinesubcategorieslist"; // Return list page content
                    }
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("jdhmedicinesubcategorieslist"), "", $this->TableVar, true);
        $pageId = "edit";
