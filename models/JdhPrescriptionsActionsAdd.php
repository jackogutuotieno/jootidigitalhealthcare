 ...
 * Page class
 */
class JdhPrescriptionsActionsAdd extends JdhPrescriptionsActions
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "JdhPrescriptionsActionsAdd";
    ...
    // CSS class/style
    public $CurrentPageName = "jdhprescriptionsactionsadd";
        ...
        switch ($this->CurrentAction) {
            case "copy": // Copy an existing record
                if (!$rsold) { // Record not loaded
                    ...
                    $this->terminate("jdhprescriptionsactionslist"); // No matching record, return to list
                    return;
                }
                break;
            case "insert": // Add new record
                ...
                if ($this->addRow($rsold)) { // Add successful
                    ...
                    if (GetPageName($returnUrl) == "jdhprescriptionsactionslist") {
                        $returnUrl = $this->addMasterUrl($returnUrl); // List page, return to List page with correct master key if necessary
                    } elseif (GetPageName($returnUrl) == "jdhprescriptionsactionsview") {
                    ...
                    if ($this->IsModal && $this->UseAjaxActions) {
                        ...
                        if (GetPageName($returnUrl) != "jdhprescriptionsactionslist") {
                            ...
                            $returnUrl = "jdhprescriptionsactionslist"; // Return list page content
                        }
                    }
    ...
    public function renderRow()
    {
        ...
        // units_given
        $this->units_given->RowCssClass = "row";
