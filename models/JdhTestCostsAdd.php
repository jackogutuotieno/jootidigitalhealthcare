 ...
 * Page class
 */
class JdhTestCostsAdd extends JdhTestCosts
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "JdhTestCostsAdd";
    ...
    // CSS class/style
    public $CurrentPageName = "jdhtestcostsadd";
        ...
        switch ($this->CurrentAction) {
            case "copy": // Copy an existing record
                if (!$rsold) { // Record not loaded
                    ...
                    $this->terminate("jdhtestcostslist"); // No matching record, return to list
                    return;
                }
                break;
            case "insert": // Add new record
                ...
                if ($this->addRow($rsold)) {
                    ...
                    if (GetPageName($returnUrl) == "jdhtestcostslist") {
                        $returnUrl = $this->addMasterUrl($returnUrl); // List page, return to List page with correct master key if necessary
                    } elseif (GetPageName($returnUrl) == "jdhtestcostsview") {
                        $returnUrl = $this->getViewUrl(); // View page, return to View page with keyurl directly
                    }

                    // Handle UseAjaxActions with return page
                    if ($this->UseAjaxActions && GetPageName($returnUrl) != "jdhtestcostslist") {
                        Container("flash")->addMessage("Return-Url", $returnUrl); // Save return URL
                        $returnUrl = "jdhtestcostslist"; // Return list page content
                    }
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("jdhtestcostslist"), "", $this->TableVar, true);
