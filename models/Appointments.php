...
/**
 * Table class for Appointments
 */
class Appointments extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("appointmentslist");
    }
    ...
    {
        global $Language;
        if ($pageName == "appointmentsview") {
            return $Language->phrase("View");
        } elseif ($pageName == "appointmentsedit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "appointmentsadd") {
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("appointmentsview", $parm);
        } else {
            $url = $this->keyUrl("appointmentsview", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("appointmentsedit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("appointmentslist", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("appointmentsadd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("appointmentslist", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl()
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("appointmentsdelete");
        }
    }
