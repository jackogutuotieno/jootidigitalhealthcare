 ...
 * Page class
 */
class JdhTestCategoriesView extends JdhTestCategories
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "JdhTestCategoriesView";
    ...
    // CSS class/style
    public $CurrentPageName = "jdhtestcategoriesview";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("category_id") ?? Route("category_id")) !== null) {
            ...
            $returnUrl = "jdhtestcategorieslist"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "jdhtestcategorieslist"; // No matching record, return to list
                    }
                break;
        }
    ...
    */
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("jdhtestcategorieslist"), "", $this->TableVar, true);
        $pageId = "view";
