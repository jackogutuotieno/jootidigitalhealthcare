 ...
 * Page class
 */
class JdhExaminationFindingsAdd extends JdhExaminationFindings
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "JdhExaminationFindingsAdd";
    ...
    // CSS class/style
    public $CurrentPageName = "jdhexaminationfindingsadd";
        ...
        switch ($this->CurrentAction) {
            case "copy": // Copy an existing record
                if (!$rsold) { // Record not loaded
                    ...
                    $this->terminate("jdhexaminationfindingslist"); // No matching record, return to list
                    return;
                }
                break;
            case "insert": // Add new record
                ...
                if ($this->addRow($rsold)) { // Add successful
                    ...
                    if (GetPageName($returnUrl) == "jdhexaminationfindingslist") {
                        $returnUrl = $this->addMasterUrl($returnUrl); // List page, return to List page with correct master key if necessary
                    } elseif (GetPageName($returnUrl) == "jdhexaminationfindingsview") {
                    ...
                    if ($this->IsModal && $this->UseAjaxActions) {
                        ...
                        if (GetPageName($returnUrl) != "jdhexaminationfindingslist") {
                            ...
                            $returnUrl = "jdhexaminationfindingslist"; // Return list page content
                        }
                    }
