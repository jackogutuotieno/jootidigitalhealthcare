 ...
 * Page class
 */
class JdhDepartmentsDelete extends JdhDepartments
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "JdhDepartmentsDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "jdhdepartmentsdelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("jdhdepartmentslist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("jdhdepartmentslist"); // Return to list
                return;
            }
        }
