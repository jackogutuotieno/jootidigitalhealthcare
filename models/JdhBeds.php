...
class JdhBeds extends DbTable
{
    ...
    public function __construct()
    {
        ...
        $this->facility_id->Lookup = new Lookup('facility_id', 'jdh_facility_units', false, 'id', ["unit_name","","",""], '', '', [], ["x_ward_id"], [], [], [], [], '', '', "`unit_name`");
        ...
        $this->ward_id->Lookup = new Lookup('ward_id', 'jdh_wards', false, 'ward_id', ["ward_name","","",""], '', '', ["x_facility_id"], [], ["facility_id"], ["x_facility_id"], [], [], '', '', "`ward_name`");
        ...
        // assigned $tbl, $fldvar, $fldname, $fldexp, $fldbsexp, $fldtype, $fldsize, $flddtfmt, $upload, $fldvirtualexp, $fldvirtual, $forceselect, $fldvirtualsrch, $fldviewtag = "", $fldhtmltag
        ...
        $this->assigned->DataType = DATATYPE_BOOLEAN;
        $this->assigned->Lookup = new Lookup('assigned', 'jdh_beds', false, '', ["","","",""], '', '', [], [], [], [], [], [], '', '', "");
    ...
    {
        global $Language;
        if ($pageName == "jdhbedsview") {
            return $Language->phrase("View");
        } elseif ($pageName == "jdhbedsedit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "jdhbedsadd") {
    ...
    public function getDeleteUrl()
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("jdhbedsdelete");
        }
    }
    ...
    {
        WriteAuditLog(CurrentUser(), $typ, 'jdh_beds', "", "", "", "");
    }
