 ...
 * Page class
 */
class JdhInvoiceItemsGrid extends JdhInvoiceItems
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "JdhInvoiceItemsGrid";
    ...
    public $FormName = "fjdh_invoice_itemsgrid";
    public $FormActionName = "";
    public $FormBlankRowName = "";
    public $FormKeyCountName = "";

    // CSS class/style
    public $CurrentPageName = "jdhinvoiceitemsgrid";
    ...
    {
        global $CurrentForm;
        if ($CurrentForm->hasValue("x_invoice_item") && $CurrentForm->hasValue("o_invoice_item") && $this->invoice_item->CurrentValue != $this->invoice_item->DefaultValue) {
            return false;
        }
        if ($CurrentForm->hasValue("x_total_amount") && $CurrentForm->hasValue("o_total_amount") && $this->total_amount->CurrentValue != $this->total_amount->DefaultValue) {
            return false;
        }
    ...
    protected function loadFormValues()
    {
        ...
        if ($CurrentForm->hasValue("o_invoice_item")) {
            $this->invoice_item->setOldValue($CurrentForm->getValue("o_invoice_item"));
        }
        ...
        if ($CurrentForm->hasValue("o_total_amount")) {
            $this->total_amount->setOldValue($CurrentForm->getValue("o_total_amount"));
        }
