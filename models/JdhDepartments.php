...
class JdhDepartments extends DbTable
{
    ...
    public function getModalCaption($pageName)
    {
        ...
        return match ($pageName) {
            "jdhdepartmentsview" => $Language->phrase("View"),
            "jdhdepartmentsedit" => $Language->phrase("Edit"),
            "jdhdepartmentsadd" => $Language->phrase("Add"),
            default => ""
        };
    }
    ...
    public function getApiPageName($action)
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "JdhDepartmentsView",
            Config("API_ADD_ACTION") => "JdhDepartmentsAdd",
            Config("API_EDIT_ACTION") => "JdhDepartmentsEdit",
            Config("API_DELETE_ACTION") => "JdhDepartmentsDelete",
            Config("API_LIST_ACTION") => "JdhDepartmentsList",
            default => ""
        };
    }
    ...
    public function getDeleteUrl($parm = "")
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("jdhdepartmentsdelete", $parm);
        }
    }
    ...
    {
        $json = "";
        $json .= "\"department_id\":" . VarToJson($this->department_id->CurrentValue, "number");
        $json = "{" . $json . "}";
        if ($htmlEncode) {
