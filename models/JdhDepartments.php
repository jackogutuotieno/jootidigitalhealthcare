...
/**
 * Table class for jdh_departments
 */
class JdhDepartments extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        // Update Table
        $this->UpdateTable = "`jdh_departments`";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        $this->department_id->SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"];
        $this->Fields['department_id'] = &$this->department_id;

        // department_name $tbl, $fldvar, $fldname, $fldexp, $fldbsexp, $fldtype, $fldsize, $flddtfmt, $upload, $fldvirtualexp, $fldvirtual, $forceselect, $fldvirtualsrch, $fldviewtag = "", $fldhtmltag
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`jdh_departments`";
    }
    ...
    public function update(&$rs, $where = "", $rsold = null, $curfilter = true)
    {
        ...
        if ($success) {
            if (!isset($rs['department_id']) && !EmptyValue($this->department_id->CurrentValue)) {
                $rs['department_id'] = $this->department_id->CurrentValue;
            }
        }
        return $success;
    }
    ...
    public function getRecordFilter($row = null, $current = false)
    {
        ...
        if (is_array($row)) {
            ...
            $val = !EmptyValue($this->department_id->OldValue) && !$current ? $this->department_id->OldValue : $this->department_id->CurrentValue;
        }
        if (!is_numeric($val)) {
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("jdhdepartmentslist");
    }
    ...
    {
        global $Language;
        if ($pageName == "jdhdepartmentsview") {
            return $Language->phrase("View");
        } elseif ($pageName == "jdhdepartmentsedit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "jdhdepartmentsadd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "JdhDepartmentsView";
            case Config("API_ADD_ACTION"):
                return "JdhDepartmentsAdd";
            case Config("API_EDIT_ACTION"):
                return "JdhDepartmentsEdit";
            case Config("API_DELETE_ACTION"):
                return "JdhDepartmentsDelete";
            case Config("API_LIST_ACTION"):
                return "JdhDepartmentsList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("jdhdepartmentsview", $parm);
        } else {
            $url = $this->keyUrl("jdhdepartmentsview", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        if ($parm != "") {
            $url = "jdhdepartmentsadd?" . $parm;
        } else {
            $url = "jdhdepartmentsadd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("jdhdepartmentsedit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("jdhdepartmentslist", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("jdhdepartmentsadd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("jdhdepartmentslist", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl()
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("jdhdepartmentsdelete");
        }
    }
    ...
    public function keyUrl($url, $parm = "")
    {
        if ($this->department_id->CurrentValue !== null) {
            $url .= "/" . $this->encodeKeyValue($this->department_id->CurrentValue);
        } else {
