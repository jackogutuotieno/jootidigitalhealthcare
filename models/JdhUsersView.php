 ...
 * Page class
 */
class JdhUsersView extends JdhUsers
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "JdhUsersView";
    ...
    // CSS class/style
    public $CurrentPageName = "jdhusersview";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("user_id") ?? Route("user_id")) !== null) {
            ...
            $returnUrl = "jdhuserslist"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "jdhuserslist"; // No matching record, return to list
                    }
                break;
        }
    ...
    protected function getExportTag($type, $custom = false)
    {
        ...
        if (SameText($type, "excel")) {
            ...
            return '<button type="button" class="btn btn-default ew-export-link ew-email" title="' . $Language->phrase("ExportToEmail", true) . '" data-caption="' . $Language->phrase("ExportToEmail", true) . '" form="fjdh_usersview" data-ew-action="email" data-hdr="' . $Language->phrase("ExportToEmail", true) . '" data-key="' . HtmlEncode(ArrayToJsonAttribute($this->RecKey)) . '" data-exported-selected="false"' . $url . '>' . $Language->phrase("ExportToEmail") . '</button>';
