 ...
 * Page class
 */
class JdhPrescriptionsDelete extends JdhPrescriptions
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "JdhPrescriptionsDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("jdhprescriptionslist"); // Prevent SQL injection, return to list
            return;
        }
