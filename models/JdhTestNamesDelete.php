 ...
 * Page class
 */
class JdhTestNamesDelete extends JdhTestNames
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "JdhTestNamesDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "jdhtestnamesdelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("jdhtestnameslist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("jdhtestnameslist"); // Return to list
                return;
            }
        }
