...
class JdhTestRequestsAdd extends JdhTestRequests
{
    ...
    protected function validateForm()
    {
        ...
        $validateForm = true;
            ...
            if ($this->requested_by_user_id->Visible && $this->requested_by_user_id->Required) {
    ...
    protected function getAddRow()
    {
        ...
        $this->requested_by_user_id->setDbValueDef($rsnew, $this->requested_by_user_id->CurrentValue);
        return $rsnew;
    }
