...
class JdhExaminationFindings extends DbTable
{
    ...
    public function __construct()
    {
        ...
        // systematic_exams $tbl, $fldvar, $fldname, $fldexp, $fldbsexp, $fldtype, $fldsize, $flddtfmt, $upload, $fldvirtualexp, $fldvirtual, $forceselect, $fldvirtualsrch, $fldviewtag = "", $fldhtmltag
    ...
    {
        global $Language;
        if ($pageName == "jdhexaminationfindingsview") {
            return $Language->phrase("View");
        } elseif ($pageName == "jdhexaminationfindingsedit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "jdhexaminationfindingsadd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "JdhExaminationFindingsView";
            case Config("API_ADD_ACTION"):
                return "JdhExaminationFindingsAdd";
            case Config("API_EDIT_ACTION"):
                return "JdhExaminationFindingsEdit";
            case Config("API_DELETE_ACTION"):
                return "JdhExaminationFindingsDelete";
    ...
    public function getDeleteUrl()
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("jdhexaminationfindingsdelete");
        }
    }
    ...
    {
        WriteAuditLog(CurrentUser(), $typ, 'jdh_examination_findings', "", "", "", "");
    }
