...
/**
 * Table class for jdh_examination_findings
 */
class JdhExaminationFindings extends DbTable
{
    protected $SqlFrom = "";
    ...
    public $id;
    public $patient_id;
    public $general_exams;
    public $systematic_exams;
    ...
    public function __construct()
    {
        ...
        // Update Table
        $this->UpdateTable = "jdh_examination_findings";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // general_exams
        $this->general_exams = new DbField(
            $this, // Table
            'x_general_exams', // Variable name
            'general_exams', // Name
            '`general_exams`', // Expression
            '`general_exams`', // Basic search expression
            200, // Type
            200, // Size
            -1, // Date/Time format
            false, // Is upload field
            '`general_exams`', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->general_exams->InputTextType = "text";
        $this->general_exams->Nullable = false; // NOT NULL field
        $this->general_exams->Required = true; // Required field
        $this->general_exams->SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY"];
        $this->Fields['general_exams'] = &$this->general_exams;

        // systematic_exams
        $this->systematic_exams = new DbField(
            $this, // Table
            'x_systematic_exams', // Variable name
            'systematic_exams', // Name
            '`systematic_exams`', // Expression
            '`systematic_exams`', // Basic search expression
            200, // Type
            200, // Size
            -1, // Date/Time format
            false, // Is upload field
            '`systematic_exams`', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->systematic_exams->InputTextType = "text";
        $this->systematic_exams->Nullable = false; // NOT NULL field
        $this->systematic_exams->Required = true; // Required field
        $this->systematic_exams->SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY"];
        $this->Fields['systematic_exams'] = &$this->systematic_exams;
        ...
        $this->date_submitted = new DbField(
            ...
            CastDateFieldForLike("`date_submitted`", 11, "DB"), // Basic search expression
            135, // Type
            19, // Size
            11, // Date/Time format
            false, // Is upload field
        ...
        $this->date_submitted->Raw = true;
        $this->date_submitted->Nullable = false; // NOT NULL field
        $this->date_submitted->Required = true; // Required field
        $this->date_submitted->DefaultErrorMessage = str_replace("%s", DateFormat(11), $Language->phrase("IncorrectDate"));
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "jdh_examination_findings";
    }
    ...
    protected function loadDbValues($row)
    {
        ...
        $this->general_exams->DbValue = $row['general_exams'];
        $this->systematic_exams->DbValue = $row['systematic_exams'];
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("jdhexaminationfindingslist");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        return match ($pageName) {
            "jdhexaminationfindingsview" => $Language->phrase("View"),
            "jdhexaminationfindingsedit" => $Language->phrase("Edit"),
            "jdhexaminationfindingsadd" => $Language->phrase("Add"),
            default => ""
        };
    }
    ...
    {
        return "jdhexaminationfindingslist";
    }
    ...
    public function getApiPageName($action)
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "JdhExaminationFindingsView",
            Config("API_ADD_ACTION") => "JdhExaminationFindingsAdd",
            Config("API_EDIT_ACTION") => "JdhExaminationFindingsEdit",
            Config("API_DELETE_ACTION") => "JdhExaminationFindingsDelete",
            Config("API_LIST_ACTION") => "JdhExaminationFindingsList",
            default => ""
        };
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("jdhexaminationfindingsview", $parm);
        } else {
            $url = $this->keyUrl("jdhexaminationfindingsview", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        if ($parm != "") {
            $url = "jdhexaminationfindingsadd?" . $parm;
        } else {
            $url = "jdhexaminationfindingsadd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("jdhexaminationfindingsedit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("jdhexaminationfindingslist", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("jdhexaminationfindingsadd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("jdhexaminationfindingslist", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl($parm = "")
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("jdhexaminationfindingsdelete", $parm);
        }
    }
    ...
    {
        global $Response;
        $listPage = "JdhExaminationFindingsList";
    ...
    public function renderEditRow()
    {
        ...
        $this->general_exams->EditValue = $this->general_exams->CurrentValue;
        ...
        $this->systematic_exams->EditValue = $this->systematic_exams->CurrentValue;
        ...
        if (!$doc->ExportCustom) {
            ...
            if ($doc->Horizontal) { // Horizontal format, write header
                ...
                if ($exportPageType == "view") {
                    ...
                    $doc->exportCaption($this->general_exams);
                    $doc->exportCaption($this->systematic_exams);
            ...
            if ($recCnt >= $startRec) {
                ...
                if (!$doc->ExportCustom) {
                    ...
                    if ($exportPageType == "view") {
                        ...
                        $doc->exportField($this->general_exams);
                        $doc->exportField($this->systematic_exams);
    ...
    public function getUserIDSubquery(&$fld, &$masterfld)
    {
        global $UserTable;
        $wrk = "";
        $sql = "SELECT " . $masterfld->Expression . " FROM jdh_examination_findings";
    ...
    {
        WriteAuditLog(CurrentUserIdentifier(), $typ, 'jdh_examination_findings');
    }
    ...
    public function writeAuditTrailOnAdd(&$rs)
    {
        ...
        foreach (array_keys($rs) as $fldname) {
            if (array_key_exists($fldname, $this->Fields) && $this->Fields[$fldname]->DataType != DataType::BLOB) { // Ignore BLOB fields
                ...
                WriteAuditLog($usr, "A", 'jdh_examination_findings', $fldname, $key, "", $newvalue);
            }
        }
    }
        ...
        foreach (array_keys($rsnew) as $fldname) {
            if (array_key_exists($fldname, $this->Fields) && array_key_exists($fldname, $rsold) && $this->Fields[$fldname]->DataType != DataType::BLOB) { // Ignore BLOB fields
                ...
                if ($modified) {
                    ...
                    WriteAuditLog($usr, "U", 'jdh_examination_findings', $fldname, $key, $oldvalue, $newvalue);
                }
            }
        }
    }
    ...
    public function writeAuditTrailOnDelete(&$rs)
    {
        ...
        foreach (array_keys($rs) as $fldname) {
            if (array_key_exists($fldname, $this->Fields) && $this->Fields[$fldname]->DataType != DataType::BLOB) { // Ignore BLOB fields
                ...
                WriteAuditLog($usr, "D", 'jdh_examination_findings', $fldname, $key, $oldvalue);
            }
        }
    }
