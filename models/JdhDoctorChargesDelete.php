 ...
 * Page class
 */
class JdhDoctorChargesDelete extends JdhDoctorCharges
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "JdhDoctorChargesDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "jdhdoctorchargesdelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("jdhdoctorchargeslist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if (!$res) {
            $this->terminate("jdhdoctorchargeslist"); // Return to list
            return;
        }
