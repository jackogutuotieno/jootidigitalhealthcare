 ...
 * Page class
 */
class JdhBedsAssignmentEdit extends JdhBedsAssignment
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "JdhBedsAssignmentEdit";
    ...
    // CSS class/style
    public $CurrentPageName = "jdhbedsassignmentedit";
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    if (!$loaded) { // Load record based on key
                        ...
                        $this->terminate("jdhbedsassignmentlist"); // No matching record, return to list
                        return;
                    }
                break;
            case "update": // Update
                $returnUrl = $this->getReturnUrl();
                if (GetPageName($returnUrl) == "jdhbedsassignmentlist") {
                ...
                if ($this->editRow()) {
                    ...
                    if ($this->UseAjaxActions && GetPageName($returnUrl) != "jdhbedsassignmentlist") {
                        Container("flash")->addMessage("Return-Url", $returnUrl); // Save return URL
                        $returnUrl = "jdhbedsassignmentlist"; // Return list page content
                    }
