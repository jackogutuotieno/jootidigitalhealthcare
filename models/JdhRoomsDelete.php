 ...
 * Page class
 */
class JdhRoomsDelete extends JdhRooms
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "JdhRoomsDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "jdhroomsdelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("jdhroomslist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("jdhroomslist"); // Return to list
                return;
            }
        }
