...
class JdhVitalsList extends JdhVitals
{
    ...
    public function getFilterList()
    {
        ...
        $filterList = Concat($filterList, $this->spo_2->AdvancedSearch->toJson(), ","); // Field spo_2
    ...
    protected function restoreFilterList()
    {
        ...
        // Field spo_2
        $this->spo_2->AdvancedSearch->SearchValue = @$filter["x_spo_2"];
        $this->spo_2->AdvancedSearch->SearchOperator = @$filter["z_spo_2"];
        $this->spo_2->AdvancedSearch->SearchCondition = @$filter["v_spo_2"];
        $this->spo_2->AdvancedSearch->SearchValue2 = @$filter["y_spo_2"];
        $this->spo_2->AdvancedSearch->SearchOperator2 = @$filter["w_spo_2"];
        $this->spo_2->AdvancedSearch->save();
    ...
    protected function setupSortOrder()
    {
        ...
        if (Get("order") !== null) {
            ...
            $this->updateSort($this->spo_2); // spo_2
    ...
    protected function setupOtherOptions()
    {
        ...
        if ($this->UseColumnVisibility) {
            ...
            $option->add("spo_2", $this->createColumnOption("spo_2"));
