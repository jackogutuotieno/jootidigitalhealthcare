 ...
 * Page class
 */
class JdhServiceCategoryView extends JdhServiceCategory
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "JdhServiceCategoryView";
    ...
    // CSS class/style
    public $CurrentPageName = "jdhservicecategoryview";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("category_id") ?? Route("category_id")) !== null) {
            ...
            $returnUrl = "jdhservicecategorylist"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "jdhservicecategorylist"; // No matching record, return to list
                    }
                break;
        }
