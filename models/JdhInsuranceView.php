 ...
 * Page class
 */
class JdhInsuranceView extends JdhInsurance
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "JdhInsuranceView";
    ...
    // CSS class/style
    public $CurrentPageName = "jdhinsuranceview";
    ...
    public function __construct()
    {
        ...
        if (($keyValue = Get("insurance_id") ?? Route("insurance_id")) !== null) {
            $this->RecKey["insurance_id"] = $keyValue;
        }
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("insurance_id") ?? Route("insurance_id")) !== null) {
            ...
            $this->RecKey["insurance_id"] = $this->insurance_id->QueryStringValue;
        } elseif (Post("insurance_id") !== null) {
            $this->insurance_id->setFormValue(Post("insurance_id"));
            $this->RecKey["insurance_id"] = $this->insurance_id->FormValue;
        } elseif (IsApi() && ($keyValue = Key(0) ?? Route(2)) !== null) {
            $this->insurance_id->setQueryStringValue($keyValue);
            $this->RecKey["insurance_id"] = $this->insurance_id->QueryStringValue;
        } elseif (!$loadCurrentRecord) {
            $returnUrl = "jdhinsurancelist"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "jdhinsurancelist"; // No matching record, return to list
                    }
                break;
        }
