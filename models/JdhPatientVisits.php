...
class JdhPatientVisits extends DbTable
{
    ...
    public function __construct()
    {
        ...
        $this->doctor_id->Lookup = new Lookup('doctor_id', 'jdh_users', false, 'user_id', ["first_name","last_name","",""], '', '', [], [], [], [], [], [], '', '', "CONCAT(COALESCE(`first_name`, ''),'" . ValueSeparator(1, $this->doctor_id) . "',COALESCE(`last_name`,''))");
        ...
        $this->visit_date = new DbField(
            ...
            CastDateFieldForLike("`visit_date`", 0, "DB"), // Basic search expression
            135, // Type
            19, // Size
            0, // Date/Time format
            false, // Is upload field
