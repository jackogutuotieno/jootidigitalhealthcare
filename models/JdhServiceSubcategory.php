...
class JdhServiceSubcategory extends DbTable
{
    ...
    public function __construct()
    {
        ...
        $this->category_id->Lookup = new Lookup($this->category_id, 'jdh_service_category', false, 'category_id', ["category_name","","",""], '', '', [], [], [], [], [], [], false, '', '', "`category_name`");
    ...
    public function getModalCaption($pageName)
    {
        ...
        return match ($pageName) {
            "jdhservicesubcategoryview" => $Language->phrase("View"),
            "jdhservicesubcategoryedit" => $Language->phrase("Edit"),
            "jdhservicesubcategoryadd" => $Language->phrase("Add"),
            default => ""
        };
    }
    ...
    public function getApiPageName($action)
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "JdhServiceSubcategoryView",
            Config("API_ADD_ACTION") => "JdhServiceSubcategoryAdd",
            Config("API_EDIT_ACTION") => "JdhServiceSubcategoryEdit",
            Config("API_DELETE_ACTION") => "JdhServiceSubcategoryDelete",
            Config("API_LIST_ACTION") => "JdhServiceSubcategoryList",
            default => ""
        };
    }
    ...
    public function getDeleteUrl($parm = "")
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("jdhservicesubcategorydelete", $parm);
        }
    }
    ...
    {
        $json = "";
        $json .= "\"subcategory_id\":" . VarToJson($this->subcategory_id->CurrentValue, "number");
        $json = "{" . $json . "}";
        if ($htmlEncode) {
