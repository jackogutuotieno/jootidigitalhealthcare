...
/**
 * Table class for jdh_service_subcategory
 */
class JdhServiceSubcategory extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        // Update Table
        $this->UpdateTable = "`jdh_service_subcategory`";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        $this->category_id->Lookup = new Lookup('category_id', 'jdh_service_category', false, 'category_id', ["category_name","","",""], '', '', [], [], [], [], [], [], '', '', "`category_name`");
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`jdh_service_subcategory`";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("jdhservicesubcategorylist");
    }
    ...
    {
        global $Language;
        if ($pageName == "jdhservicesubcategoryview") {
            return $Language->phrase("View");
        } elseif ($pageName == "jdhservicesubcategoryedit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "jdhservicesubcategoryadd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "JdhServiceSubcategoryView";
            case Config("API_ADD_ACTION"):
                return "JdhServiceSubcategoryAdd";
            case Config("API_EDIT_ACTION"):
                return "JdhServiceSubcategoryEdit";
            case Config("API_DELETE_ACTION"):
                return "JdhServiceSubcategoryDelete";
            case Config("API_LIST_ACTION"):
                return "JdhServiceSubcategoryList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("jdhservicesubcategoryview", $parm);
        } else {
            $url = $this->keyUrl("jdhservicesubcategoryview", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        if ($parm != "") {
            $url = "jdhservicesubcategoryadd?" . $parm;
        } else {
            $url = "jdhservicesubcategoryadd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("jdhservicesubcategoryedit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("jdhservicesubcategorylist", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("jdhservicesubcategoryadd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("jdhservicesubcategorylist", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl()
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("jdhservicesubcategorydelete");
        }
    }
    ...
    {
        global $Response;
        $listPage = "JdhServiceSubcategoryList";
