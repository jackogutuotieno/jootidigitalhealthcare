...
class JdhServiceCategory extends DbTable
{
    ...
    public function getModalCaption($pageName)
    {
        ...
        return match ($pageName) {
            "jdhservicecategoryview" => $Language->phrase("View"),
            "jdhservicecategoryedit" => $Language->phrase("Edit"),
            "jdhservicecategoryadd" => $Language->phrase("Add"),
            default => ""
        };
    }
    ...
    public function getApiPageName($action)
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "JdhServiceCategoryView",
            Config("API_ADD_ACTION") => "JdhServiceCategoryAdd",
            Config("API_EDIT_ACTION") => "JdhServiceCategoryEdit",
            Config("API_DELETE_ACTION") => "JdhServiceCategoryDelete",
            Config("API_LIST_ACTION") => "JdhServiceCategoryList",
            default => ""
        };
    }
    ...
    public function getDeleteUrl($parm = "")
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("jdhservicecategorydelete", $parm);
        }
    }
