...
/**
 * Table class for jdh_service_category
 */
class JdhServiceCategory extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        // Update Table
        $this->UpdateTable = "`jdh_service_category`";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`jdh_service_category`";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("jdhservicecategorylist");
    }
    ...
    {
        global $Language;
        if ($pageName == "jdhservicecategoryview") {
            return $Language->phrase("View");
        } elseif ($pageName == "jdhservicecategoryedit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "jdhservicecategoryadd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "JdhServiceCategoryView";
            case Config("API_ADD_ACTION"):
                return "JdhServiceCategoryAdd";
            case Config("API_EDIT_ACTION"):
                return "JdhServiceCategoryEdit";
            case Config("API_DELETE_ACTION"):
                return "JdhServiceCategoryDelete";
            case Config("API_LIST_ACTION"):
                return "JdhServiceCategoryList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("jdhservicecategoryview", $parm);
        } else {
            $url = $this->keyUrl("jdhservicecategoryview", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        if ($parm != "") {
            $url = "jdhservicecategoryadd?" . $parm;
        } else {
            $url = "jdhservicecategoryadd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("jdhservicecategoryedit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("jdhservicecategorylist", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("jdhservicecategoryadd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("jdhservicecategorylist", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl()
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("jdhservicecategorydelete");
        }
    }
    ...
    {
        global $Response;
        $listPage = "JdhServiceCategoryList";
