...
class JdhInsurance extends DbTable
{
    ...
    public function __construct()
    {
        ...
        $this->insurance_id->Nullable = false; // NOT NULL field
        $this->insurance_id->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
        $this->insurance_id->SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN"];
    ...
    public function getModalCaption($pageName)
    {
        ...
        return match ($pageName) {
            "jdhinsuranceview" => $Language->phrase("View"),
            "jdhinsuranceedit" => $Language->phrase("Edit"),
            "jdhinsuranceadd" => $Language->phrase("Add"),
            default => ""
        };
    }
    ...
    public function getApiPageName($action)
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "JdhInsuranceView",
            Config("API_ADD_ACTION") => "JdhInsuranceAdd",
            Config("API_EDIT_ACTION") => "JdhInsuranceEdit",
            Config("API_DELETE_ACTION") => "JdhInsuranceDelete",
            Config("API_LIST_ACTION") => "JdhInsuranceList",
            default => ""
        };
    }
    ...
    public function getDeleteUrl($parm = "")
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("jdhinsurancedelete", $parm);
        }
    }
    ...
    {
        $json = "";
        $json .= "\"insurance_id\":" . VarToJson($this->insurance_id->CurrentValue, "number");
        $json = "{" . $json . "}";
        if ($htmlEncode) {
