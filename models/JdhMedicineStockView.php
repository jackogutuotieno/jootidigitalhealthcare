 ...
 * Page class
 */
class JdhMedicineStockView extends JdhMedicineStock
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "JdhMedicineStockView";
    ...
    // CSS class/style
    public $CurrentPageName = "jdhmedicinestockview";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("id") ?? Route("id")) !== null) {
            ...
            $returnUrl = "jdhmedicinestocklist"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "jdhmedicinestocklist"; // No matching record, return to list
                    }
                break;
        }
