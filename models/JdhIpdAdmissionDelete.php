 ...
 * Page class
 */
class JdhIpdAdmissionDelete extends JdhIpdAdmission
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "JdhIpdAdmissionDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "jdhipdadmissiondelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("jdhipdadmissionlist"); // Prevent SQL injection, return to list
            return;
        }
