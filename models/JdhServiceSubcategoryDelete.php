 ...
 * Page class
 */
class JdhServiceSubcategoryDelete extends JdhServiceSubcategory
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "JdhServiceSubcategoryDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "jdhservicesubcategorydelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("jdhservicesubcategorylist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("jdhservicesubcategorylist"); // Return to list
                return;
            }
        }
