 ...
 * Page class
 */
class JdhPatientServicesAdd extends JdhPatientServices
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "JdhPatientServicesAdd";
    ...
    // CSS class/style
    public $CurrentPageName = "jdhpatientservicesadd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($rsold)) {
                    ...
                    } elseif (GetPageName($returnUrl) == "jdhpatientservicesview") {
