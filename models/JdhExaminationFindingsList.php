 ...
 * Page class
 */
class JdhExaminationFindingsList extends JdhExaminationFindings
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "JdhExaminationFindingsList";
    ...
    public $FormName = "fjdh_examination_findingslist";
    public $FormActionName = "";
    public $FormBlankRowName = "";
    public $FormKeyCountName = "";

    // CSS class/style
    public $CurrentPageName = "jdhexaminationfindingslist";
    ...
    public function __construct()
    {
        ...
        // Initialize URLs
        $this->AddUrl = "jdhexaminationfindingsadd";
        $this->InlineAddUrl = $pageUrl . "action=add";
        $this->GridAddUrl = $pageUrl . "action=gridadd";
        $this->GridEditUrl = $pageUrl . "action=gridedit";
        $this->MultiEditUrl = $pageUrl . "action=multiedit";
        $this->MultiDeleteUrl = "jdhexaminationfindingsdelete";
        $this->MultiUpdateUrl = "jdhexaminationfindingsupdate";
    ...
    public function run()
    {
        ...
        if ($this->IsModal) {
            $this->FormName = "fjdh_examination_findingsgrid";
        }
    ...
    public function resetFormError()
    {
        ...
        $this->general_exams->clearErrorMessage();
        $this->systematic_exams->clearErrorMessage();
    }
    ...
    public function getFilterList()
    {
        ...
        if (Config("SEARCH_FILTER_OPTION") == "Server" && isset($UserProfile)) {
            $savedFilterList = $UserProfile->getSearchFilters(CurrentUserName(), "fjdh_examination_findingssrch");
        }
        $filterList = Concat($filterList, $this->id->AdvancedSearch->toJson(), ","); // Field id
        $filterList = Concat($filterList, $this->patient_id->AdvancedSearch->toJson(), ","); // Field patient_id
        $filterList = Concat($filterList, $this->general_exams->AdvancedSearch->toJson(), ","); // Field general_exams
        $filterList = Concat($filterList, $this->systematic_exams->AdvancedSearch->toJson(), ","); // Field systematic_exams
        $filterList = Concat($filterList, $this->submitted_by_user_id->AdvancedSearch->toJson(), ","); // Field submitted_by_user_id
        $filterList = Concat($filterList, $this->date_submitted->AdvancedSearch->toJson(), ","); // Field date_submitted
        if ($this->BasicSearch->Keyword != "") {
    ...
    protected function processFilterList()
    {
        ...
        if (Post("ajax") == "savefilters") { // Save filter request (Ajax)
            ...
            $UserProfile->setSearchFilters(CurrentUserName(), "fjdh_examination_findingssrch", $filters);
    ...
    protected function restoreFilterList()
    {
        ...
        // Field general_exams
        $this->general_exams->AdvancedSearch->SearchValue = @$filter["x_general_exams"];
        $this->general_exams->AdvancedSearch->SearchOperator = @$filter["z_general_exams"];
        $this->general_exams->AdvancedSearch->SearchCondition = @$filter["v_general_exams"];
        $this->general_exams->AdvancedSearch->SearchValue2 = @$filter["y_general_exams"];
        $this->general_exams->AdvancedSearch->SearchOperator2 = @$filter["w_general_exams"];
        $this->general_exams->AdvancedSearch->save();

        // Field systematic_exams
        $this->systematic_exams->AdvancedSearch->SearchValue = @$filter["x_systematic_exams"];
        $this->systematic_exams->AdvancedSearch->SearchOperator = @$filter["z_systematic_exams"];
        $this->systematic_exams->AdvancedSearch->SearchCondition = @$filter["v_systematic_exams"];
        $this->systematic_exams->AdvancedSearch->SearchValue2 = @$filter["y_systematic_exams"];
        $this->systematic_exams->AdvancedSearch->SearchOperator2 = @$filter["w_systematic_exams"];
        $this->systematic_exams->AdvancedSearch->save();
        ...
        $this->date_submitted->AdvancedSearch->SearchValue = @$filter["x_date_submitted"];
        $this->date_submitted->AdvancedSearch->SearchOperator = @$filter["z_date_submitted"];
        $this->date_submitted->AdvancedSearch->SearchCondition = @$filter["v_date_submitted"];
        $this->date_submitted->AdvancedSearch->SearchValue2 = @$filter["y_date_submitted"];
        $this->date_submitted->AdvancedSearch->SearchOperator2 = @$filter["w_date_submitted"];
        $this->date_submitted->AdvancedSearch->save();
    ...
    public function basicSearchWhere($default = false)
    {
        ...
        // Fields to search
        $searchFlds = [];
        $searchFlds[] = &$this->general_exams;
        $searchFlds[] = &$this->systematic_exams;
    ...
    protected function setupSortOrder()
    {
        ...
        if (Get("order") !== null) {
            ...
            $this->updateSort($this->general_exams); // general_exams
            $this->updateSort($this->systematic_exams); // systematic_exams
    ...
    protected function resetCmd()
    {
        ...
        if (StartsString("reset", $this->Command)) {
            ...
            if ($this->Command == "resetsort") {
                ...
                $this->general_exams->setSort("");
                $this->systematic_exams->setSort("");
                $this->submitted_by_user_id->setSort("");
                $this->date_submitted->setSort("");
            }
    ...
    public function renderListOptions()
    {
        ...
        if ($this->isInlineAddRow() || $this->isInlineCopyRow()) { // Inline Add/Copy
            ...
            if ($this->UseAjaxActions) {
                ...
                $opt->Body = <<<INLINEADD
                    <div{$divClass}>
                        <button class="ew-grid-link ew-inline-insert" title="{$insertTitle}" data-caption="{$insertTitle}" form="fjdh_examination_findingslist" formaction="{$inlineInsertUrl}">{$insertCaption}</button>
        ...
        if ($this->isInlineEditRow()) { // Inline-Edit
            ...
            $cancelurl = $this->addMasterUrl($pageUrl . "action=cancel");
                ...
                if ($this->UseAjaxActions) {
                    ...
                    $opt->Body = <<<INLINEEDIT
                    <div{$divClass}>
                        <button class="ew-grid-link ew-inline-update" title="{$updateTitle}" data-caption="{$updateTitle}" form="fjdh_examination_findingslist" formaction="{$inlineUpdateUrl}">{$updateCaption}</button>
        ...
        if ($this->CurrentMode == "view") {
            ...
            if ($Security->canView()) {
                if ($this->ModalView && !IsMobile()) {
                    $opt->Body = "<a class=\"ew-row-link ew-view\" title=\"" . $viewcaption . "\" data-table=\"jdh_examination_findings\" data-caption=\"" . $viewcaption . "\" data-ew-action=\"modal\" data-action=\"view\" data-ajax=\"" . ($this->UseAjaxActions ? "true" : "false") . "\" data-url=\"" . HtmlEncode(GetUrl($this->ViewUrl)) . "\" data-btn=\"null\">" . $Language->phrase("ViewLink") . "</a>";
                } else {
            ...
            if ($Security->canEdit()) {
                if ($this->ModalEdit && !IsMobile()) {
                    $opt->Body = "<a class=\"ew-row-link ew-edit\" title=\"" . $editcaption . "\" data-table=\"jdh_examination_findings\" data-caption=\"" . $editcaption . "\" data-ew-action=\"modal\" data-action=\"edit\" data-ajax=\"" . ($this->UseAjaxActions ? "true" : "false") . "\" data-url=\"" . HtmlEncode(GetUrl($this->EditUrl)) . "\" data-btn=\"SaveBtn\">" . $Language->phrase("EditLink") . "</a>";
                } else {
            ...
            if ($Security->canAdd()) {
                if ($this->ModalAdd && !IsMobile()) {
                    $opt->Body = "<a class=\"ew-row-link ew-copy\" title=\"" . $copycaption . "\" data-table=\"jdh_examination_findings\" data-caption=\"" . $copycaption . "\" data-ew-action=\"modal\" data-action=\"add\" data-ajax=\"" . ($this->UseAjaxActions ? "true" : "false") . "\" data-url=\"" . HtmlEncode(GetUrl($this->CopyUrl)) . "\" data-btn=\"AddBtn\">" . $Language->phrase("CopyLink") . "</a>";
                } else {
        ...
        if ($opt && !$this->isExport() && !$this->CurrentAction) {
            ...
            foreach ($this->ListActions->Items as $listaction) {
                ...
                if ($listaction->Select == ACTION_SINGLE && $allowed) {
                    ...
                    $link = "<li><button type=\"button\" class=\"dropdown-item ew-action ew-list-action\" data-caption=\"" . HtmlTitle($caption) . "\" data-ew-action=\"submit\" form=\"fjdh_examination_findingslist\" data-key=\"" . $this->keyToJson(true) . "\"" . $listaction->toDataAttrs() . ">" . $icon . " " . $listaction->Caption . "</button></li>";
                    if ($link != "") {
                        $links[] = $link;
                        if ($body == "") { // Setup first button
                            $body = "<button type=\"button\" class=\"btn btn-default ew-action ew-list-action\" title=\"" . HtmlTitle($caption) . "\" data-caption=\"" . HtmlTitle($caption) . "\" data-ew-action=\"submit\" form=\"fjdh_examination_findingslist\" data-key=\"" . $this->keyToJson(true) . "\"" . $listaction->toDataAttrs() . ">" . $icon . " " . $listaction->Caption . "</button>";
                        }
                    }
                }
            }
    ...
    protected function setupOtherOptions()
    {
        ...
        if ($this->ModalAdd && !IsMobile()) {
            $item->Body = "<a class=\"ew-add-edit ew-add\" title=\"" . $addcaption . "\" data-table=\"jdh_examination_findings\" data-caption=\"" . $addcaption . "\" data-ew-action=\"modal\" data-action=\"add\" data-ajax=\"" . ($this->UseAjaxActions ? "true" : "false") . "\" data-url=\"" . HtmlEncode(GetUrl($this->AddUrl)) . "\" data-btn=\"AddBtn\">" . $Language->phrase("AddLink") . "</a>";
        } else {
        ...
        $item->Body = "<button type=\"button\" class=\"ew-action ew-multi-delete\" title=\"" .
            ...
            HtmlTitle($Language->phrase("DeleteSelectedLink")) . "\" form=\"fjdh_examination_findingslist\"" .
        ...
        if ($this->UseColumnVisibility) {
            ...
            $option->add("general_exams", $this->createColumnOption("general_exams"));
            $option->add("systematic_exams", $this->createColumnOption("systematic_exams"));
        }
        ...
        $item->Body = "<a class=\"ew-save-filter\" data-form=\"fjdh_examination_findingssrch\" data-ew-action=\"none\">" . $Language->phrase("SaveCurrentFilter") . "</a>";
        $item->Visible = true;
        $item = &$this->FilterOptions->add("deletefilter");
        $item->Body = "<a class=\"ew-delete-filter\" data-form=\"fjdh_examination_findingssrch\" data-ew-action=\"none\">" . $Language->phrase("DeleteFilter") . "</a>";
        $item->Visible = true;
    ...
    public function renderOtherOptions()
    {
        ...
        foreach ($this->ListActions->Items as $listaction) {
            if ($listaction->Select == ACTION_MULTIPLE) {
                ...
                $item->Body = '<button type="button" class="btn btn-default ew-action ew-list-action" title="' . HtmlEncode($caption) . '" data-caption="' . HtmlEncode($caption) . '" data-ew-action="submit" form="fjdh_examination_findingslist"' . $listaction->toDataAttrs() . '>' . $icon . '</button>';
    ...
    public function setupRow()
    {
        ...
        if (($this->isGridAdd() || $this->isGridEdit())) {
            if ($this->RowIndex === '$rowindex$') { // Render template row first
                ...
                // Set row properties
                $this->resetAttributes();
                $this->RowAttrs->merge(["data-rowindex" => $this->RowIndex, "id" => "r0_jdh_examination_findings", "data-rowtype" => ROWTYPE_ADD]);
        ...
        $this->RowAttrs->merge([
            ...
            "id" => "r" . $this->RowCount . "_jdh_examination_findings",
    ...
    protected function validateForm()
    {
        ...
        if ($this->systematic_exams->Required) {
            if (!$this->systematic_exams->IsDetailKey && EmptyValue($this->systematic_exams->FormValue)) {
    ...
    protected function editRow()
    {
        ...
        // general_exams
        $this->general_exams->setDbValueDef($rsnew, $this->general_exams->CurrentValue, "", $this->general_exams->ReadOnly);

        // systematic_exams
        $this->systematic_exams->setDbValueDef($rsnew, $this->systematic_exams->CurrentValue, "", $this->systematic_exams->ReadOnly);
    ...
    public function getRowHash(&$rs)
    {
        ...
        $hash .= GetFieldHash($row['general_exams']); // general_exams
        $hash .= GetFieldHash($row['systematic_exams']); // systematic_exams
        return md5($hash);
    }
    ...
    protected function addRow($rsold = null)
    {
        ...
        // general_exams
        $this->general_exams->setDbValueDef($rsnew, $this->general_exams->CurrentValue, "", false);

        // systematic_exams
        $this->systematic_exams->setDbValueDef($rsnew, $this->systematic_exams->CurrentValue, "", false);
    ...
    protected function getExportTag($type, $custom = false)
    {
        ...
        if (SameText($type, "excel")) {
            if ($custom) {
                return "<button type=\"button\" class=\"btn btn-default ew-export-link ew-excel\" title=\"" . HtmlEncode($Language->phrase("ExportToExcel", true)) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToExcel", true)) . "\" form=\"fjdh_examination_findingslist\" data-url=\"$exportUrl\" data-ew-action=\"export\" data-export=\"excel\" data-custom=\"true\" data-export-selected=\"false\">" . $Language->phrase("ExportToExcel") . "</button>";
            } else {
                return "<a href=\"$exportUrl\" class=\"btn btn-default ew-export-link ew-excel\" title=\"" . HtmlEncode($Language->phrase("ExportToExcel", true)) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToExcel", true)) . "\">" . $Language->phrase("ExportToExcel") . "</a>";
            }
        } elseif (SameText($type, "word")) {
            if ($custom) {
                return "<button type=\"button\" class=\"btn btn-default ew-export-link ew-word\" title=\"" . HtmlEncode($Language->phrase("ExportToWord", true)) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToWord", true)) . "\" form=\"fjdh_examination_findingslist\" data-url=\"$exportUrl\" data-ew-action=\"export\" data-export=\"word\" data-custom=\"true\" data-export-selected=\"false\">" . $Language->phrase("ExportToWord") . "</button>";
            } else {
                return "<a href=\"$exportUrl\" class=\"btn btn-default ew-export-link ew-word\" title=\"" . HtmlEncode($Language->phrase("ExportToWord", true)) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToWord", true)) . "\">" . $Language->phrase("ExportToWord") . "</a>";
            }
        } elseif (SameText($type, "pdf")) {
            if ($custom) {
                return "<button type=\"button\" class=\"btn btn-default ew-export-link ew-pdf\" title=\"" . HtmlEncode($Language->phrase("ExportToPdf", true)) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToPdf", true)) . "\" form=\"fjdh_examination_findingslist\" data-url=\"$exportUrl\" data-ew-action=\"export\" data-export=\"pdf\" data-custom=\"true\" data-export-selected=\"false\">" . $Language->phrase("ExportToPdf") . "</button>";
            } else {
            ...
            return '<button type="button" class="btn btn-default ew-export-link ew-email" title="' . $Language->phrase("ExportToEmail", true) . '" data-caption="' . $Language->phrase("ExportToEmail", true) . '" form="fjdh_examination_findingslist" data-ew-action="email" data-custom="false" data-hdr="' . $Language->phrase("ExportToEmail", true) . '" data-exported-selected="false"' . $url . '>' . $Language->phrase("ExportToEmail") . '</button>';
    ...
    protected function setupSearchOptions()
    {
        ...
        $item->Body = "<a class=\"btn btn-default ew-search-toggle" . $searchToggleClass . "\" role=\"button\" title=\"" . $Language->phrase("SearchPanel") . "\" data-caption=\"" . $Language->phrase("SearchPanel") . "\" data-ew-action=\"search-toggle\" data-form=\"fjdh_examination_findingssrch\" aria-pressed=\"" . ($searchToggleClass == " active" ? "true" : "false") . "\">" . $Language->phrase("SearchLink") . "</a>";
        $item->Visible = true;
