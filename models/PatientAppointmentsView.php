 ...
 * Page class
 */
class PatientAppointmentsView extends PatientAppointments
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PatientAppointmentsView";
    ...
    public $CurrentPageName = "patientappointmentsview";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("appointment_id") ?? Route("appointment_id")) !== null) {
            ...
            $returnUrl = "patientappointmentslist"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "patientappointmentslist"; // No matching record, return to list
                    }
                break;
        }
    ...
    protected function getExportTag($type, $custom = false)
    {
        ...
        if (SameText($type, "excel")) {
            ...
            return '<button type="button" class="btn btn-default ew-export-link ew-email" title="' . $Language->phrase("ExportToEmail", true) . '" data-caption="' . $Language->phrase("ExportToEmail", true) . '" form="fPatient_Appointmentsview" data-ew-action="email" data-hdr="' . $Language->phrase("ExportToEmail", true) . '" data-key="' . HtmlEncode(ArrayToJsonAttribute($this->RecKey)) . '" data-exported-selected="false"' . $url . '>' . $Language->phrase("ExportToEmail") . '</button>';
