...
class BedsDelete extends Beds
{
    ...
    // CSS class/style
    public $CurrentPageName = "bedsdelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("bedslist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("bedslist"); // Return to list
                return;
            }
        }
