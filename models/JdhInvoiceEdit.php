...
class JdhInvoiceEdit extends JdhInvoice
{
    ...
    protected function editRow()
    {
        ...
        if ($updateRow) {
            ...
            $detailTblVar = explode(",", $this->getCurrentDetailTable());
            $detailPage = Container("JdhInvoiceItemsGrid");
            if (in_array("jdh_invoice_items", $detailTblVar) && $detailPage->DetailEdit && $editRow) {
    ...
    protected function restoreEditFormFromRow($row)
    {
        ...
        if (isset($row['invoice_title'])) { // invoice_title
            $this->invoice_title->CurrentValue = $row['invoice_title'];
        }
        if (isset($row['invoice_description'])) { // invoice_description
            $this->invoice_description->CurrentValue = $row['invoice_description'];
        }
    }
