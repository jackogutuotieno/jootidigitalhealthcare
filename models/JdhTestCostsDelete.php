 ...
 * Page class
 */
class JdhTestCostsDelete extends JdhTestCosts
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "JdhTestCostsDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "jdhtestcostsdelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("jdhtestcostslist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("jdhtestcostslist"); // Return to list
                return;
            }
        }
