...
/**
 * Table class for jdh_test_categories
 */
class JdhTestCategories extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        // Update Table
        $this->UpdateTable = "`jdh_test_categories`";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`jdh_test_categories`";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("jdhtestcategorieslist");
    }
    ...
    {
        global $Language;
        if ($pageName == "jdhtestcategoriesview") {
            return $Language->phrase("View");
        } elseif ($pageName == "jdhtestcategoriesedit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "jdhtestcategoriesadd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "JdhTestCategoriesView";
            case Config("API_ADD_ACTION"):
                return "JdhTestCategoriesAdd";
            case Config("API_EDIT_ACTION"):
                return "JdhTestCategoriesEdit";
            case Config("API_DELETE_ACTION"):
                return "JdhTestCategoriesDelete";
            case Config("API_LIST_ACTION"):
                return "JdhTestCategoriesList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("jdhtestcategoriesview", $parm);
        } else {
            $url = $this->keyUrl("jdhtestcategoriesview", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        if ($parm != "") {
            $url = "jdhtestcategoriesadd?" . $parm;
        } else {
            $url = "jdhtestcategoriesadd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("jdhtestcategoriesedit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("jdhtestcategorieslist", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("jdhtestcategoriesadd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("jdhtestcategorieslist", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl()
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("jdhtestcategoriesdelete");
        }
    }
    ...
    {
        global $Response;
        $listPage = "JdhTestCategoriesList";
