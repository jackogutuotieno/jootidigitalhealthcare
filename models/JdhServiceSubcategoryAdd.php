 ...
 * Page class
 */
class JdhServiceSubcategoryAdd extends JdhServiceSubcategory
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "JdhServiceSubcategoryAdd";
    ...
    // CSS class/style
    public $CurrentPageName = "jdhservicesubcategoryadd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($rsold)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "jdhservicesubcategoryview") {
    ...
    protected function addRow($rsold = null)
    {
        ...
        if ($this->description->CurrentValue != "") { // Check field with unique index
            $filter = "(`description` = '" . AdjustSql($this->description->CurrentValue, $this->Dbid) . "')";
    ...
    protected function getAddRow()
    {
        ...
        // subcategory_name
        $this->subcategory_name->setDbValueDef($rsnew, $this->subcategory_name->CurrentValue, false);
    ...
    protected function restoreAddFormFromRow($row)
    {
        ...
        if (isset($row['subcategory_name'])) { // subcategory_name
            $this->subcategory_name->setFormValue($row['subcategory_name']);
        }
