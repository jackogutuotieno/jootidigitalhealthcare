 ...
 * Page class
 */
class JdhUsersDelete extends JdhUsers
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "JdhUsersDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "jdhusersdelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("jdhuserslist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("jdhuserslist"); // Return to list
                return;
            }
        }
