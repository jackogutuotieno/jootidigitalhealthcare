 ...
 * Page class
 */
class LatestAppointmentsSummary extends LatestAppointments
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "LatestAppointmentsSummary";
    ...
    public $CurrentPageName = "latestappointments";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'Latest_Appointments';
        $this->TableName = 'Latest Appointments';
        ...
        // Table object (Latest_Appointments)
        if (!isset($GLOBALS["Latest_Appointments"]) || get_class($GLOBALS["Latest_Appointments"]) == PROJECT_NAMESPACE . "Latest_Appointments") {
            $GLOBALS["Latest_Appointments"] = &$this;
        }
        ...
        if (!defined(PROJECT_NAMESPACE . "TABLE_NAME")) {
            define(PROJECT_NAMESPACE . "TABLE_NAME", 'Latest Appointments');
        }
    ...
    public function loadRowValues($record)
    {
        ...
        $data["appointment_title"] = $record['appointment_title'];
        $data["appointment_start_date"] = $record['appointment_start_date'];
        $data["appointment_end_date"] = $record['appointment_end_date'];
        $data["appointment_all_day"] = $record['appointment_all_day'];
        $data["submission_date"] = $record['submission_date'];
        $data["subbmitted_by_user_id"] = $record['subbmitted_by_user_id'];
        $this->Rows[] = $data;
        $this->appointment_id->setDbValue($record['appointment_id']);
        $this->patient_id->setDbValue($record['patient_id']);
        $this->appointment_title->setDbValue($record['appointment_title']);
        $this->appointment_start_date->setDbValue($record['appointment_start_date']);
        $this->appointment_end_date->setDbValue($record['appointment_end_date']);
        $this->appointment_all_day->setDbValue($record['appointment_all_day']);
        $this->appointment_description->setDbValue($record['appointment_description']);
        $this->submission_date->setDbValue($record['submission_date']);
        $this->subbmitted_by_user_id->setDbValue($record['subbmitted_by_user_id']);
    }
    ...
    public function renderRow()
    {
        ...
        if ($this->RowType == ROWTYPE_SEARCH) { // Search row
            ...
            $this->appointment_title->CellCssClass = ($this->RecordCount % 2 != 1 ? "ew-table-alt-row" : "");
            ...
            $this->appointment_start_date->CellCssClass = ($this->RecordCount % 2 != 1 ? "ew-table-alt-row" : "");
            ...
            $this->appointment_end_date->CellCssClass = ($this->RecordCount % 2 != 1 ? "ew-table-alt-row" : "");
        ...
        if ($this->RowType == ROWTYPE_TOTAL) { // Summary row
            ...
            // appointment_title
            $currentValue = $this->appointment_title->CurrentValue;
            $viewValue = &$this->appointment_title->ViewValue;
            $viewAttrs = &$this->appointment_title->ViewAttrs;
            $cellAttrs = &$this->appointment_title->CellAttrs;
            $hrefValue = &$this->appointment_title->HrefValue;
            $linkAttrs = &$this->appointment_title->LinkAttrs;
            $this->cellRendered($this->appointment_title, $currentValue, $viewValue, $viewAttrs, $cellAttrs, $hrefValue, $linkAttrs);

            // appointment_start_date
            $currentValue = $this->appointment_start_date->CurrentValue;
            $viewValue = &$this->appointment_start_date->ViewValue;
            $viewAttrs = &$this->appointment_start_date->ViewAttrs;
            $cellAttrs = &$this->appointment_start_date->CellAttrs;
            $hrefValue = &$this->appointment_start_date->HrefValue;
            $linkAttrs = &$this->appointment_start_date->LinkAttrs;
            $this->cellRendered($this->appointment_start_date, $currentValue, $viewValue, $viewAttrs, $cellAttrs, $hrefValue, $linkAttrs);

            // appointment_end_date
            $currentValue = $this->appointment_end_date->CurrentValue;
            $viewValue = &$this->appointment_end_date->ViewValue;
            $viewAttrs = &$this->appointment_end_date->ViewAttrs;
            $cellAttrs = &$this->appointment_end_date->CellAttrs;
            $hrefValue = &$this->appointment_end_date->HrefValue;
            $linkAttrs = &$this->appointment_end_date->LinkAttrs;
            $this->cellRendered($this->appointment_end_date, $currentValue, $viewValue, $viewAttrs, $cellAttrs, $hrefValue, $linkAttrs);
        }
    ...
    protected function setupFieldCount()
    {
        ...
        if ($this->appointment_title->Visible) {
            $this->DetailColumnCount += 1;
        }
        if ($this->appointment_start_date->Visible) {
            $this->DetailColumnCount += 1;
        }
        if ($this->appointment_end_date->Visible) {
            $this->DetailColumnCount += 1;
        }
    }
    ...
    protected function setupOtherOptions()
    {
        ...
        $item->Body = "<a class=\"ew-save-filter\" data-form=\"fLatest_Appointmentssrch\" data-ew-action=\"none\">" . $Language->phrase("SaveCurrentFilter") . "</a>";
        $item->Visible = false;
        $item = &$this->FilterOptions->add("deletefilter");
        $item->Body = "<a class=\"ew-delete-filter\" data-form=\"fLatest_Appointmentssrch\" data-ew-action=\"none\">" . $Language->phrase("DeleteFilter") . "</a>";
        $item->Visible = false;
