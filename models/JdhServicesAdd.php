 ...
 * Page class
 */
class JdhServicesAdd extends JdhServices
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "JdhServicesAdd";
    ...
    // CSS class/style
    public $CurrentPageName = "jdhservicesadd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($rsold)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "jdhservicesview") {
        ...
        if ($this->RowType == RowType::VIEW) {
            ...
            if ($this->subcategory_id->ViewValue !== null) { // Load from cache
                ...
                if ($curVal == "") {
                    ...
                    $filterWrk = SearchFilter($this->subcategory_id->Lookup->getTable()->Fields["subcategory_id"]->searchExpression(), "=", $this->subcategory_id->CurrentValue, $this->subcategory_id->Lookup->getTable()->Fields["subcategory_id"]->searchDataType(), "");
                }
    ...
    protected function validateForm()
    {
        ...
        $validateForm = true;
            ...
            if ($this->service_cost->Visible && $this->service_cost->Required) {
            ...
            if ($this->service_description->Visible && $this->service_description->Required) {
    ...
    protected function getAddRow()
    {
        ...
        // service_cost
        $this->service_cost->setDbValueDef($rsnew, $this->service_cost->CurrentValue, false);

        // service_description
        $this->service_description->setDbValueDef($rsnew, $this->service_description->CurrentValue, false);
    ...
    protected function restoreAddFormFromRow($row)
    {
        ...
        if (isset($row['service_cost'])) { // service_cost
            $this->service_cost->setFormValue($row['service_cost']);
        }
        if (isset($row['service_description'])) { // service_description
            $this->service_description->setFormValue($row['service_description']);
        }
