...
class JdhServicesAdd extends JdhServices
{
    ...
    protected function addRow($rsold = null)
    {
        ...
        // subcategory_id
        $this->subcategory_id->setDbValueDef($rsnew, $this->subcategory_id->CurrentValue, 0, false);

        // service_name
        $this->service_name->setDbValueDef($rsnew, $this->service_name->CurrentValue, "", false);

        // service_cost
        $this->service_cost->setDbValueDef($rsnew, $this->service_cost->CurrentValue, 0, false);

        // service_description
        $this->service_description->setDbValueDef($rsnew, $this->service_description->CurrentValue, null, false);
