 ...
 * Page class
 */
class JdhBedsDelete extends JdhBeds
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "JdhBedsDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "jdhbedsdelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("jdhbedslist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("jdhbedslist"); // Return to list
                return;
            }
        }
