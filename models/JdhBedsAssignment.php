...
/**
 * Table class for jdh_beds_assignment
 */
class JdhBedsAssignment extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        // Update Table
        $this->UpdateTable = "`jdh_beds_assignment`";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`jdh_beds_assignment`";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("jdhbedsassignmentlist");
    }
    ...
    {
        global $Language;
        if ($pageName == "jdhbedsassignmentview") {
            return $Language->phrase("View");
        } elseif ($pageName == "jdhbedsassignmentedit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "jdhbedsassignmentadd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "JdhBedsAssignmentView";
            case Config("API_ADD_ACTION"):
                return "JdhBedsAssignmentAdd";
            case Config("API_EDIT_ACTION"):
                return "JdhBedsAssignmentEdit";
            case Config("API_DELETE_ACTION"):
                return "JdhBedsAssignmentDelete";
            case Config("API_LIST_ACTION"):
                return "JdhBedsAssignmentList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("jdhbedsassignmentview", $parm);
        } else {
            $url = $this->keyUrl("jdhbedsassignmentview", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        if ($parm != "") {
            $url = "jdhbedsassignmentadd?" . $parm;
        } else {
            $url = "jdhbedsassignmentadd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("jdhbedsassignmentedit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("jdhbedsassignmentlist", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("jdhbedsassignmentadd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("jdhbedsassignmentlist", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl()
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("jdhbedsassignmentdelete");
        }
    }
    ...
    {
        global $Response;
        $listPage = "JdhBedsAssignmentList";
    ...
    public function getUserIDSubquery(&$fld, &$masterfld)
    {
        global $UserTable;
        $wrk = "";
        $sql = "SELECT " . $masterfld->Expression . " FROM `jdh_beds_assignment`";
    ...
    {
        WriteAuditLog(CurrentUser(), $typ, 'jdh_beds_assignment', "", "", "", "");
    }
    ...
    public function writeAuditTrailOnAdd(&$rs)
    {
        ...
        foreach (array_keys($rs) as $fldname) {
            if (array_key_exists($fldname, $this->Fields) && $this->Fields[$fldname]->DataType != DATATYPE_BLOB) { // Ignore BLOB fields
                ...
                WriteAuditLog($usr, "A", 'jdh_beds_assignment', $fldname, $key, "", $newvalue);
            }
        }
    }
        ...
        foreach (array_keys($rsnew) as $fldname) {
            if (array_key_exists($fldname, $this->Fields) && array_key_exists($fldname, $rsold) && $this->Fields[$fldname]->DataType != DATATYPE_BLOB) { // Ignore BLOB fields
                ...
                if ($modified) {
                    ...
                    WriteAuditLog($usr, "U", 'jdh_beds_assignment', $fldname, $key, $oldvalue, $newvalue);
                }
            }
        }
    }
    ...
    public function writeAuditTrailOnDelete(&$rs)
    {
        ...
        foreach (array_keys($rs) as $fldname) {
            if (array_key_exists($fldname, $this->Fields) && $this->Fields[$fldname]->DataType != DATATYPE_BLOB) { // Ignore BLOB fields
                ...
                WriteAuditLog($usr, "D", 'jdh_beds_assignment', $fldname, $key, $oldvalue, "");
            }
        }
    }
