 ...
 * Page class
 */
class JdhFacilityUnitsAdd extends JdhFacilityUnits
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "JdhFacilityUnitsAdd";
    ...
    // CSS class/style
    public $CurrentPageName = "jdhfacilityunitsadd";
        ...
        switch ($this->CurrentAction) {
            case "copy": // Copy an existing record
                if (!$rsold) { // Record not loaded
                    ...
                    $this->terminate("jdhfacilityunitslist"); // No matching record, return to list
                    return;
                }
                break;
            case "insert": // Add new record
                ...
                if ($this->addRow($rsold)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "jdhfacilityunitsview") {
    ...
    protected function loadFormValues()
    {
        ...
        // Check field name 'unit_name' first before field var 'x_unit_name'
        $val = $CurrentForm->hasValue("unit_name") ? $CurrentForm->getValue("unit_name") : $CurrentForm->getValue("x_unit_name");
        if (!$this->unit_name->IsDetailKey) {
            if (IsApi() && $val === null) {
                $this->unit_name->Visible = false; // Disable update for API request
            } else {
                $this->unit_name->setFormValue($val);
            }
        }
    ...
    public function renderRow()
    {
        ...
        // unit_name
        $this->unit_name->RowCssClass = "row";
        ...
        if ($this->RowType == RowType::VIEW) {
            ...
            $this->unit_name->EditValue = HtmlEncode($this->unit_name->CurrentValue);
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("jdhfacilityunitslist"), "", $this->TableVar, true);
