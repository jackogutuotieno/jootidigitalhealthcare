 ...
 * Page class
 */
class JdhExaminationFindingsDelete extends JdhExaminationFindings
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "JdhExaminationFindingsDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "jdhexaminationfindingsdelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("jdhexaminationfindingslist"); // Prevent SQL injection, return to list
            return;
        }
