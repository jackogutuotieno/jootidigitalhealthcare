...
class JdhExportlog extends DbTable
{
    ...
    public function getModalCaption($pageName)
    {
        ...
        return match ($pageName) {
            "jdhexportlogview" => $Language->phrase("View"),
            "jdhexportlogedit" => $Language->phrase("Edit"),
            "jdhexportlogadd" => $Language->phrase("Add"),
            default => ""
        };
    }
    ...
    public function getApiPageName($action)
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "JdhExportlogView",
            Config("API_ADD_ACTION") => "JdhExportlogAdd",
            Config("API_EDIT_ACTION") => "JdhExportlogEdit",
            Config("API_DELETE_ACTION") => "JdhExportlogDelete",
            Config("API_LIST_ACTION") => "JdhExportlogList",
            default => ""
        };
    }
    ...
    public function getDeleteUrl($parm = "")
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("jdhexportlogdelete", $parm);
        }
    }
    ...
    {
        $json = "";
        $json .= "\"FileId\":" . VarToJson($this->FileId->CurrentValue, "string");
        $json = "{" . $json . "}";
        if ($htmlEncode) {
