 ...
 * Page class
 */
class JdhStatusView extends JdhStatus
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "JdhStatusView";
    ...
    // CSS class/style
    public $CurrentPageName = "jdhstatusview";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("status_id") ?? Route("status_id")) !== null) {
            ...
            $returnUrl = "jdhstatuslist"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "jdhstatuslist"; // No matching record, return to list
                    }
                break;
        }
    ...
    protected function getExportTag($type, $custom = false)
    {
        ...
        if (SameText($type, "excel")) {
            ...
            return '<button type="button" class="btn btn-default ew-export-link ew-email" title="' . $Language->phrase("ExportToEmail", true) . '" data-caption="' . $Language->phrase("ExportToEmail", true) . '" form="fjdh_statusview" data-ew-action="email" data-hdr="' . $Language->phrase("ExportToEmail", true) . '" data-key="' . HtmlEncode(ArrayToJsonAttribute($this->RecKey)) . '" data-exported-selected="false"' . $url . '>' . $Language->phrase("ExportToEmail") . '</button>';
    ...
    */
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("jdhstatuslist"), "", $this->TableVar, true);
        $pageId = "view";
