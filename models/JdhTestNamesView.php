 ...
 * Page class
 */
class JdhTestNamesView extends JdhTestNames
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "JdhTestNamesView";
    ...
    // CSS class/style
    public $CurrentPageName = "jdhtestnamesview";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("test_id") ?? Route("test_id")) !== null) {
            ...
            $returnUrl = "jdhtestnameslist"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "jdhtestnameslist"; // No matching record, return to list
                    }
                break;
        }
    ...
    protected function getExportTag($type, $custom = false)
    {
        ...
        if (SameText($type, "excel")) {
            ...
            return '<button type="button" class="btn btn-default ew-export-link ew-email" title="' . $Language->phrase("ExportToEmail", true) . '" data-caption="' . $Language->phrase("ExportToEmail", true) . '" form="fjdh_test_namesview" data-ew-action="email" data-hdr="' . $Language->phrase("ExportToEmail", true) . '" data-key="' . HtmlEncode(ArrayToJsonAttribute($this->RecKey)) . '" data-exported-selected="false"' . $url . '>' . $Language->phrase("ExportToEmail") . '</button>';
