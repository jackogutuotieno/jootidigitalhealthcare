...
class JdhServicesEdit extends JdhServices
{
    ...
    protected function getEditRow($rsold)
    {
        ...
        // service_cost
        $this->service_cost->setDbValueDef($rsnew, $this->service_cost->CurrentValue, $this->service_cost->ReadOnly);

        // service_description
        $this->service_description->setDbValueDef($rsnew, $this->service_description->CurrentValue, $this->service_description->ReadOnly);
        return $rsnew;
    }
    ...
    protected function restoreEditFormFromRow($row)
    {
        ...
        if (isset($row['service_cost'])) { // service_cost
            $this->service_cost->CurrentValue = $row['service_cost'];
        }
        if (isset($row['service_description'])) { // service_description
            $this->service_description->CurrentValue = $row['service_description'];
        }
    }
