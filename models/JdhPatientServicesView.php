 ...
 * Page class
 */
class JdhPatientServicesView extends JdhPatientServices
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "JdhPatientServicesView";
    ...
    // CSS class/style
    public $CurrentPageName = "jdhpatientservicesview";
    ...
    public function __construct()
    {
        ...
        if (($keyValue = Get("patient_service_id") ?? Route("patient_service_id")) !== null) {
            $this->RecKey["patient_service_id"] = $keyValue;
        }
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("patient_service_id") ?? Route("patient_service_id")) !== null) {
            ...
            $this->RecKey["patient_service_id"] = $this->patient_service_id->QueryStringValue;
        } elseif (Post("patient_service_id") !== null) {
            $this->patient_service_id->setFormValue(Post("patient_service_id"));
            $this->RecKey["patient_service_id"] = $this->patient_service_id->FormValue;
        } elseif (IsApi() && ($keyValue = Key(0) ?? Route(2)) !== null) {
            $this->patient_service_id->setQueryStringValue($keyValue);
            $this->RecKey["patient_service_id"] = $this->patient_service_id->QueryStringValue;
        } elseif (!$loadCurrentRecord) {
            $returnUrl = "jdhpatientserviceslist"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "jdhpatientserviceslist"; // No matching record, return to list
                    }
                break;
        }
    ...
    protected function getExportTag($type, $custom = false)
    {
        ...
        if (SameText($type, "excel")) {
            ...
            return '<button type="button" class="btn btn-default ew-export-link ew-email" title="' . $Language->phrase("ExportToEmail", true) . '" data-caption="' . $Language->phrase("ExportToEmail", true) . '" form="fjdh_patient_servicesview" data-ew-action="email" data-hdr="' . $Language->phrase("ExportToEmail", true) . '" data-key="' . HtmlEncode(ArrayToJsonAttribute($this->RecKey)) . '" data-exported-selected="false"' . $url . '>' . $Language->phrase("ExportToEmail") . '</button>';
    ...
    */
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("jdhpatientserviceslist"), "", $this->TableVar, true);
        $pageId = "view";
