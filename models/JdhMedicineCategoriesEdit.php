 ...
 * Page class
 */
class JdhMedicineCategoriesEdit extends JdhMedicineCategories
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "JdhMedicineCategoriesEdit";
    ...
    // CSS class/style
    public $CurrentPageName = "jdhmedicinecategoriesedit";
    ...
    protected function restoreEditFormFromRow($row)
    {
        if (isset($row['category_name'])) { // category_name
            $this->category_name->CurrentValue = $row['category_name'];
        }
