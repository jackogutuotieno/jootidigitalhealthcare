 ...
 * Page class
 */
class JdhAudittrailDelete extends JdhAudittrail
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "JdhAudittrailDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "jdhaudittraildelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("jdhaudittraillist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("jdhaudittraillist"); // Return to list
                return;
            }
        }
