...
class JdhPatientCases extends DbTable
{
    ...
    public function getModalCaption($pageName)
    {
        ...
        return match ($pageName) {
            "jdhpatientcasesview" => $Language->phrase("View"),
            "jdhpatientcasesedit" => $Language->phrase("Edit"),
            "jdhpatientcasesadd" => $Language->phrase("Add"),
            default => ""
        };
    }
    ...
    public function getApiPageName($action)
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "JdhPatientCasesView",
            Config("API_ADD_ACTION") => "JdhPatientCasesAdd",
            Config("API_EDIT_ACTION") => "JdhPatientCasesEdit",
            Config("API_DELETE_ACTION") => "JdhPatientCasesDelete",
            Config("API_LIST_ACTION") => "JdhPatientCasesList",
            default => ""
        };
    }
    ...
    public function getDeleteUrl($parm = "")
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("jdhpatientcasesdelete", $parm);
        }
    }
    ...
    {
        $json = "";
        $json .= "\"case_id\":" . VarToJson($this->case_id->CurrentValue, "number");
        $json = "{" . $json . "}";
        if ($htmlEncode) {
    ...
    {
        WriteAuditLog(CurrentUserIdentifier(), $typ, 'jdh_patient_cases');
    }
