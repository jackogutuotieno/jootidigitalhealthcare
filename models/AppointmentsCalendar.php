...
class AppointmentsCalendar extends Appointments
{
    ...
    public function run()
    {
        ...
        $this->ViewUrl = "appointmentsview";
        $this->AddUrl = "appointmentsadd";
        $this->EditUrl = "appointmentsedit";
        $this->DeleteUrl = "appointmentsdelete";
    ...
    public function getEvents()
    {
        ...
        $this->Fields['appointment_date']->FormatPattern = "yyyy-MM-dd'T'HH:mm:ss";
    ...
    {
        $eventListFields = ["appointment_id","patient_id","appointment_title","submission_date","subbmitted_by_user_id","appointment_end_date","appointment_start_date"];
        $event = [];
