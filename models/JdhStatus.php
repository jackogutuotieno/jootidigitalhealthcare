...
/**
 * Table class for jdh_status
 */
class JdhStatus extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->status_id->IsAutoIncrement = true; // Autoincrement field
        ...
        $this->status_id->SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN"];
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "jdh_status";
    }
    ...
    public function insert(&$rs)
    {
        ...
        if ($result) {
            $this->status_id->setDbValue($conn->lastInsertId());
    ...
    public function update(&$rs, $where = "", $rsold = null, $curfilter = true)
    {
        ...
        if ($success) {
            if (!isset($rs['status_id']) && !EmptyValue($this->status_id->CurrentValue)) {
                $rs['status_id'] = $this->status_id->CurrentValue;
            }
        }
        return $success;
    }
    ...
    public function getRecordFilter($row = null, $current = false)
    {
        ...
        if (is_array($row)) {
            ...
            $val = !EmptyValue($this->status_id->OldValue) && !$current ? $this->status_id->OldValue : $this->status_id->CurrentValue;
        }
        if (!is_numeric($val)) {
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("jdhstatuslist");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        return match ($pageName) {
            "jdhstatusview" => $Language->phrase("View"),
            "jdhstatusedit" => $Language->phrase("Edit"),
            "jdhstatusadd" => $Language->phrase("Add"),
            default => ""
        };
    }
    ...
    public function getApiPageName($action)
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "JdhStatusView",
            Config("API_ADD_ACTION") => "JdhStatusAdd",
            Config("API_EDIT_ACTION") => "JdhStatusEdit",
            Config("API_DELETE_ACTION") => "JdhStatusDelete",
            Config("API_LIST_ACTION") => "JdhStatusList",
            default => ""
        };
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("jdhstatusview", $parm);
        } else {
            $url = $this->keyUrl("jdhstatusview", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("jdhstatusedit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("jdhstatuslist", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("jdhstatusadd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("jdhstatuslist", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl($parm = "")
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("jdhstatusdelete", $parm);
        }
    }
    ...
    {
        $json = "";
        $json .= "\"status_id\":" . VarToJson($this->status_id->CurrentValue, "number");
        $json = "{" . $json . "}";
        if ($htmlEncode) {
    ...
    public function keyUrl($url, $parm = "")
    {
        if ($this->status_id->CurrentValue !== null) {
            $url .= "/" . $this->encodeKeyValue($this->status_id->CurrentValue);
        } else {
