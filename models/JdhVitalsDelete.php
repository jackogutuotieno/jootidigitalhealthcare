 ...
 * Page class
 */
class JdhVitalsDelete extends JdhVitals
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "JdhVitalsDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "jdhvitalsdelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("jdhvitalslist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if (!$res) {
            $this->terminate("jdhvitalslist"); // Return to list
            return;
        }
