...
class JdhPrescriptionsList extends JdhPrescriptions
{
    ...
    public function __construct()
    {
        ...
        if (!isset($GLOBALS["jdh_prescriptions"]) || $GLOBALS["jdh_prescriptions"]::class == PROJECT_NAMESPACE . "jdh_prescriptions") {
        ...
        if ($url != "") {
            ...
            if ($this->IsModal) { // Show as modal
                ...
                if (!SameString($pageName, GetPageName($this->getListUrl()))) { // Not List page
                    ...
                    $result["view"] = SameString($pageName, "jdhprescriptionsview"); // If View page, no primary button
                } else { // List page
    ...
    public function getFilterList()
    {
        ...
        if (Config("SEARCH_FILTER_OPTION") == "Server") {
            $savedFilterList = Profile()->getSearchFilters("fjdh_prescriptionssrch");
        }
        ...
        $filterList = Concat($filterList, $this->prescription_days->AdvancedSearch->toJson(), ","); // Field prescription_days
    ...
    protected function processFilterList()
    {
        if (Post("ajax") == "savefilters") { // Save filter request (Ajax)
            ...
            Profile()->setSearchFilters("fjdh_prescriptionssrch", $filters);
    ...
    protected function restoreFilterList()
    {
        ...
        // Field prescription_days
        $this->prescription_days->AdvancedSearch->SearchValue = @$filter["x_prescription_days"];
        $this->prescription_days->AdvancedSearch->SearchOperator = @$filter["z_prescription_days"];
        $this->prescription_days->AdvancedSearch->SearchCondition = @$filter["v_prescription_days"];
        $this->prescription_days->AdvancedSearch->SearchValue2 = @$filter["y_prescription_days"];
        $this->prescription_days->AdvancedSearch->SearchOperator2 = @$filter["w_prescription_days"];
        $this->prescription_days->AdvancedSearch->save();
    ...
    protected function setupSortOrder()
    {
        ...
        if (Get("order") !== null) {
            ...
            $this->updateSort($this->prescription_days); // prescription_days
    ...
    protected function resetCmd()
    {
        ...
        if (StartsString("reset", $this->Command)) {
            ...
            if ($this->Command == "resetsort") {
                ...
                $this->prescription_days->setSort("");
                ...
                if ($listAction->Select == ACTION_SINGLE && $allowed) {
                    ...
                    if ($action != "") {
                        ...
                        $link = $disabled
                            ...
                            : "<li><button type=\"button\" class=\"dropdown-item ew-action ew-list-action\" data-caption=\"" . $title . "\" data-ew-action=\"submit\" form=\"fjdh_prescriptionslist\" data-key=\"" . $this->keyToJson(true) . "\"" . $listAction->toDataAttrs() . ">" . $icon . " " . $caption . "</button></li>";
                        $links[] = $link;
                        if ($body == "") { // Setup first button
                            $body = $disabled
                            ? "<div class=\"alert alert-light\">" . $icon . " " . $caption . "</div>"
                            : "<button type=\"button\" class=\"btn btn-default ew-action ew-list-action\" title=\"" . $title . "\" data-caption=\"" . $title . "\" data-ew-action=\"submit\" form=\"fjdh_prescriptionslist\" data-key=\"" . $this->keyToJson(true) . "\"" . $listAction->toDataAttrs() . ">" . $icon . " " . $caption . "</button>";
                        }
                    }
                }
            }
    ...
    protected function setupOtherOptions()
    {
        ...
        if ($this->UseColumnVisibility) {
            ...
            $this->createColumnOption($option, "prescription_title");
            $this->createColumnOption($option, "medicine_id");
            $this->createColumnOption($option, "tabs");
            $this->createColumnOption($option, "frequency");
            $this->createColumnOption($option, "prescription_days");
            $this->createColumnOption($option, "prescription_time");
            $this->createColumnOption($option, "prescription_date");
        }
    ...
    public function setupRow()
    {
        ...
        if ($this->isGridAdd() || $this->isGridEdit()) {
            if ($this->RowIndex === '$rowindex$') { // Render template row first
                ...
                // Set row properties
                $this->resetAttributes();
                $this->RowAttrs->merge(["data-rowindex" => $this->RowIndex, "id" => "r0_jdh_prescriptions", "data-rowtype" => RowType::ADD]);
        ...
        if ($this->RowType == RowType::VIEW) {
            ...
            if ($curVal != "") {
                ...
                if ($this->medicine_id->ViewValue === null) { // Lookup from database
                    $filterWrk = SearchFilter($this->medicine_id->Lookup->getTable()->Fields["id"]->searchExpression(), "=", $curVal, $this->medicine_id->Lookup->getTable()->Fields["id"]->searchDataType(), "");
        ...
        if (Config("EXPORT_MASTER_RECORD") && $this->DbMasterFilter != "" && $this->getCurrentMasterTable() == "jdh_patients") {
            ...
            if ($rsmaster) {
                ...
                if (!$this->isExport("csv") || Config("EXPORT_MASTER_RECORD_FOR_CSV")) {
                    $doc->setTable($jdh_patients);
                    $jdh_patients->exportDocument($doc, $rsmaster);
                    $doc->exportEmptyRow();
                    $doc->setTable($this);
                }
