 ...
 * Page class
 */
class JdhMedicineSubcategoriesDelete extends JdhMedicineSubcategories
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "JdhMedicineSubcategoriesDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "jdhmedicinesubcategoriesdelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("jdhmedicinesubcategorieslist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("jdhmedicinesubcategorieslist"); // Return to list
                return;
            }
        }
