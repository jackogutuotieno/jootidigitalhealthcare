...
class JdhConsultationIncome extends DbTable
{
    ...
    public function getModalCaption($pageName)
    {
        ...
        return match ($pageName) {
            "jdhconsultationincomeview" => $Language->phrase("View"),
            "jdhconsultationincomeedit" => $Language->phrase("Edit"),
            "jdhconsultationincomeadd" => $Language->phrase("Add"),
            default => ""
        };
    }
    ...
    public function getApiPageName($action)
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "JdhConsultationIncomeView",
            Config("API_ADD_ACTION") => "JdhConsultationIncomeAdd",
            Config("API_EDIT_ACTION") => "JdhConsultationIncomeEdit",
            Config("API_DELETE_ACTION") => "JdhConsultationIncomeDelete",
            Config("API_LIST_ACTION") => "JdhConsultationIncomeList",
            default => ""
        };
    }
    ...
    public function getDeleteUrl($parm = "")
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("jdhconsultationincomedelete", $parm);
        }
    }
