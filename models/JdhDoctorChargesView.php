 ...
 * Page class
 */
class JdhDoctorChargesView extends JdhDoctorCharges
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "JdhDoctorChargesView";
    ...
    // CSS class/style
    public $CurrentPageName = "jdhdoctorchargesview";
    ...
    public function __construct()
    {
        ...
        if (!isset($GLOBALS["jdh_doctor_charges"]) || $GLOBALS["jdh_doctor_charges"]::class == PROJECT_NAMESPACE . "jdh_doctor_charges") {
        ...
        if ($url != "") {
            ...
            if ($this->IsModal) { // Show as modal
                ...
                if (!SameString($pageName, GetPageName($this->getListUrl()))) { // Not List page
                    ...
                    $result["view"] = SameString($pageName, "jdhdoctorchargesview"); // If View page, no primary button
                } else { // List page
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("id") ?? Route("id")) !== null) {
            ...
            $returnUrl = "jdhdoctorchargeslist"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "jdhdoctorchargeslist"; // No matching record, return to list
                    }
                break;
        }
    ...
    protected function getExportTag($type, $custom = false)
    {
        ...
        if (SameText($type, "excel")) {
            ...
            return '<button type="button" class="btn btn-default ew-export-link ew-email" title="' . $Language->phrase("ExportToEmail", true) . '" data-caption="' . $Language->phrase("ExportToEmail", true) . '" form="fjdh_doctor_chargesview" data-ew-action="email" data-hdr="' . $Language->phrase("ExportToEmail", true) . '" data-key="' . ArrayToJsonAttribute($this->RecKey) . '" data-exported-selected="false"' . $url . '>' . $Language->phrase("ExportToEmail") . '</button>';
    ...
    */
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("jdhdoctorchargeslist"), "", $this->TableVar, true);
        $pageId = "view";
