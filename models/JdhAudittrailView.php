 ...
 * Page class
 */
class JdhAudittrailView extends JdhAudittrail
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "JdhAudittrailView";
    ...
    // CSS class/style
    public $CurrentPageName = "jdhaudittrailview";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("Id") ?? Route("Id")) !== null) {
            ...
            $returnUrl = "jdhaudittraillist"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "jdhaudittraillist"; // No matching record, return to list
                    }
                break;
        }
