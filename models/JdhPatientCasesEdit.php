...
class JdhPatientCasesEdit extends JdhPatientCases
{
    ...
    protected function validateForm()
    {
        ...
        $validateForm = true;
            if ($this->case_id->Visible && $this->case_id->Required) {
    ...
    protected function getEditRow($rsold)
    {
        ...
        // history
        $this->history->setDbValueDef($rsnew, $this->history->CurrentValue, $this->history->ReadOnly);
    ...
    protected function restoreEditFormFromRow($row)
    {
        ...
        if (isset($row['history'])) { // history
            $this->history->CurrentValue = $row['history'];
        }
        ...
        if (isset($row['medical_history'])) { // medical_history
            $this->medical_history->CurrentValue = $row['medical_history'];
        }
        if (isset($row['family'])) { // family
            $this->family->CurrentValue = $row['family'];
        }
        if (isset($row['socio_economic_history'])) { // socio_economic_history
            $this->socio_economic_history->CurrentValue = $row['socio_economic_history'];
        }
