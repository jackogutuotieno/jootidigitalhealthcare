...
/**
 * Table class for jdh_patient_queue
 */
class JdhPatientQueue extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        // Update Table
        $this->UpdateTable = "`jdh_patient_queue`";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`jdh_patient_queue`";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("jdhpatientqueuelist");
    }
    ...
    {
        global $Language;
        if ($pageName == "jdhpatientqueueview") {
            return $Language->phrase("View");
        } elseif ($pageName == "jdhpatientqueueedit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "jdhpatientqueueadd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "JdhPatientQueueView";
            case Config("API_ADD_ACTION"):
                return "JdhPatientQueueAdd";
            case Config("API_EDIT_ACTION"):
                return "JdhPatientQueueEdit";
            case Config("API_DELETE_ACTION"):
                return "JdhPatientQueueDelete";
            case Config("API_LIST_ACTION"):
                return "JdhPatientQueueList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("jdhpatientqueueview", $parm);
        } else {
            $url = $this->keyUrl("jdhpatientqueueview", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        if ($parm != "") {
            $url = "jdhpatientqueueadd?" . $parm;
        } else {
            $url = "jdhpatientqueueadd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("jdhpatientqueueedit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("jdhpatientqueuelist", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("jdhpatientqueueadd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("jdhpatientqueuelist", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl()
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("jdhpatientqueuedelete");
        }
    }
