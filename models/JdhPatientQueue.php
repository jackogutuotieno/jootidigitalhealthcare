...
class JdhPatientQueue extends DbTable
{
    ...
    public function getModalCaption($pageName)
    {
        ...
        return match ($pageName) {
            "jdhpatientqueueview" => $Language->phrase("View"),
            "jdhpatientqueueedit" => $Language->phrase("Edit"),
            "jdhpatientqueueadd" => $Language->phrase("Add"),
            default => ""
        };
    }
    ...
    public function getApiPageName($action)
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "JdhPatientQueueView",
            Config("API_ADD_ACTION") => "JdhPatientQueueAdd",
            Config("API_EDIT_ACTION") => "JdhPatientQueueEdit",
            Config("API_DELETE_ACTION") => "JdhPatientQueueDelete",
            Config("API_LIST_ACTION") => "JdhPatientQueueList",
            default => ""
        };
    }
    ...
    public function getDeleteUrl($parm = "")
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("jdhpatientqueuedelete", $parm);
        }
    }
