...
class JdhMedicineStock extends DbTable
{
    ...
    public function getModalCaption($pageName)
    {
        ...
        return match ($pageName) {
            "jdhmedicinestockview" => $Language->phrase("View"),
            "jdhmedicinestockedit" => $Language->phrase("Edit"),
            "jdhmedicinestockadd" => $Language->phrase("Add"),
            default => ""
        };
    }
    ...
    public function getApiPageName($action)
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "JdhMedicineStockView",
            Config("API_ADD_ACTION") => "JdhMedicineStockAdd",
            Config("API_EDIT_ACTION") => "JdhMedicineStockEdit",
            Config("API_DELETE_ACTION") => "JdhMedicineStockDelete",
            Config("API_LIST_ACTION") => "JdhMedicineStockList",
            default => ""
        };
    }
    ...
    public function getDeleteUrl($parm = "")
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("jdhmedicinestockdelete", $parm);
        }
    }
    ...
    {
        WriteAuditLog(CurrentUserIdentifier(), $typ, 'jdh_medicine_stock');
    }
