...
class JdhMedicines extends DbTable
{
    ...
    public function __construct()
    {
        ...
        // buying_price $tbl, $fldvar, $fldname, $fldexp, $fldbsexp, $fldtype, $fldsize, $flddtfmt, $upload, $fldvirtualexp, $fldvirtual, $forceselect, $fldvirtualsrch, $fldviewtag = "", $fldhtmltag
        ...
        // expiry $tbl, $fldvar, $fldname, $fldexp, $fldbsexp, $fldtype, $fldsize, $flddtfmt, $upload, $fldvirtualexp, $fldvirtual, $forceselect, $fldvirtualsrch, $fldviewtag = "", $fldhtmltag
    ...
    {
        global $Language;
        if ($pageName == "jdhmedicinesview") {
            return $Language->phrase("View");
        } elseif ($pageName == "jdhmedicinesedit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "jdhmedicinesadd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "JdhMedicinesView";
            case Config("API_ADD_ACTION"):
                return "JdhMedicinesAdd";
            case Config("API_EDIT_ACTION"):
                return "JdhMedicinesEdit";
            case Config("API_DELETE_ACTION"):
                return "JdhMedicinesDelete";
    ...
    public function getDeleteUrl()
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("jdhmedicinesdelete");
        }
    }
