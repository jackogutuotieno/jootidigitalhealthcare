 ...
 * Page class
 */
class JdhInvoiceItemsDelete extends JdhInvoiceItems
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "JdhInvoiceItemsDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "jdhinvoiceitemsdelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("jdhinvoiceitemslist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("jdhinvoiceitemslist"); // Return to list
                return;
            }
        }
