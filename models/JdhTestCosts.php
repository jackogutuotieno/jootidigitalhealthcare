...
/**
 * Table class for jdh_test_costs
 */
class JdhTestCosts extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        // Update Table
        $this->UpdateTable = "`jdh_test_costs`";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        $this->test_category_id->Lookup = new Lookup('test_category_id', 'jdh_lab_test_categories', false, 'test_category_id', ["test_category_name","","",""], '', '', [], ["x_test_subcategory_id"], [], [], [], [], '', '', "`test_category_name`");
        ...
        $this->test_subcategory_id->Lookup = new Lookup('test_subcategory_id', 'jdh_lab_test_subcategories', false, 'test_subcategory_id', ["test_subcategory_name","","",""], '', '', ["x_test_category_id"], [], ["test_category_id"], ["x_test_category_id"], [], [], '', '', "`test_subcategory_name`");
        ...
        $this->date_submitted = new DbField(
            ...
            CastDateFieldForLike("`date_submitted`", 1, "DB"), // Basic search expression
            135, // Type
            19, // Size
            1, // Date/Time format
            false, // Is upload field
        ...
        $this->date_submitted->DefaultErrorMessage = str_replace("%s", DateFormat(1), $Language->phrase("IncorrectDate"));
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`jdh_test_costs`";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("jdhtestcostslist");
    }
    ...
    {
        global $Language;
        if ($pageName == "jdhtestcostsview") {
            return $Language->phrase("View");
        } elseif ($pageName == "jdhtestcostsedit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "jdhtestcostsadd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "JdhTestCostsView";
            case Config("API_ADD_ACTION"):
                return "JdhTestCostsAdd";
            case Config("API_EDIT_ACTION"):
                return "JdhTestCostsEdit";
            case Config("API_DELETE_ACTION"):
                return "JdhTestCostsDelete";
            case Config("API_LIST_ACTION"):
                return "JdhTestCostsList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("jdhtestcostsview", $parm);
        } else {
            $url = $this->keyUrl("jdhtestcostsview", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("jdhtestcostsedit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("jdhtestcostslist", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("jdhtestcostsadd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("jdhtestcostslist", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl()
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("jdhtestcostsdelete");
        }
    }
