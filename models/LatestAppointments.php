...
/**
 * Table class for Latest Appointments
 */
class LatestAppointments extends ReportTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->ReportSourceTable = 'jdh_appointments'; // Report source table
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        $this->appointment_all_day->Lookup = new Lookup('appointment_all_day', 'Latest_Appointments', false, '', ["","","",""], '', '', [], [], [], [], [], [], '', '', "");
    ...
    {
        return "LatestAppointmentsSummary";
    }
