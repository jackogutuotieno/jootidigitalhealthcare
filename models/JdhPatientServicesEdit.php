 ...
 * Page class
 */
class JdhPatientServicesEdit extends JdhPatientServices
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "JdhPatientServicesEdit";
    ...
    // CSS class/style
    public $CurrentPageName = "jdhpatientservicesedit";
    ...
    public function run()
    {
        ...
        if (IsApi()) {
            // Load key values
            $loaded = true;
            if (($keyValue = Get("patient_service_id") ?? Key(0) ?? Route(2)) !== null) {
                $this->patient_service_id->setQueryStringValue($keyValue);
                $this->patient_service_id->setOldValue($this->patient_service_id->QueryStringValue);
            } elseif (Post("patient_service_id") !== null) {
                $this->patient_service_id->setFormValue(Post("patient_service_id"));
                $this->patient_service_id->setOldValue($this->patient_service_id->FormValue);
            } else {
            ...
            if (Post("action") !== null) {
                ...
                if (($keyValue = Get("patient_service_id") ?? Route("patient_service_id")) !== null) {
                    ...
                    $this->patient_service_id->CurrentValue = null;
                }
            }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    if (!$loaded) { // Load record based on key
                        ...
                        $this->terminate("jdhpatientserviceslist"); // No matching record, return to list
                        return;
                    }
                break;
            case "update": // Update
                $returnUrl = $this->getReturnUrl();
                if (GetPageName($returnUrl) == "jdhpatientserviceslist") {
                ...
                if ($this->editRow()) {
                    ...
                    if ($this->UseAjaxActions && GetPageName($returnUrl) != "jdhpatientserviceslist") {
                        Container("flash")->addMessage("Return-Url", $returnUrl); // Save return URL
                        $returnUrl = "jdhpatientserviceslist"; // Return list page content
                    }
    ...
    protected function loadFormValues()
    {
        ...
        if (!$this->patient_service_id->IsDetailKey) {
    ...
    public function renderRow()
    {
        ...
        // patient_service_id
        $this->patient_service_id->RowCssClass = "row";
