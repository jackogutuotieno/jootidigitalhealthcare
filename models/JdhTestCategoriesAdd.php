 ...
 * Page class
 */
class JdhTestCategoriesAdd extends JdhTestCategories
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "JdhTestCategoriesAdd";
    ...
    // CSS class/style
    public $CurrentPageName = "jdhtestcategoriesadd";
        ...
        switch ($this->CurrentAction) {
            case "copy": // Copy an existing record
                if (!$rsold) { // Record not loaded
                    ...
                    $this->terminate("jdhtestcategorieslist"); // No matching record, return to list
                    return;
                }
                break;
            case "insert": // Add new record
                ...
                if ($this->addRow($rsold)) {
                    ...
                    if (GetPageName($returnUrl) == "jdhtestcategorieslist") {
                        $returnUrl = $this->addMasterUrl($returnUrl); // List page, return to List page with correct master key if necessary
                    } elseif (GetPageName($returnUrl) == "jdhtestcategoriesview") {
                        $returnUrl = $this->getViewUrl(); // View page, return to View page with keyurl directly
                    }

                    // Handle UseAjaxActions with return page
                    if ($this->UseAjaxActions && GetPageName($returnUrl) != "jdhtestcategorieslist") {
                        Container("flash")->addMessage("Return-Url", $returnUrl); // Save return URL
                        $returnUrl = "jdhtestcategorieslist"; // Return list page content
                    }
