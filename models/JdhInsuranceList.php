 ...
 * Page class
 */
class JdhInsuranceList extends JdhInsurance
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "JdhInsuranceList";
    ...
    public $FormName = "fjdh_insurancelist";
    public $FormActionName = "";
    public $FormBlankRowName = "";
    public $FormKeyCountName = "";

    // CSS class/style
    public $CurrentPageName = "jdhinsurancelist";
    ...
    public function __construct()
    {
        ...
        // Initialize URLs
        $this->AddUrl = "jdhinsuranceadd";
        $this->InlineAddUrl = $pageUrl . "action=add";
        $this->GridAddUrl = $pageUrl . "action=gridadd";
        $this->GridEditUrl = $pageUrl . "action=gridedit";
        $this->MultiEditUrl = $pageUrl . "action=multiedit";
        $this->MultiDeleteUrl = "jdhinsurancedelete";
        $this->MultiUpdateUrl = "jdhinsuranceupdate";
    ...
    public function run()
    {
        ...
        if ($this->IsModal) {
            $this->FormName = "fjdh_insurancegrid";
        }
    ...
    public function getFilterList()
    {
        ...
        if (Config("SEARCH_FILTER_OPTION") == "Server" && isset($UserProfile)) {
            $savedFilterList = $UserProfile->getSearchFilters(CurrentUserName(), "fjdh_insurancesrch");
        }
        $filterList = Concat($filterList, $this->insurance_id->AdvancedSearch->toJson(), ","); // Field insurance_id
        $filterList = Concat($filterList, $this->insurance_name->AdvancedSearch->toJson(), ","); // Field insurance_name
        $filterList = Concat($filterList, $this->insurance_contact_person->AdvancedSearch->toJson(), ","); // Field insurance_contact_person
        $filterList = Concat($filterList, $this->insurance_contact_person_phone->AdvancedSearch->toJson(), ","); // Field insurance_contact_person_phone
        $filterList = Concat($filterList, $this->insurance_contact_person_email->AdvancedSearch->toJson(), ","); // Field insurance_contact_person_email
    ...
    protected function processFilterList()
    {
        ...
        if (Post("ajax") == "savefilters") { // Save filter request (Ajax)
            ...
            $UserProfile->setSearchFilters(CurrentUserName(), "fjdh_insurancesrch", $filters);
    ...
    protected function restoreFilterList()
    {
        ...
        // Field insurance_id
        $this->insurance_id->AdvancedSearch->SearchValue = @$filter["x_insurance_id"];
        $this->insurance_id->AdvancedSearch->SearchOperator = @$filter["z_insurance_id"];
        $this->insurance_id->AdvancedSearch->SearchCondition = @$filter["v_insurance_id"];
        $this->insurance_id->AdvancedSearch->SearchValue2 = @$filter["y_insurance_id"];
        $this->insurance_id->AdvancedSearch->SearchOperator2 = @$filter["w_insurance_id"];
        $this->insurance_id->AdvancedSearch->save();
        ...
        // Field insurance_contact_person
        $this->insurance_contact_person->AdvancedSearch->SearchValue = @$filter["x_insurance_contact_person"];
        $this->insurance_contact_person->AdvancedSearch->SearchOperator = @$filter["z_insurance_contact_person"];
        $this->insurance_contact_person->AdvancedSearch->SearchCondition = @$filter["v_insurance_contact_person"];
        $this->insurance_contact_person->AdvancedSearch->SearchValue2 = @$filter["y_insurance_contact_person"];
        $this->insurance_contact_person->AdvancedSearch->SearchOperator2 = @$filter["w_insurance_contact_person"];
        $this->insurance_contact_person->AdvancedSearch->save();

        // Field insurance_contact_person_phone
        $this->insurance_contact_person_phone->AdvancedSearch->SearchValue = @$filter["x_insurance_contact_person_phone"];
        $this->insurance_contact_person_phone->AdvancedSearch->SearchOperator = @$filter["z_insurance_contact_person_phone"];
        $this->insurance_contact_person_phone->AdvancedSearch->SearchCondition = @$filter["v_insurance_contact_person_phone"];
        $this->insurance_contact_person_phone->AdvancedSearch->SearchValue2 = @$filter["y_insurance_contact_person_phone"];
        $this->insurance_contact_person_phone->AdvancedSearch->SearchOperator2 = @$filter["w_insurance_contact_person_phone"];
        $this->insurance_contact_person_phone->AdvancedSearch->save();

        // Field insurance_contact_person_email
        $this->insurance_contact_person_email->AdvancedSearch->SearchValue = @$filter["x_insurance_contact_person_email"];
        $this->insurance_contact_person_email->AdvancedSearch->SearchOperator = @$filter["z_insurance_contact_person_email"];
        $this->insurance_contact_person_email->AdvancedSearch->SearchCondition = @$filter["v_insurance_contact_person_email"];
        $this->insurance_contact_person_email->AdvancedSearch->SearchValue2 = @$filter["y_insurance_contact_person_email"];
        $this->insurance_contact_person_email->AdvancedSearch->SearchOperator2 = @$filter["w_insurance_contact_person_email"];
        $this->insurance_contact_person_email->AdvancedSearch->save();

        // Field insurance_physical_address
        $this->insurance_physical_address->AdvancedSearch->SearchValue = @$filter["x_insurance_physical_address"];
        $this->insurance_physical_address->AdvancedSearch->SearchOperator = @$filter["z_insurance_physical_address"];
        $this->insurance_physical_address->AdvancedSearch->SearchCondition = @$filter["v_insurance_physical_address"];
        $this->insurance_physical_address->AdvancedSearch->SearchValue2 = @$filter["y_insurance_physical_address"];
        $this->insurance_physical_address->AdvancedSearch->SearchOperator2 = @$filter["w_insurance_physical_address"];
        $this->insurance_physical_address->AdvancedSearch->save();
    ...
    public function basicSearchWhere($default = false)
    {
        ...
        $searchFlds[] = &$this->insurance_contact_person;
        $searchFlds[] = &$this->insurance_contact_person_phone;
        $searchFlds[] = &$this->insurance_contact_person_email;
        $searchFlds[] = &$this->insurance_physical_address;
    ...
    protected function setupSortOrder()
    {
        ...
        if (Get("order") !== null) {
            ...
            $this->updateSort($this->insurance_id); // insurance_id
            $this->updateSort($this->insurance_name); // insurance_name
            $this->updateSort($this->insurance_contact_person); // insurance_contact_person
            $this->updateSort($this->insurance_contact_person_phone); // insurance_contact_person_phone
            $this->updateSort($this->insurance_contact_person_email); // insurance_contact_person_email
    ...
    protected function resetCmd()
    {
        ...
        if (StartsString("reset", $this->Command)) {
            ...
            if ($this->Command == "resetsort") {
                ...
                $this->insurance_id->setSort("");
                $this->insurance_name->setSort("");
                $this->insurance_contact_person->setSort("");
                $this->insurance_contact_person_phone->setSort("");
                $this->insurance_contact_person_email->setSort("");
    ...
    public function renderListOptions()
    {
        ...
        if ($opt && !$this->isExport() && !$this->CurrentAction) {
            ...
            foreach ($this->ListActions->Items as $listaction) {
                ...
                if ($listaction->Select == ACTION_SINGLE && $allowed) {
                    ...
                    $link = "<li><button type=\"button\" class=\"dropdown-item ew-action ew-list-action\" data-caption=\"" . HtmlTitle($caption) . "\" data-ew-action=\"submit\" form=\"fjdh_insurancelist\" data-key=\"" . $this->keyToJson(true) . "\"" . $listaction->toDataAttrs() . ">" . $icon . " " . $listaction->Caption . "</button></li>";
                    if ($link != "") {
                        $links[] = $link;
                        if ($body == "") { // Setup first button
                            $body = "<button type=\"button\" class=\"btn btn-default ew-action ew-list-action\" title=\"" . HtmlTitle($caption) . "\" data-caption=\"" . HtmlTitle($caption) . "\" data-ew-action=\"submit\" form=\"fjdh_insurancelist\" data-key=\"" . $this->keyToJson(true) . "\"" . $listaction->toDataAttrs() . ">" . $icon . " " . $listaction->Caption . "</button>";
                        }
                    }
                }
            }
        ...
        $opt->Body = "<div class=\"form-check\"><input type=\"checkbox\" id=\"key_m_" . $this->RowCount . "\" name=\"key_m[]\" class=\"form-check-input ew-multi-select\" value=\"" . HtmlEncode($this->insurance_id->CurrentValue) . "\" data-ew-action=\"select-key\"></div>";
    ...
    protected function setupOtherOptions()
    {
        ...
        if ($this->ModalAdd && !IsMobile()) {
            $item->Body = "<a class=\"ew-add-edit ew-add\" title=\"" . $addcaption . "\" data-table=\"jdh_insurance\" data-caption=\"" . $addcaption . "\" data-ew-action=\"modal\" data-action=\"add\" data-ajax=\"" . ($this->UseAjaxActions ? "true" : "false") . "\" data-url=\"" . HtmlEncode(GetUrl($this->AddUrl)) . "\" data-btn=\"AddBtn\">" . $Language->phrase("AddLink") . "</a>";
        } else {
        ...
        $item->Body = "<button type=\"button\" class=\"ew-action ew-multi-delete\" title=\"" .
            ...
            HtmlTitle($Language->phrase("DeleteSelectedLink")) . "\" form=\"fjdh_insurancelist\"" .
        ...
        if ($this->UseColumnVisibility) {
            ...
            $option->add("insurance_id", $this->createColumnOption("insurance_id"));
            $option->add("insurance_name", $this->createColumnOption("insurance_name"));
            $option->add("insurance_contact_person", $this->createColumnOption("insurance_contact_person"));
            $option->add("insurance_contact_person_phone", $this->createColumnOption("insurance_contact_person_phone"));
            $option->add("insurance_contact_person_email", $this->createColumnOption("insurance_contact_person_email"));
        ...
        $item->Body = "<a class=\"ew-save-filter\" data-form=\"fjdh_insurancesrch\" data-ew-action=\"none\">" . $Language->phrase("SaveCurrentFilter") . "</a>";
        $item->Visible = true;
        $item = &$this->FilterOptions->add("deletefilter");
        $item->Body = "<a class=\"ew-delete-filter\" data-form=\"fjdh_insurancesrch\" data-ew-action=\"none\">" . $Language->phrase("DeleteFilter") . "</a>";
        $item->Visible = true;
    ...
    public function renderOtherOptions()
    {
        ...
        foreach ($this->ListActions->Items as $listaction) {
            if ($listaction->Select == ACTION_MULTIPLE) {
                ...
                $item->Body = '<button type="button" class="btn btn-default ew-action ew-list-action" title="' . HtmlEncode($caption) . '" data-caption="' . HtmlEncode($caption) . '" data-ew-action="submit" form="fjdh_insurancelist"' . $listaction->toDataAttrs() . '>' . $icon . '</button>';
    ...
    public function setupRow()
    {
        ...
        if (($this->isGridAdd() || $this->isGridEdit())) {
            if ($this->RowIndex === '$rowindex$') { // Render template row first
                ...
                // Set row properties
                $this->resetAttributes();
                $this->RowAttrs->merge(["data-rowindex" => $this->RowIndex, "id" => "r0_jdh_insurance", "data-rowtype" => ROWTYPE_ADD]);
        ...
        $this->RowAttrs->merge([
            ...
            "id" => "r" . $this->RowCount . "_jdh_insurance",
    ...
    protected function getExportTag($type, $custom = false)
    {
        ...
        if (SameText($type, "excel")) {
            ...
            return '<button type="button" class="btn btn-default ew-export-link ew-email" title="' . $Language->phrase("ExportToEmail", true) . '" data-caption="' . $Language->phrase("ExportToEmail", true) . '" form="fjdh_insurancelist" data-ew-action="email" data-custom="false" data-hdr="' . $Language->phrase("ExportToEmail", true) . '" data-exported-selected="false"' . $url . '>' . $Language->phrase("ExportToEmail") . '</button>';
    ...
    protected function setupSearchOptions()
    {
        ...
        $item->Body = "<a class=\"btn btn-default ew-search-toggle" . $searchToggleClass . "\" role=\"button\" title=\"" . $Language->phrase("SearchPanel") . "\" data-caption=\"" . $Language->phrase("SearchPanel") . "\" data-ew-action=\"search-toggle\" data-form=\"fjdh_insurancesrch\" aria-pressed=\"" . ($searchToggleClass == " active" ? "true" : "false") . "\">" . $Language->phrase("SearchLink") . "</a>";
        $item->Visible = true;
