...
class Login extends JdhUsers
{
    ...
    public function run()
    {
        ...
        $this->Password = new DbField("jdh_users", "password", "password", "password", "", 202, 255, -1, false, "", false, false, false);
        $this->Password->EditAttrs->appendClass("form-control ew-form-control");
        if (Config("ENCRYPTED_PASSWORD")) {
            $this->Password->Raw = true;
        }
        $this->LoginType = new DbField("jdh_users", "type", "logintype", "logintype", "", 202, 255, -1, false, "", false, false, false);
