 ...
 * Page class
 */
class JdhPharmacyIncomeView extends JdhPharmacyIncome
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "JdhPharmacyIncomeView";
    ...
    // CSS class/style
    public $CurrentPageName = "jdhpharmacyincomeview";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("patient_id") ?? Route("patient_id")) !== null) {
            ...
            $returnUrl = "jdhpharmacyincomelist"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "jdhpharmacyincomelist"; // No matching record, return to list
                    }
                break;
        }
    ...
    protected function getExportTag($type, $custom = false)
    {
        ...
        if (SameText($type, "excel")) {
            ...
            return '<button type="button" class="btn btn-default ew-export-link ew-email" title="' . $Language->phrase("ExportToEmail", true) . '" data-caption="' . $Language->phrase("ExportToEmail", true) . '" form="fjdh_pharmacy_incomeview" data-ew-action="email" data-hdr="' . $Language->phrase("ExportToEmail", true) . '" data-key="' . HtmlEncode(ArrayToJsonAttribute($this->RecKey)) . '" data-exported-selected="false"' . $url . '>' . $Language->phrase("ExportToEmail") . '</button>';
    ...
    */
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("jdhpharmacyincomelist"), "", $this->TableVar, true);
        $pageId = "view";
