 ...
 * Page class
 */
class JdhPatientBillDelete extends JdhPatientBill
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "JdhPatientBillDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "jdhpatientbilldelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("jdhpatientbilllist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if (!$res) {
            $this->terminate("jdhpatientbilllist"); // Return to list
            return;
        }
