 ...
 * Page class
 */
class JdhMedicinesEdit extends JdhMedicines
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "JdhMedicinesEdit";
    ...
    // CSS class/style
    public $CurrentPageName = "jdhmedicinesedit";
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    if (!$loaded) { // Load record based on key
                        ...
                        $this->terminate("jdhmedicineslist"); // No matching record, return to list
                        return;
                    }
                break;
            case "update": // Update
    ...
    protected function getEditRow($rsold)
    {
        ...
        // buying_price
        $this->buying_price->setDbValueDef($rsnew, $this->buying_price->CurrentValue, $this->buying_price->ReadOnly);

        // description
        $this->description->setDbValueDef($rsnew, $this->description->CurrentValue, $this->description->ReadOnly);

        // expiry
        $this->expiry->setDbValueDef($rsnew, UnFormatDateTime($this->expiry->CurrentValue, $this->expiry->formatPattern()), $this->expiry->ReadOnly);
        return $rsnew;
    }
