...
class JdhChiefComplaints extends DbTable
{
    ...
    public function __construct()
    {
        ...
        $this->modifiedby_user_id->Raw = true;
    ...
    public function getModalCaption($pageName)
    {
        ...
        return match ($pageName) {
            "jdhchiefcomplaintsview" => $Language->phrase("View"),
            "jdhchiefcomplaintsedit" => $Language->phrase("Edit"),
            "jdhchiefcomplaintsadd" => $Language->phrase("Add"),
            default => ""
        };
    }
    ...
    public function getApiPageName($action)
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "JdhChiefComplaintsView",
            Config("API_ADD_ACTION") => "JdhChiefComplaintsAdd",
            Config("API_EDIT_ACTION") => "JdhChiefComplaintsEdit",
            Config("API_DELETE_ACTION") => "JdhChiefComplaintsDelete",
            Config("API_LIST_ACTION") => "JdhChiefComplaintsList",
            default => ""
        };
    }
    ...
    public function getDeleteUrl($parm = "")
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("jdhchiefcomplaintsdelete", $parm);
        }
    }
    ...
    {
        WriteAuditLog(CurrentUserIdentifier(), $typ, 'jdh_chief_complaints');
    }
