...
class JdhMedicineCategories extends DbTable
{
    ...
    public function getModalCaption($pageName)
    {
        ...
        return match ($pageName) {
            "jdhmedicinecategoriesview" => $Language->phrase("View"),
            "jdhmedicinecategoriesedit" => $Language->phrase("Edit"),
            "jdhmedicinecategoriesadd" => $Language->phrase("Add"),
            default => ""
        };
    }
    ...
    public function getApiPageName($action)
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "JdhMedicineCategoriesView",
            Config("API_ADD_ACTION") => "JdhMedicineCategoriesAdd",
            Config("API_EDIT_ACTION") => "JdhMedicineCategoriesEdit",
            Config("API_DELETE_ACTION") => "JdhMedicineCategoriesDelete",
            Config("API_LIST_ACTION") => "JdhMedicineCategoriesList",
            default => ""
        };
    }
    ...
    public function getDeleteUrl($parm = "")
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("jdhmedicinecategoriesdelete", $parm);
        }
    }
