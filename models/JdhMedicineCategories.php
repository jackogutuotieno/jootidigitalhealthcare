...
/**
 * Table class for jdh_medicine_categories
 */
class JdhMedicineCategories extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        // Update Table
        $this->UpdateTable = "`jdh_medicine_categories`";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // category_name $tbl, $fldvar, $fldname, $fldexp, $fldbsexp, $fldtype, $fldsize, $flddtfmt, $upload, $fldvirtualexp, $fldvirtual, $forceselect, $fldvirtualsrch, $fldviewtag = "", $fldhtmltag
        ...
        // category_description $tbl, $fldvar, $fldname, $fldexp, $fldbsexp, $fldtype, $fldsize, $flddtfmt, $upload, $fldvirtualexp, $fldvirtual, $forceselect, $fldvirtualsrch, $fldviewtag = "", $fldhtmltag
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`jdh_medicine_categories`";
    }
    ...
    public function update(&$rs, $where = "", $rsold = null, $curfilter = true)
    {
        ...
        if ($success) {
            if (!isset($rs['category_id']) && !EmptyValue($this->category_id->CurrentValue)) {
                $rs['category_id'] = $this->category_id->CurrentValue;
            }
        }
        return $success;
    }
    ...
    public function getRecordFilter($row = null, $current = false)
    {
        ...
        if (is_array($row)) {
            ...
            $val = !EmptyValue($this->category_id->OldValue) && !$current ? $this->category_id->OldValue : $this->category_id->CurrentValue;
        }
        if (!is_numeric($val)) {
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("jdhmedicinecategorieslist");
    }
    ...
    {
        global $Language;
        if ($pageName == "jdhmedicinecategoriesview") {
            return $Language->phrase("View");
        } elseif ($pageName == "jdhmedicinecategoriesedit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "jdhmedicinecategoriesadd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "JdhMedicineCategoriesView";
            case Config("API_ADD_ACTION"):
                return "JdhMedicineCategoriesAdd";
            case Config("API_EDIT_ACTION"):
                return "JdhMedicineCategoriesEdit";
            case Config("API_DELETE_ACTION"):
                return "JdhMedicineCategoriesDelete";
            case Config("API_LIST_ACTION"):
                return "JdhMedicineCategoriesList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("jdhmedicinecategoriesview", $parm);
        } else {
            $url = $this->keyUrl("jdhmedicinecategoriesview", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        if ($parm != "") {
            $url = "jdhmedicinecategoriesadd?" . $parm;
        } else {
            $url = "jdhmedicinecategoriesadd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("jdhmedicinecategoriesedit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("jdhmedicinecategorieslist", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("jdhmedicinecategoriesadd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("jdhmedicinecategorieslist", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl()
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("jdhmedicinecategoriesdelete");
        }
    }
    ...
    {
        global $Response;
        $listPage = "JdhMedicineCategoriesList";
    ...
    public function renderEditRow()
    {
        ...
        $this->category_description->EditValue = $this->category_description->CurrentValue;
