...
class JdhLabIncome extends DbTable
{
    ...
    public function getModalCaption($pageName)
    {
        ...
        return match ($pageName) {
            "jdhlabincomeview" => $Language->phrase("View"),
            "jdhlabincomeedit" => $Language->phrase("Edit"),
            "jdhlabincomeadd" => $Language->phrase("Add"),
            default => ""
        };
    }
    ...
    public function getApiPageName($action)
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "JdhLabIncomeView",
            Config("API_ADD_ACTION") => "JdhLabIncomeAdd",
            Config("API_EDIT_ACTION") => "JdhLabIncomeEdit",
            Config("API_DELETE_ACTION") => "JdhLabIncomeDelete",
            Config("API_LIST_ACTION") => "JdhLabIncomeList",
            default => ""
        };
    }
    ...
    public function getDeleteUrl($parm = "")
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("jdhlabincomedelete", $parm);
        }
    }
