 ...
 * Page class
 */
class JdhPatientBillAdd extends JdhPatientBill
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "JdhPatientBillAdd";
    ...
    // CSS class/style
    public $CurrentPageName = "jdhpatientbilladd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($rsold)) {
                    ...
                    } elseif (GetPageName($returnUrl) == "jdhpatientbillview") {
    ...
    protected function addRow($rsold = null)
    {
        ...
        // bill_description
        $this->bill_description->setDbValueDef($rsnew, $this->bill_description->CurrentValue, null, false);
