 ...
 * Page class
 */
class JdhExaminationFindingsEdit extends JdhExaminationFindings
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "JdhExaminationFindingsEdit";
    ...
    // CSS class/style
    public $CurrentPageName = "jdhexaminationfindingsedit";
