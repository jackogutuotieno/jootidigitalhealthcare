 ...
 * Page class
 */
class JdhTestRequestsDelete extends JdhTestRequests
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "JdhTestRequestsDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("jdhtestrequestslist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if (!$res) {
            $this->terminate("jdhtestrequestslist"); // Return to list
            return;
        }
