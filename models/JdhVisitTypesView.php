 ...
 * Page class
 */
class JdhVisitTypesView extends JdhVisitTypes
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "JdhVisitTypesView";
    ...
    // CSS class/style
    public $CurrentPageName = "jdhvisittypesview";
    ...
    public function __construct()
    {
        ...
        if (($keyValue = Get("visit_type_id") ?? Route("visit_type_id")) !== null) {
            $this->RecKey["visit_type_id"] = $keyValue;
        }
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("visit_type_id") ?? Route("visit_type_id")) !== null) {
            ...
            $this->RecKey["visit_type_id"] = $this->visit_type_id->QueryStringValue;
        } elseif (Post("visit_type_id") !== null) {
            $this->visit_type_id->setFormValue(Post("visit_type_id"));
            $this->RecKey["visit_type_id"] = $this->visit_type_id->FormValue;
        } elseif (IsApi() && ($keyValue = Key(0) ?? Route(2)) !== null) {
            $this->visit_type_id->setQueryStringValue($keyValue);
            $this->RecKey["visit_type_id"] = $this->visit_type_id->QueryStringValue;
        } elseif (!$loadCurrentRecord) {
            $returnUrl = "jdhvisittypeslist"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "jdhvisittypeslist"; // No matching record, return to list
                    }
                break;
        }
    ...
    protected function getExportTag($type, $custom = false)
    {
        ...
        if (SameText($type, "excel")) {
            ...
            return '<button type="button" class="btn btn-default ew-export-link ew-email" title="' . $Language->phrase("ExportToEmail", true) . '" data-caption="' . $Language->phrase("ExportToEmail", true) . '" form="fjdh_visit_typesview" data-ew-action="email" data-hdr="' . $Language->phrase("ExportToEmail", true) . '" data-key="' . ArrayToJsonAttribute($this->RecKey) . '" data-exported-selected="false"' . $url . '>' . $Language->phrase("ExportToEmail") . '</button>';
