 ...
 * Page class
 */
class JdhAudittrailAdd extends JdhAudittrail
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "JdhAudittrailAdd";
    ...
    // CSS class/style
    public $CurrentPageName = "jdhaudittrailadd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($rsold)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "jdhaudittrailview") {
