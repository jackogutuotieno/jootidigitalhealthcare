 ...
 * Page class
 */
class JdhWardsView extends JdhWards
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "JdhWardsView";
    ...
    // CSS class/style
    public $CurrentPageName = "jdhwardsview";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("ward_id") ?? Route("ward_id")) !== null) {
            ...
            $this->RecKey["ward_id"] = $this->ward_id->QueryStringValue;
        } elseif (Post("ward_id") !== null) {
            $this->ward_id->setFormValue(Post("ward_id"));
            $this->RecKey["ward_id"] = $this->ward_id->FormValue;
        } elseif (IsApi() && ($keyValue = Key(0) ?? Route(2)) !== null) {
            $this->ward_id->setQueryStringValue($keyValue);
            $this->RecKey["ward_id"] = $this->ward_id->QueryStringValue;
        } elseif (!$loadCurrentRecord) {
            $returnUrl = "jdhwardslist"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "jdhwardslist"; // No matching record, return to list
                    }
                break;
        }
    ...
    protected function getExportTag($type, $custom = false)
    {
        ...
        if (SameText($type, "excel")) {
            ...
            return '<button type="button" class="btn btn-default ew-export-link ew-email" title="' . $Language->phrase("ExportToEmail", true) . '" data-caption="' . $Language->phrase("ExportToEmail", true) . '" form="fjdh_wardsview" data-ew-action="email" data-hdr="' . $Language->phrase("ExportToEmail", true) . '" data-key="' . ArrayToJsonAttribute($this->RecKey) . '" data-exported-selected="false"' . $url . '>' . $Language->phrase("ExportToEmail") . '</button>';
