 ...
 * Page class
 */
class JdhInsuranceDelete extends JdhInsurance
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "JdhInsuranceDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "jdhinsurancedelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("jdhinsurancelist"); // Prevent SQL injection, return to list
            return;
        }
