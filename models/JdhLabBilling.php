...
/**
 * Table class for jdh_lab_billing
 */
class JdhLabBilling extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        // Update Table
        $this->UpdateTable = "`jdh_lab_billing`";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("jdhlabbillinglist");
    }
    ...
    {
        global $Language;
        if ($pageName == "jdhlabbillingview") {
            return $Language->phrase("View");
        } elseif ($pageName == "jdhlabbillingedit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "jdhlabbillingadd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "JdhLabBillingView";
            case Config("API_ADD_ACTION"):
                return "JdhLabBillingAdd";
            case Config("API_EDIT_ACTION"):
                return "JdhLabBillingEdit";
            case Config("API_DELETE_ACTION"):
                return "JdhLabBillingDelete";
            case Config("API_LIST_ACTION"):
                return "JdhLabBillingList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("jdhlabbillingview", $parm);
        } else {
            $url = $this->keyUrl("jdhlabbillingview", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        if ($parm != "") {
            $url = "jdhlabbillingadd?" . $parm;
        } else {
            $url = "jdhlabbillingadd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("jdhlabbillingedit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("jdhlabbillinglist", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("jdhlabbillingadd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("jdhlabbillinglist", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl()
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("jdhlabbillingdelete");
        }
    }
