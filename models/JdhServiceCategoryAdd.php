 ...
 * Page class
 */
class JdhServiceCategoryAdd extends JdhServiceCategory
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "JdhServiceCategoryAdd";
    ...
    // CSS class/style
    public $CurrentPageName = "jdhservicecategoryadd";
        ...
        switch ($this->CurrentAction) {
            case "copy": // Copy an existing record
                if (!$rsold) { // Record not loaded
                    ...
                    $this->terminate("jdhservicecategorylist"); // No matching record, return to list
                    return;
                }
                break;
            case "insert": // Add new record
                ...
                if ($this->addRow($rsold)) { // Add successful
                    ...
                    if (GetPageName($returnUrl) == "jdhservicecategorylist") {
                        $returnUrl = $this->addMasterUrl($returnUrl); // List page, return to List page with correct master key if necessary
                    } elseif (GetPageName($returnUrl) == "jdhservicecategoryview") {
                    ...
                    if ($this->IsModal && $this->UseAjaxActions) {
                        ...
                        if (GetPageName($returnUrl) != "jdhservicecategorylist") {
                            ...
                            $returnUrl = "jdhservicecategorylist"; // Return list page content
                        }
                    }
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("jdhservicecategorylist"), "", $this->TableVar, true);
