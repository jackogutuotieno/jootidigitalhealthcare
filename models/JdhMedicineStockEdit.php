 ...
 * Page class
 */
class JdhMedicineStockEdit extends JdhMedicineStock
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "JdhMedicineStockEdit";
    ...
    // CSS class/style
    public $CurrentPageName = "jdhmedicinestockedit";
    ...
    protected function getEditRow($rsold)
    {
        ...
        // units_available
        $this->units_available->setDbValueDef($rsnew, $this->units_available->CurrentValue, $this->units_available->ReadOnly);
    ...
    protected function restoreEditFormFromRow($row)
    {
        ...
        if (isset($row['units_available'])) { // units_available
            $this->units_available->CurrentValue = $row['units_available'];
        }
