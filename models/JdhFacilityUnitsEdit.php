 ...
 * Page class
 */
class JdhFacilityUnitsEdit extends JdhFacilityUnits
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "JdhFacilityUnitsEdit";
    ...
    // CSS class/style
    public $CurrentPageName = "jdhfacilityunitsedit";
    ...
    protected function restoreEditFormFromRow($row)
    {
        if (isset($row['unit_name'])) { // unit_name
            $this->unit_name->CurrentValue = $row['unit_name'];
        }
