...
class JdhPrescriptions extends DbTable
{
    ...
    public function __construct()
    {
        ...
        $this->prescription_days->Raw = true;
        ...
        $this->prescription_time->setSelectMultiple(false); // Select one
        ...
        $this->prescription_time->Lookup = new Lookup($this->prescription_time, 'jdh_prescriptions', false, '', ["","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
        ...
        $this->prescription_date->Raw = true;
    ...
    public function getModalCaption($pageName)
    {
        ...
        return match ($pageName) {
            "jdhprescriptionsview" => $Language->phrase("View"),
            "jdhprescriptionsedit" => $Language->phrase("Edit"),
            "jdhprescriptionsadd" => $Language->phrase("Add"),
            default => ""
        };
    }
    ...
    public function getApiPageName($action)
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "JdhPrescriptionsView",
            Config("API_ADD_ACTION") => "JdhPrescriptionsAdd",
            Config("API_EDIT_ACTION") => "JdhPrescriptionsEdit",
            Config("API_DELETE_ACTION") => "JdhPrescriptionsDelete",
            Config("API_LIST_ACTION") => "JdhPrescriptionsList",
            default => ""
        };
    }
    ...
    public function getDeleteUrl($parm = "")
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("jdhprescriptionsdelete", $parm);
        }
    }
    ...
    {
        $json = "";
        $json .= "\"prescription_id\":" . VarToJson($this->prescription_id->CurrentValue, "number");
        $json = "{" . $json . "}";
        if ($htmlEncode) {
    ...
    {
        WriteAuditLog(CurrentUserIdentifier(), $typ, 'jdh_prescriptions');
    }
