 ...
 * Page class
 */
class JdhInvoiceItemsEdit extends JdhInvoiceItems
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "JdhInvoiceItemsEdit";
    ...
    // CSS class/style
    public $CurrentPageName = "jdhinvoiceitemsedit";
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    if (!$loaded) { // Load record based on key
                        ...
                        $this->terminate("jdhinvoiceitemslist"); // No matching record, return to list
                        return;
                    }
                break;
            case "update": // Update
                $returnUrl = $this->getReturnUrl();
                if (GetPageName($returnUrl) == "jdhinvoiceitemslist") {
                ...
                if ($this->editRow()) {
                    ...
                    if ($this->UseAjaxActions && GetPageName($returnUrl) != "jdhinvoiceitemslist") {
                        Container("flash")->addMessage("Return-Url", $returnUrl); // Save return URL
                        $returnUrl = "jdhinvoiceitemslist"; // Return list page content
                    }
    ...
    protected function editRow()
    {
        ...
        // submittedby_user_id
        $this->submittedby_user_id->setDbValueDef($rsnew, $this->submittedby_user_id->CurrentValue, 0, $this->submittedby_user_id->ReadOnly);
