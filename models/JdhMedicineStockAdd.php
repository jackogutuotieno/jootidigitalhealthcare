 ...
 * Page class
 */
class JdhMedicineStockAdd extends JdhMedicineStock
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "JdhMedicineStockAdd";
    ...
    // CSS class/style
    public $CurrentPageName = "jdhmedicinestockadd";
        ...
        switch ($this->CurrentAction) {
            case "copy": // Copy an existing record
                if (!$rsold) { // Record not loaded
                    ...
                    $this->terminate("jdhmedicinestocklist"); // No matching record, return to list
                    return;
                }
                break;
            case "insert": // Add new record
                ...
                if ($this->addRow($rsold)) { // Add successful
                    ...
                    if (GetPageName($returnUrl) == "jdhmedicinestocklist") {
                        $returnUrl = $this->addMasterUrl($returnUrl); // List page, return to List page with correct master key if necessary
                    } elseif (GetPageName($returnUrl) == "jdhmedicinestockview") {
                    ...
                    if ($this->IsModal && $this->UseAjaxActions) {
                        ...
                        if (GetPageName($returnUrl) != "jdhmedicinestocklist") {
                            ...
                            $returnUrl = "jdhmedicinestocklist"; // Return list page content
                        }
                    }
    ...
    protected function validateForm()
    {
        ...
        $validateForm = true;
            ...
            if ($this->units_available->Visible && $this->units_available->Required) {
    ...
    protected function getAddRow()
    {
        ...
        // units_available
        $this->units_available->setDbValueDef($rsnew, $this->units_available->CurrentValue, false);
    ...
    protected function restoreAddFormFromRow($row)
    {
        ...
        if (isset($row['units_available'])) { // units_available
            $this->units_available->setFormValue($row['units_available']);
        }
