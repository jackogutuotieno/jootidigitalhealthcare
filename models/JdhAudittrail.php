...
class JdhAudittrail extends DbTable
{
    ...
    {
        global $Language;
        if ($pageName == "jdhaudittrailview") {
            return $Language->phrase("View");
        } elseif ($pageName == "jdhaudittrailedit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "jdhaudittrailadd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "JdhAudittrailView";
            case Config("API_ADD_ACTION"):
                return "JdhAudittrailAdd";
            case Config("API_EDIT_ACTION"):
                return "JdhAudittrailEdit";
            case Config("API_DELETE_ACTION"):
                return "JdhAudittrailDelete";
    ...
    public function getDeleteUrl()
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("jdhaudittraildelete");
        }
    }
