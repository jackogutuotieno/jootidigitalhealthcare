...
/**
 * Table class for jdh_audittrail
 */
class JdhAudittrail extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        // Update Table
        $this->UpdateTable = "jdh_audittrail";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "jdh_audittrail";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("jdhaudittraillist");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        return match ($pageName) {
            "jdhaudittrailview" => $Language->phrase("View"),
            "jdhaudittrailedit" => $Language->phrase("Edit"),
            "jdhaudittrailadd" => $Language->phrase("Add"),
            default => ""
        };
    }
    ...
    public function getApiPageName($action)
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "JdhAudittrailView",
            Config("API_ADD_ACTION") => "JdhAudittrailAdd",
            Config("API_EDIT_ACTION") => "JdhAudittrailEdit",
            Config("API_DELETE_ACTION") => "JdhAudittrailDelete",
            Config("API_LIST_ACTION") => "JdhAudittrailList",
            default => ""
        };
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("jdhaudittrailview", $parm);
        } else {
            $url = $this->keyUrl("jdhaudittrailview", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        if ($parm != "") {
            $url = "jdhaudittrailadd?" . $parm;
        } else {
            $url = "jdhaudittrailadd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("jdhaudittrailedit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("jdhaudittraillist", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("jdhaudittrailadd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("jdhaudittraillist", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl($parm = "")
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("jdhaudittraildelete", $parm);
        }
    }
