 ...
 * Page class
 */
class JdhMedicineSubcategoriesAdd extends JdhMedicineSubcategories
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "JdhMedicineSubcategoriesAdd";
    ...
    // CSS class/style
    public $CurrentPageName = "jdhmedicinesubcategoriesadd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($rsold)) {
                    ...
                    } elseif (GetPageName($returnUrl) == "jdhmedicinesubcategoriesview") {
