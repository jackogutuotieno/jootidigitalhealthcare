 ...
 * Page class
 */
class JdhPatientBillView extends JdhPatientBill
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "JdhPatientBillView";
    ...
    // CSS class/style
    public $CurrentPageName = "jdhpatientbillview";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("bill_id") ?? Route("bill_id")) !== null) {
            ...
            $returnUrl = "jdhpatientbilllist"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "jdhpatientbilllist"; // No matching record, return to list
                    }
                break;
        }
