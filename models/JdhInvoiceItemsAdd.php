 ...
 * Page class
 */
class JdhInvoiceItemsAdd extends JdhInvoiceItems
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "JdhInvoiceItemsAdd";
    ...
    // CSS class/style
    public $CurrentPageName = "jdhinvoiceitemsadd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($rsold)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "jdhinvoiceitemsview") {
