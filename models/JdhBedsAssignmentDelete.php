 ...
 * Page class
 */
class JdhBedsAssignmentDelete extends JdhBedsAssignment
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "JdhBedsAssignmentDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("jdhbedsassignmentlist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if (!$res) {
            $this->terminate("jdhbedsassignmentlist"); // Return to list
            return;
        }
