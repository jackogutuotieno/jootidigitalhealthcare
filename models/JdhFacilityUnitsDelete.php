 ...
 * Page class
 */
class JdhFacilityUnitsDelete extends JdhFacilityUnits
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "JdhFacilityUnitsDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "jdhfacilityunitsdelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("jdhfacilityunitslist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("jdhfacilityunitslist"); // Return to list
                return;
            }
        }
