...
{
    // list
    #[Map(["GET","POST","OPTIONS"], "/jdhexportloglist[/{FileId:.*}]", [PermissionMiddleware::class], "list.jdh_exportlog")]
    ...
    // add
    #[Map(["GET","POST","OPTIONS"], "/jdhexportlogadd[/{FileId:.*}]", [PermissionMiddleware::class], "add.jdh_exportlog")]
