...
class JdhConsultationIncomeController extends ControllerBase
{
    // list
    #[Map(["GET","POST","OPTIONS"], "/jdhconsultationincomelist[/{user_id}]", [PermissionMiddleware::class], "list.jdh_consultation_income")]
    public function list(Request $request, Response $response, array $args): Response
    {
        return $this->runPage($request, $response, $args, "JdhConsultationIncomeList");
    }
}
