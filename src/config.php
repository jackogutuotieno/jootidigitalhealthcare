...
$CONFIG = [
    ...
    "RANDOM_KEY" => 'XgEZ4Hm0VQSy8mc1', // Random key for encryption
    ...
    // Export Log
    "EXPORT_PATH" => "export-edb02539-d193-4081-b8f6-deffeae24230", // Export folder
    "EXPORT_LOG_DBID" => "DB", // DB ID
    "EXPORT_LOG_TABLE_NAME" => "jdh_exportlog", // Table name
    "EXPORT_LOG_TABLE_VAR" => "jdh_exportlog", // Table var
    "EXPORT_LOG_FIELD_NAME_FILE_ID" => "FileId", // File id (GUID) field name
    "EXPORT_LOG_FIELD_NAME_DATETIME" => "DateTime", // DateTime field name
    "EXPORT_LOG_FIELD_NAME_DATETIME_ALIAS" => "datetime", // DateTime field name Alias
    "EXPORT_LOG_FIELD_NAME_USER" => "User", // User field name
    "EXPORT_LOG_FIELD_NAME_EXPORT_TYPE" => "ExportType", // Export Type field name
    "EXPORT_LOG_FIELD_NAME_EXPORT_TYPE_ALIAS" => "type", // Export Type field name Alias
    "EXPORT_LOG_FIELD_NAME_TABLE" => "Table", // Table field name
    "EXPORT_LOG_FIELD_NAME_TABLE_ALIAS" => "tablename", // Table field name Alias
    "EXPORT_LOG_FIELD_NAME_KEY_VALUE" => "KeyValue", // Key Value field name
    ...
    "PUSH_SERVER_PUBLIC_KEY" => "BMjOKzByLA8eZ0bbyXp5bh1sPxhsKsQYRjjdDsnEZ6MZjoJUqUxhgYMk4iddyuOoEaHIuknSc-F837E9sEmCt5w", // Public Key
