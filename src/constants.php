...
// Project
define(PROJECT_NAMESPACE . "PROJECT_NAME", "jootidigitalhealthcare"); // Project name
define(PROJECT_NAMESPACE . "PROJECT_ID", "{EDB02539-D193-4081-B8F6-DEFFEAE24230}"); // Project ID
