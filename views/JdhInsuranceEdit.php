...
<script>
loadjs.ready(["fjdh_insuranceedit", "editor"], function() {
    ew.createEditor("fjdh_insuranceedit", "x_insurance_physical_address", 35, 4, <?= $Page->insurance_physical_address->ReadOnly || false ? "true" : "false" ?>);
});
</script>
</span>
</div></div>
