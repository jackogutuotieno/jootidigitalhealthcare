...
?>
<main class="view">
<form name="fjdh_invoice_itemsview" id="fjdh_invoice_itemsview" class="ew-form ew-view-form overlay-wrapper" action="<?= CurrentPageUrl(false) ?>" method="post" novalidate autocomplete="off">
<?php if (!$Page->isExport()) { ?>
<script>
