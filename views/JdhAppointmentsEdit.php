...
?>
<main class="edit">
<form name="fjdh_appointmentsedit" id="fjdh_appointmentsedit" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post" novalidate autocomplete="on">
<script>
...
loadjs.ready("fjdh_appointmentsedit", function() {
    fjdh_appointmentsedit.createAutoSuggest(Object.assign({"id":"x_patient_id","forceSelect":false}, { lookupAllDisplayFields: <?= $Page->patient_id->Lookup->LookupAllDisplayFields ? "true" : "false" ?> }, ew.vars.tables.jdh_appointments.fields.patient_id.autoSuggestOptions));
});
</script>
...
loadjs.ready(["fjdh_appointmentsedit", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("fjdh_appointmentsedit", "x_appointment_start_date", jQuery.extend(true, {"useCurrent":false,"display":{"sideBySide":false}}, options));
});
</script>
<?php } ?>
</span>
...
loadjs.ready(["fjdh_appointmentsedit", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("fjdh_appointmentsedit", "x_appointment_end_date", jQuery.extend(true, {"useCurrent":false,"display":{"sideBySide":false}}, options));
});
</script>
<?php } ?>
</span>
...
<script>
loadjs.ready(["fjdh_appointmentsedit", "editor"], function() {
    ew.createEditor("fjdh_appointmentsedit", "x_appointment_description", 35, 4, <?= $Page->appointment_description->ReadOnly || false ? "true" : "false" ?>);
});
</script>
</span>
</div></div>
