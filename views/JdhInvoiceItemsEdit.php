...
?>
<main class="edit">
<form name="fjdh_invoice_itemsedit" id="fjdh_invoice_itemsedit" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post" novalidate autocomplete="on">
<script>
