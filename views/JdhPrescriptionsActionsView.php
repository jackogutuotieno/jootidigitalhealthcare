...
?>
<main class="view">
<form name="fjdh_prescriptions_actionsview" id="fjdh_prescriptions_actionsview" class="ew-form ew-view-form overlay-wrapper" action="<?= CurrentPageUrl(false) ?>" method="post" novalidate autocomplete="on">
<?php if (!$Page->isExport()) { ?>
<script>
