...
<input type="hidden" data-table="jdh_patient_visits" data-field="x_visit_id" data-hidden="1" name="x<?= $Page->RowIndex ?>_visit_id" id="x<?= $Page->RowIndex ?>_visit_id" value="<?= HtmlEncode($Page->visit_id->CurrentValue) ?>">
</span>
<?php } ?>
