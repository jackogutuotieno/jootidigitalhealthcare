...
?>
<main class="view">
<form name="fjdh_examination_findingsview" id="fjdh_examination_findingsview" class="ew-form ew-view-form overlay-wrapper" action="<?= CurrentPageUrl(false) ?>" method="post" novalidate autocomplete="on">
<?php if (!$Page->isExport()) { ?>
<script>
