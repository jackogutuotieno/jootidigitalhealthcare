...
$Page->showMessage();
?>
<form name="fjdh_prescriptions_actionsadd" id="fjdh_prescriptions_actionsadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post" novalidate autocomplete="on">
