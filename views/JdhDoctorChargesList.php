...
<?php if ($Page->user_id->Visible) { // user_id ?>
        <th data-name="user_id" class="<?= $Page->user_id->headerCellClass() ?>"><div id="elh_jdh_doctor_charges_user_id" class="jdh_doctor_charges_user_id"><?= $Page->renderFieldHeader($Page->user_id) ?></div></th>
<?php } ?>
...
<span id="el<?= $Page->RowIndex == '$rowindex$' ? '$rowindex$' : $Page->RowCount ?>_jdh_doctor_charges_id" class="el_jdh_doctor_charges_id">
...
<span id="el<?= $Page->RowIndex == '$rowindex$' ? '$rowindex$' : $Page->RowCount ?>_jdh_doctor_charges_user_id" class="el_jdh_doctor_charges_user_id">
...
<span id="el<?= $Page->RowIndex == '$rowindex$' ? '$rowindex$' : $Page->RowCount ?>_jdh_doctor_charges_service_id" class="el_jdh_doctor_charges_service_id">
...
<span id="el<?= $Page->RowIndex == '$rowindex$' ? '$rowindex$' : $Page->RowCount ?>_jdh_doctor_charges_submission_date" class="el_jdh_doctor_charges_submission_date">
...
<span id="el<?= $Page->RowIndex == '$rowindex$' ? '$rowindex$' : $Page->RowCount ?>_jdh_doctor_charges_date_updated" class="el_jdh_doctor_charges_date_updated">
