    ...
    <div class="modal-dialog modal-fullscreen-sm-down">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="ew-push-notification-form" class="ew-form"  novalidate autocomplete="off">
                    <?php if (Config("CHECK_TOKEN")) { ?>
                    <input type="hidden" name="<?= $TokenNameKey ?>" value="<?= $TokenName ?>"><!-- CSRF token name -->
                    <input type="hidden" name="<?= $TokenValueKey ?>" value="<?= $TokenValue ?>"><!-- CSRF token value -->
                    <?php } ?>
                    <div class="row mb-3">
                        <label class="col-sm-2 col-form-label ew-label" for="notification-title"><?= $Language->phrase("PushNotificationFormTitle") ?></label>
                        <div class="col-sm-10">
                    ...
                    <div class="row mb-3">
                        <label class="col-sm-2 col-form-label ew-label" for="notification-body"><?= $Language->phrase("PushNotificationFormBody") ?></label>
                        <div class="col-sm-10">
