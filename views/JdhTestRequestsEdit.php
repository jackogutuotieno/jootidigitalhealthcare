...
<span id="el_jdh_test_requests_request_category_id">
    <select
        ...
        data-select2-id="fjdh_test_requestsedit_x_request_category_id"
        data-table="jdh_test_requests"
...
<script>
loadjs.ready("fjdh_test_requestsedit", function() {
    var options = { name: "x_request_category_id", selectId: "fjdh_test_requestsedit_x_request_category_id" },
        el = document.querySelector("select[data-select2-id='" + options.selectId + "']");
    options.closeOnSelect = !options.multiple;
    options.dropdownParent = el.closest("#ew-modal-dialog, #ew-add-opt-dialog");
    if (fjdh_test_requestsedit.lists.request_category_id?.lookupOptions.length) {
        options.data = { id: "x_request_category_id", form: "fjdh_test_requestsedit" };
    } else {
        options.ajax = { id: "x_request_category_id", form: "fjdh_test_requestsedit", limit: ew.LOOKUP_PAGE_SIZE };
    }
...
<span id="el_jdh_test_requests_request_subcategory_id">
    <select
        ...
        data-select2-id="fjdh_test_requestsedit_x_request_subcategory_id"
        data-table="jdh_test_requests"
...
<script>
loadjs.ready("fjdh_test_requestsedit", function() {
    var options = { name: "x_request_subcategory_id", selectId: "fjdh_test_requestsedit_x_request_subcategory_id" },
        el = document.querySelector("select[data-select2-id='" + options.selectId + "']");
    options.closeOnSelect = !options.multiple;
    options.dropdownParent = el.closest("#ew-modal-dialog, #ew-add-opt-dialog");
    if (fjdh_test_requestsedit.lists.request_subcategory_id?.lookupOptions.length) {
        options.data = { id: "x_request_subcategory_id", form: "fjdh_test_requestsedit" };
    } else {
        options.ajax = { id: "x_request_subcategory_id", form: "fjdh_test_requestsedit", limit: ew.LOOKUP_PAGE_SIZE };
    }
    options.minimumResultsForSearch = Infinity;
