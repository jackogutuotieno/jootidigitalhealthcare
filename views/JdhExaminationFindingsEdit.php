...
?>
<main class="edit">
<form name="fjdh_examination_findingsedit" id="fjdh_examination_findingsedit" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post" novalidate autocomplete="off">
<script>
