...
$Page->showMessage();
?>
<form name="fjdh_prescriptions_actionsdelete" id="fjdh_prescriptions_actionsdelete" class="ew-form ew-delete-form" action="<?= CurrentPageUrl(false) ?>" method="post" novalidate autocomplete="off">
