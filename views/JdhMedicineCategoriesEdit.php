...
?>
<main class="edit">
<form name="fjdh_medicine_categoriesedit" id="fjdh_medicine_categoriesedit" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post" novalidate autocomplete="on">
<script>
...
<script>
loadjs.ready(["fjdh_medicine_categoriesedit", "editor"], function() {
    ew.createEditor("fjdh_medicine_categoriesedit", "x_category_description", 35, 4, <?= $Page->category_description->ReadOnly || false ? "true" : "false" ?>);
});
</script>
</span>
</div></div>
