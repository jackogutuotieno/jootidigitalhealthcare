...
?>
<main class="view">
<form name="fjdh_medicine_stockview" id="fjdh_medicine_stockview" class="ew-form ew-view-form overlay-wrapper" action="<?= CurrentPageUrl(false) ?>" method="post" novalidate autocomplete="off">
<?php if (!$Page->isExport()) { ?>
<script>
