...
?>
<main class="view">
<form name="fjdh_audittrailview" id="fjdh_audittrailview" class="ew-form ew-view-form overlay-wrapper" action="<?= CurrentPageUrl(false) ?>" method="post" novalidate autocomplete="on">
<?php if (!$Page->isExport()) { ?>
<script>
