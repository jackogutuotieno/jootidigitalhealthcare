...
?>
<main class="view">
<form name="fjdh_audittrailview" id="fjdh_audittrailview" class="ew-form ew-view-form overlay-wrapper" action="<?= CurrentPageUrl(false) ?>" method="post" novalidate autocomplete="off">
<?php if (!$Page->isExport()) { ?>
<script>
...
<?php if ($Page->Id->Visible) { // Id ?>
    <tr id="r_Id"<?= $Page->Id->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_jdh_audittrail_Id"><?= $Page->Id->caption() ?></span></td>
        <td data-name="Id"<?= $Page->Id->cellAttributes() ?>>
<span id="el_jdh_audittrail_Id">
...
<?php if ($Page->DateTime->Visible) { // DateTime ?>
    <tr id="r_DateTime"<?= $Page->DateTime->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_jdh_audittrail_DateTime"><?= $Page->DateTime->caption() ?></span></td>
...
<?php if ($Page->Script->Visible) { // Script ?>
    <tr id="r_Script"<?= $Page->Script->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_jdh_audittrail_Script"><?= $Page->Script->caption() ?></span></td>
...
<?php if ($Page->User->Visible) { // User ?>
    <tr id="r_User"<?= $Page->User->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_jdh_audittrail_User"><?= $Page->User->caption() ?></span></td>
...
<?php if ($Page->_Action->Visible) { // Action ?>
    <tr id="r__Action"<?= $Page->_Action->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_jdh_audittrail__Action"><?= $Page->_Action->caption() ?></span></td>
...
<?php if ($Page->_Table->Visible) { // Table ?>
    <tr id="r__Table"<?= $Page->_Table->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_jdh_audittrail__Table"><?= $Page->_Table->caption() ?></span></td>
...
<?php if ($Page->Field->Visible) { // Field ?>
    <tr id="r_Field"<?= $Page->Field->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_jdh_audittrail_Field"><?= $Page->Field->caption() ?></span></td>
...
<?php if ($Page->KeyValue->Visible) { // KeyValue ?>
    <tr id="r_KeyValue"<?= $Page->KeyValue->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_jdh_audittrail_KeyValue"><?= $Page->KeyValue->caption() ?></span></td>
...
<?php if ($Page->OldValue->Visible) { // OldValue ?>
    <tr id="r_OldValue"<?= $Page->OldValue->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_jdh_audittrail_OldValue"><?= $Page->OldValue->caption() ?></span></td>
...
<?php if ($Page->NewValue->Visible) { // NewValue ?>
    <tr id="r_NewValue"<?= $Page->NewValue->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_jdh_audittrail_NewValue"><?= $Page->NewValue->caption() ?></span></td>
