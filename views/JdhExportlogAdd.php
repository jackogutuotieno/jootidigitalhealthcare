...
$Page->showMessage();
?>
<form name="fjdh_exportlogadd" id="fjdh_exportlogadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post" novalidate autocomplete="off">
...
loadjs.ready(["fjdh_exportlogadd", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("fjdh_exportlogadd", "x_DateTime", ew.deepAssign({"useCurrent":false,"display":{"sideBySide":false}}, options));
});
</script>
<?php } ?>
</span>
