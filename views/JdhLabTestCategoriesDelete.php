...
$Page->showMessage();
?>
<form name="fjdh_lab_test_categoriesdelete" id="fjdh_lab_test_categoriesdelete" class="ew-form ew-delete-form" action="<?= CurrentPageUrl(false) ?>" method="post" novalidate autocomplete="on">
