...
var currentForm;
var fjdh_service_categorydelete;
loadjs.ready(["wrapper", "head"], function () {
    ...
    let form = new ew.FormBuilder()
        .setId("fjdh_service_categorydelete")
        .setPageId("delete")
        .build();
    window[form.id] = form;
    currentForm = form;
...
<?php if ($Page->category_id->Visible) { // category_id ?>
        <th class="<?= $Page->category_id->headerCellClass() ?>"><span id="elh_jdh_service_category_category_id" class="jdh_service_category_category_id"><?= $Page->category_id->caption() ?></span></th>
<?php } ?>
<?php if ($Page->category_name->Visible) { // category_name ?>
        <th class="<?= $Page->category_name->headerCellClass() ?>"><span id="elh_jdh_service_category_category_name" class="jdh_service_category_category_name"><?= $Page->category_name->caption() ?></span></th>
<?php } ?>
    </tr>
    </thead>
    <tbody>
