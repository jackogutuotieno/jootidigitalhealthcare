...
// Page object
$JdhEmployeeCredentialsAdd = &$Page;
?>
<script>
...
var currentForm;
var fjdh_employee_credentialsadd;
loadjs.ready(["wrapper", "head"], function () {
    ...
    let form = new ew.FormBuilder()
        .setId("fjdh_employee_credentialsadd")
        .setPageId("add")
...
$Page->showMessage();
?>
<form name="fjdh_employee_credentialsadd" id="fjdh_employee_credentialsadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post" novalidate autocomplete="on">
...
<input type="hidden" name="fa_x_academic_certificates" id= "fa_x_academic_certificates" value="0">
...
<input type="hidden" name="fa_x_professional_certifications" id= "fa_x_professional_certifications" value="0">
...
<?php } ?>
    ...
    <?php if (strval($Page->user_id->getSessionValue()) != "") { ?>
    <input type="hidden" name="x_user_id" id="x_user_id" value="<?= HtmlEncode(strval($Page->user_id->getSessionValue())) ?>">
    <?php } ?>
<?= $Page->IsModal ? '<template class="ew-modal-buttons">' : '<div class="row ew-buttons">' ?><!-- buttons .row -->
    <div class="<?= $Page->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ew-btn" name="btn-action" id="btn-action" type="submit" form="fjdh_employee_credentialsadd"><?= $Language->phrase("AddBtn") ?></button>
<?php if (IsJsonResponse()) { ?>
<button class="btn btn-default ew-btn" name="btn-cancel" id="btn-cancel" type="button" data-bs-dismiss="modal"><?= $Language->phrase("CancelBtn") ?></button>
<?php } else { ?>
<button class="btn btn-default ew-btn" name="btn-cancel" id="btn-cancel" type="button" form="fjdh_employee_credentialsadd" data-href="<?= HtmlEncode(GetUrl($Page->getReturnUrl())) ?>"><?= $Language->phrase("CancelBtn") ?></button>
<?php } ?>
    </div><!-- /buttons offset -->
