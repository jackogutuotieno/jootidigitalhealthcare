...
<?php if ($Page->user_id->Visible) { // user_id ?>
        <th data-name="user_id" class="<?= $Page->user_id->headerCellClass() ?>"><div id="elh_jdh_users_user_id" class="jdh_users_user_id"><?= $Page->renderFieldHeader($Page->user_id) ?></div></th>
<?php } ?>
