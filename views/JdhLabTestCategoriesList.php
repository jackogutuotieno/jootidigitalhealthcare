...
<?php } ?>
<?php if (!$Page->IsModal) { ?>
<form name="fjdh_lab_test_categoriessrch" id="fjdh_lab_test_categoriessrch" class="ew-form ew-ext-search-form" action="<?= CurrentPageUrl(false) ?>" novalidate autocomplete="off">
<div id="fjdh_lab_test_categoriessrch_search_panel" class="mb-2 mb-sm-0 <?= $Page->SearchPanelClass ?>"><!-- .ew-search-panel -->
<script>
var currentTable = <?= JsonEncode($Page->toClientVar()) ?>;
ew.deepAssign(ew.vars, { tables: { jdh_lab_test_categories: currentTable } });
var currentForm;
var fjdh_lab_test_categoriessrch, currentSearchForm, currentAdvancedSearchForm;
loadjs.ready(["wrapper", "head"], function () {
    let $ = jQuery,
    ...
    let form = new ew.FormBuilder()
        .setId("fjdh_lab_test_categoriessrch")
        .setPageId("list")
...
<?php } ?>
<div id="gmp_jdh_lab_test_categories" class="card-body ew-grid-middle-panel <?= $Page->TableContainerClass ?>" style="<?= $Page->TableContainerStyle ?>">
<?php if ($Page->TotalRecords > 0 || $Page->isGridEdit() || $Page->isMultiEdit()) { ?>
<table id="tbl_jdh_lab_test_categorieslist" class="<?= $Page->TableClass ?>"><!-- .ew-table -->
<thead>
...
<?php if ($Page->test_category_id->Visible) { // test_category_id ?>
        <th data-name="test_category_id" class="<?= $Page->test_category_id->headerCellClass() ?>"><div id="elh_jdh_lab_test_categories_test_category_id" class="jdh_lab_test_categories_test_category_id"><?= $Page->renderFieldHeader($Page->test_category_id) ?></div></th>
<?php } ?>
<?php if ($Page->test_category_name->Visible) { // test_category_name ?>
        <th data-name="test_category_name" class="<?= $Page->test_category_name->headerCellClass() ?>"><div id="elh_jdh_lab_test_categories_test_category_name" class="jdh_lab_test_categories_test_category_name"><?= $Page->renderFieldHeader($Page->test_category_name) ?></div></th>
<?php } ?>
<?php
...
<span id="el<?= $Page->RowIndex == '$rowindex$' ? '$rowindex$' : $Page->RowCount ?>_jdh_lab_test_categories_test_category_id" class="el_jdh_lab_test_categories_test_category_id">
...
<span id="el<?= $Page->RowIndex == '$rowindex$' ? '$rowindex$' : $Page->RowCount ?>_jdh_lab_test_categories_test_category_name" class="el_jdh_lab_test_categories_test_category_name">
