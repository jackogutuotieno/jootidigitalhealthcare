...
<form name="fjdh_lab_test_categoriessrch" id="fjdh_lab_test_categoriessrch" class="ew-form ew-ext-search-form" action="<?= CurrentPageUrl(false) ?>" novalidate autocomplete="on">
...
<span id="el<?= $Page->RowCount ?>_jdh_lab_test_categories_test_category_id" class="el_jdh_lab_test_categories_test_category_id">
...
<span id="el<?= $Page->RowCount ?>_jdh_lab_test_categories_test_category_name" class="el_jdh_lab_test_categories_test_category_name">
