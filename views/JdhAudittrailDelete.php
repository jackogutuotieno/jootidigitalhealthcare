...
$Page->showMessage();
?>
<form name="fjdh_audittraildelete" id="fjdh_audittraildelete" class="ew-form ew-delete-form" action="<?= CurrentPageUrl(false) ?>" method="post" novalidate autocomplete="off">
