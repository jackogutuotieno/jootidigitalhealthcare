...
<?php } ?>
<?php if (!$Page->IsModal) { ?>
<form name="fjdh_consultation_incomesrch" id="fjdh_consultation_incomesrch" class="ew-form ew-ext-search-form" action="<?= CurrentPageUrl(false) ?>" novalidate autocomplete="off">
...
<span id="el<?= $Page->RowIndex == '$rowindex$' ? '$rowindex$' : $Page->RowCount ?>_jdh_consultation_income_patient_id" class="el_jdh_consultation_income_patient_id">
...
<span id="el<?= $Page->RowIndex == '$rowindex$' ? '$rowindex$' : $Page->RowCount ?>_jdh_consultation_income_first_name" class="el_jdh_consultation_income_first_name">
...
<span id="el<?= $Page->RowIndex == '$rowindex$' ? '$rowindex$' : $Page->RowCount ?>_jdh_consultation_income_last_name" class="el_jdh_consultation_income_last_name">
...
<span id="el<?= $Page->RowIndex == '$rowindex$' ? '$rowindex$' : $Page->RowCount ?>_jdh_consultation_income_service_cost" class="el_jdh_consultation_income_service_cost">
