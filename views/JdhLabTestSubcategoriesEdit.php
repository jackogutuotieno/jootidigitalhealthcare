...
?>
<main class="edit">
<form name="fjdh_lab_test_subcategoriesedit" id="fjdh_lab_test_subcategoriesedit" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post" novalidate autocomplete="on">
<script>
