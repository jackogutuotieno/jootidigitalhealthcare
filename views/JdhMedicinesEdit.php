...
?>
<main class="edit">
<form name="fjdh_medicinesedit" id="fjdh_medicinesedit" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post" novalidate autocomplete="off">
<script>
...
loadjs.ready(["fjdh_medicinesedit", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("fjdh_medicinesedit", "x_expiry", ew.deepAssign({"useCurrent":false,"display":{"sideBySide":false}}, options));
});
</script>
<?php } ?>
</span>
