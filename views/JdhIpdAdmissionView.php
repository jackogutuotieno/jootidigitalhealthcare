...
?>
<main class="view">
<form name="fjdh_ipd_admissionview" id="fjdh_ipd_admissionview" class="ew-form ew-view-form overlay-wrapper" action="<?= CurrentPageUrl(false) ?>" method="post" novalidate autocomplete="on">
<?php if (!$Page->isExport()) { ?>
<script>
