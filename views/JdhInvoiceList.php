...
<?php } ?>
<?php if (!$Page->IsModal) { ?>
<form name="fjdh_invoicesrch" id="fjdh_invoicesrch" class="ew-form ew-ext-search-form" action="<?= CurrentPageUrl(false) ?>" novalidate autocomplete="off">
...
<span id="el<?= $Page->RowIndex == '$rowindex$' ? '$rowindex$' : $Page->RowCount ?>_jdh_invoice_id" class="el_jdh_invoice_id">
...
<span id="el<?= $Page->RowIndex == '$rowindex$' ? '$rowindex$' : $Page->RowCount ?>_jdh_invoice_patient_id" class="el_jdh_invoice_patient_id">
...
<span id="el<?= $Page->RowIndex == '$rowindex$' ? '$rowindex$' : $Page->RowCount ?>_jdh_invoice_invoice_title" class="el_jdh_invoice_invoice_title">
...
<span id="el<?= $Page->RowIndex == '$rowindex$' ? '$rowindex$' : $Page->RowCount ?>_jdh_invoice_invoice_date" class="el_jdh_invoice_invoice_date">
