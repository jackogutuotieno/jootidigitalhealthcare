...
$sideMenu->addMenuItem(293, "mi_jdh_invoice", $MenuLanguage->MenuPhrase("293", "MenuText"), $MenuRelativePath . "jdhinvoicelist", 60, "", AllowListMenu('{EDB02539-D193-4081-B8F6-DEFFEAE24230}jdh_invoice'), false, false, "fa-money", "", false, true);
$sideMenu->addMenuItem(294, "mi_jdh_invoice_items", $MenuLanguage->MenuPhrase("294", "MenuText"), $MenuRelativePath . "jdhinvoiceitemslist?cmd=resetall", 60, "", AllowListMenu('{EDB02539-D193-4081-B8F6-DEFFEAE24230}jdh_invoice_items'), false, false, "fa-money", "", false, true);
