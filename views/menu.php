...
$sideMenu->addMenuItem(14, "mi_jdh_services", $MenuLanguage->MenuPhrase("14", "MenuText"), $MenuRelativePath . "jdhserviceslist", -1, "", AllowListMenu('{EDB02539-D193-4081-B8F6-DEFFEAE24230}jdh_services'), false, false, "fa-file-circle-check", "", false, true);
$sideMenu->addMenuItem(12, "mi_jdh_service_category", $MenuLanguage->MenuPhrase("12", "MenuText"), $MenuRelativePath . "jdhservicecategorylist", 14, "", AllowListMenu('{EDB02539-D193-4081-B8F6-DEFFEAE24230}jdh_service_category'), false, false, "fa-file", "", false, true);
$sideMenu->addMenuItem(13, "mi_jdh_service_subcategory", $MenuLanguage->MenuPhrase("13", "MenuText"), $MenuRelativePath . "jdhservicesubcategorylist", 14, "", AllowListMenu('{EDB02539-D193-4081-B8F6-DEFFEAE24230}jdh_service_subcategory'), false, false, "fa-file", "", false, true);
...
$sideMenu->addMenuItem(23, "mi_jdh_patient_bill", $MenuLanguage->MenuPhrase("23", "MenuText"), $MenuRelativePath . "jdhpatientbilllist", 60, "", AllowListMenu('{EDB02539-D193-4081-B8F6-DEFFEAE24230}jdh_patient_bill'), false, false, "fa-money-bill-wave", "", false, true);
