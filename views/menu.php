...
$sideMenu->addMenuItem(102, "mci_Patients", $MenuLanguage->MenuPhrase("102", "MenuText"), "", -1, "", true, false, true, "fa-users", "", false, true);
...
$sideMenu->addMenuItem(104, "mi_jdh_chief_complaints", $MenuLanguage->MenuPhrase("104", "MenuText"), $MenuRelativePath . "jdhchiefcomplaintslist?cmd=resetall", 102, "", AllowListMenu('{EDB02539-D193-4081-B8F6-DEFFEAE24230}jdh_chief_complaints'), false, false, "fa-notes-medical", "", false, true);
...
$sideMenu->addMenuItem(11, "mi_jdh_prescriptions", $MenuLanguage->MenuPhrase("11", "MenuText"), $MenuRelativePath . "jdhprescriptionslist", 102, "", AllowListMenu('{EDB02539-D193-4081-B8F6-DEFFEAE24230}jdh_prescriptions'), false, false, "fa-file-prescription", "", false, true);
$sideMenu->addMenuItem(37, "mci_Laboratory", $MenuLanguage->MenuPhrase("37", "MenuText"), "", -1, "", IsLoggedIn(), false, true, "fa-flask", "", false, true);
...
$sideMenu->addMenuItem(103, "mi_jdh_test_costs", $MenuLanguage->MenuPhrase("103", "MenuText"), $MenuRelativePath . "jdhtestcostslist", 37, "", AllowListMenu('{EDB02539-D193-4081-B8F6-DEFFEAE24230}jdh_test_costs'), false, false, "fa-dollar-sign", "", false, true);
...
$sideMenu->addMenuItem(16, "mi_jdh_test_reports", $MenuLanguage->MenuPhrase("16", "MenuText"), $MenuRelativePath . "jdhtestreportslist", 37, "", AllowListMenu('{EDB02539-D193-4081-B8F6-DEFFEAE24230}jdh_test_reports'), false, false, "fa-file-medical", "", false, true);
$sideMenu->addMenuItem(68, "mci_Pharmacy", $MenuLanguage->MenuPhrase("68", "MenuText"), "", -1, "", true, false, true, "fa-suitcase-medical", "", false, true);
...
$sideMenu->addMenuItem(6, "mi_jdh_medicine_subcategories", $MenuLanguage->MenuPhrase("6", "MenuText"), $MenuRelativePath . "jdhmedicinesubcategorieslist", 68, "", AllowListMenu('{EDB02539-D193-4081-B8F6-DEFFEAE24230}jdh_medicine_subcategories'), false, false, "fa-pills", "", false, true);
...
$sideMenu->addMenuItem(14, "mi_jdh_services", $MenuLanguage->MenuPhrase("14", "MenuText"), $MenuRelativePath . "jdhserviceslist", -1, "", AllowListMenu('{EDB02539-D193-4081-B8F6-DEFFEAE24230}jdh_services'), false, false, "", "", false, true);
$sideMenu->addMenuItem(12, "mi_jdh_service_category", $MenuLanguage->MenuPhrase("12", "MenuText"), $MenuRelativePath . "jdhservicecategorylist", 14, "", AllowListMenu('{EDB02539-D193-4081-B8F6-DEFFEAE24230}jdh_service_category'), false, false, "", "", false, true);
$sideMenu->addMenuItem(13, "mi_jdh_service_subcategory", $MenuLanguage->MenuPhrase("13", "MenuText"), $MenuRelativePath . "jdhservicesubcategorylist", 14, "", AllowListMenu('{EDB02539-D193-4081-B8F6-DEFFEAE24230}jdh_service_subcategory'), false, false, "", "", false, true);
$sideMenu->addMenuItem(60, "mci_Financials", $MenuLanguage->MenuPhrase("60", "MenuText"), "", -1, "", IsLoggedIn(), false, true, "", "", false, true);
$sideMenu->addMenuItem(30, "mi_jdh_insurance", $MenuLanguage->MenuPhrase("30", "MenuText"), $MenuRelativePath . "jdhinsurancelist", 60, "", AllowListMenu('{EDB02539-D193-4081-B8F6-DEFFEAE24230}jdh_insurance'), false, false, "", "", false, true);
$sideMenu->addMenuItem(23, "mi_jdh_patient_bill", $MenuLanguage->MenuPhrase("23", "MenuText"), $MenuRelativePath . "jdhpatientbilllist", 60, "", AllowListMenu('{EDB02539-D193-4081-B8F6-DEFFEAE24230}jdh_patient_bill'), false, false, "", "", false, true);
$sideMenu->addMenuItem(24, "mi_jdh_patient_services", $MenuLanguage->MenuPhrase("24", "MenuText"), $MenuRelativePath . "jdhpatientserviceslist", 60, "", AllowListMenu('{EDB02539-D193-4081-B8F6-DEFFEAE24230}jdh_patient_services'), false, false, "", "", false, true);
