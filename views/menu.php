...
$sideMenu->addMenuItem(279, "mi_jdh_patient_queue", $MenuLanguage->MenuPhrase("279", "MenuText"), $MenuRelativePath . "jdhpatientqueuelist", 102, "", AllowListMenu('{EDB02539-D193-4081-B8F6-DEFFEAE24230}jdh_patient_queue'), false, false, "", "", false, true);
...
$sideMenu->addMenuItem(282, "mi_jdh_wards", $MenuLanguage->MenuPhrase("282", "MenuText"), $MenuRelativePath . "jdhwardslist", 102, "", AllowListMenu('{EDB02539-D193-4081-B8F6-DEFFEAE24230}jdh_wards'), false, false, "", "", false, true);
$sideMenu->addMenuItem(281, "mi_jdh_rooms", $MenuLanguage->MenuPhrase("281", "MenuText"), $MenuRelativePath . "jdhroomslist", 102, "", AllowListMenu('{EDB02539-D193-4081-B8F6-DEFFEAE24230}jdh_rooms'), false, false, "", "", false, true);
$sideMenu->addMenuItem(283, "mi_beds", $MenuLanguage->MenuPhrase("283", "MenuText"), $MenuRelativePath . "bedslist", 102, "", AllowListMenu('{EDB02539-D193-4081-B8F6-DEFFEAE24230}beds'), false, false, "", "", false, true);
$sideMenu->addMenuItem(284, "mi_jdh_beds_assignment", $MenuLanguage->MenuPhrase("284", "MenuText"), $MenuRelativePath . "jdhbedsassignmentlist?cmd=resetall", 102, "", AllowListMenu('{EDB02539-D193-4081-B8F6-DEFFEAE24230}jdh_beds_assignment'), false, false, "", "", false, true);
...
$sideMenu->addMenuItem(17, "mi_jdh_test_requests", $MenuLanguage->MenuPhrase("17", "MenuText"), $MenuRelativePath . "jdhtestrequestslist", 37, "", AllowListMenu('{EDB02539-D193-4081-B8F6-DEFFEAE24230}jdh_test_requests'), false, false, "fa-file-waveform", "", false, true);
...
$sideMenu->addMenuItem(278, "mi_jdh_lab_income", $MenuLanguage->MenuPhrase("278", "MenuText"), $MenuRelativePath . "jdhlabincomelist", 190, "", AllowListMenu('{EDB02539-D193-4081-B8F6-DEFFEAE24230}jdh_lab_income'), false, false, "", "", false, true);
$sideMenu->addMenuItem(280, "mi_Patient_Queues", $MenuLanguage->MenuPhrase("280", "MenuText"), $MenuRelativePath . "patientqueues", 190, "", AllowListMenu('{EDB02539-D193-4081-B8F6-DEFFEAE24230}Patient Queues'), false, false, "", "", false, true);
