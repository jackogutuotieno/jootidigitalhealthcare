...
$sideMenu->addMenuItem(282, "mi_jdh_wards", $MenuLanguage->MenuPhrase("282", "MenuText"), $MenuRelativePath . "jdhwardslist", 38, "", AllowListMenu('{EDB02539-D193-4081-B8F6-DEFFEAE24230}jdh_wards'), false, false, "", "", false, true);
$sideMenu->addMenuItem(281, "mi_jdh_rooms", $MenuLanguage->MenuPhrase("281", "MenuText"), $MenuRelativePath . "jdhroomslist", 38, "", AllowListMenu('{EDB02539-D193-4081-B8F6-DEFFEAE24230}jdh_rooms'), false, false, "", "", false, true);
$sideMenu->addMenuItem(284, "mi_jdh_beds_assignment", $MenuLanguage->MenuPhrase("284", "MenuText"), $MenuRelativePath . "jdhbedsassignmentlist", 38, "", AllowListMenu('{EDB02539-D193-4081-B8F6-DEFFEAE24230}jdh_beds_assignment'), false, false, "", "", false, true);
$sideMenu->addMenuItem(283, "mi_beds", $MenuLanguage->MenuPhrase("283", "MenuText"), $MenuRelativePath . "bedslist", 38, "", AllowListMenu('{EDB02539-D193-4081-B8F6-DEFFEAE24230}beds'), false, false, "", "", false, true);
