...
<?php } ?>
<?php if (!$Page->IsModal) { ?>
<form name="fjdh_pharmacy_incomesrch" id="fjdh_pharmacy_incomesrch" class="ew-form ew-ext-search-form" action="<?= CurrentPageUrl(false) ?>" novalidate autocomplete="off">
...
<span id="el<?= $Page->RowIndex == '$rowindex$' ? '$rowindex$' : $Page->RowCount ?>_jdh_pharmacy_income_patient_id" class="el_jdh_pharmacy_income_patient_id">
...
<span id="el<?= $Page->RowIndex == '$rowindex$' ? '$rowindex$' : $Page->RowCount ?>_jdh_pharmacy_income_patient_name" class="el_jdh_pharmacy_income_patient_name">
...
<span id="el<?= $Page->RowIndex == '$rowindex$' ? '$rowindex$' : $Page->RowCount ?>_jdh_pharmacy_income_name" class="el_jdh_pharmacy_income_name">
...
<span id="el<?= $Page->RowIndex == '$rowindex$' ? '$rowindex$' : $Page->RowCount ?>_jdh_pharmacy_income_selling_price" class="el_jdh_pharmacy_income_selling_price">
...
<span id="el<?= $Page->RowIndex == '$rowindex$' ? '$rowindex$' : $Page->RowCount ?>_jdh_pharmacy_income_units_given" class="el_jdh_pharmacy_income_units_given">
...
<span id="el<?= $Page->RowIndex == '$rowindex$' ? '$rowindex$' : $Page->RowCount ?>_jdh_pharmacy_income_line_total_cost" class="el_jdh_pharmacy_income_line_total_cost">
