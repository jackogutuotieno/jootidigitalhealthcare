...
?>
<main class="view">
<form name="fjdh_lab_test_categoriesview" id="fjdh_lab_test_categoriesview" class="ew-form ew-view-form overlay-wrapper" action="<?= CurrentPageUrl(false) ?>" method="post" novalidate autocomplete="off">
<?php if (!$Page->isExport()) { ?>
<script>
