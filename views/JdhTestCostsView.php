...
?>
<main class="view">
<form name="fjdh_test_costsview" id="fjdh_test_costsview" class="ew-form ew-view-form overlay-wrapper" action="<?= CurrentPageUrl(false) ?>" method="post" novalidate autocomplete="on">
<?php if (!$Page->isExport()) { ?>
<script>
...
<?php if ($Page->test_id->Visible) { // test_id ?>
    <tr id="r_test_id"<?= $Page->test_id->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_jdh_test_costs_test_id"><?= $Page->test_id->caption() ?></span></td>
...
<?php if ($Page->test_category_id->Visible) { // test_category_id ?>
    <tr id="r_test_category_id"<?= $Page->test_category_id->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_jdh_test_costs_test_category_id"><?= $Page->test_category_id->caption() ?></span></td>
...
<?php if ($Page->test_subcategory_id->Visible) { // test_subcategory_id ?>
    <tr id="r_test_subcategory_id"<?= $Page->test_subcategory_id->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_jdh_test_costs_test_subcategory_id"><?= $Page->test_subcategory_id->caption() ?></span></td>
...
<?php if ($Page->test_cost->Visible) { // test_cost ?>
    <tr id="r_test_cost"<?= $Page->test_cost->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_jdh_test_costs_test_cost"><?= $Page->test_cost->caption() ?></span></td>
...
<?php if ($Page->date_submitted->Visible) { // date_submitted ?>
    <tr id="r_date_submitted"<?= $Page->date_submitted->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_jdh_test_costs_date_submitted"><?= $Page->date_submitted->caption() ?></span></td>
        <td data-name="date_submitted"<?= $Page->date_submitted->cellAttributes() ?>>
<span id="el_jdh_test_costs_date_submitted">
...
<?php if ($Page->date_updated->Visible) { // date_updated ?>
    <tr id="r_date_updated"<?= $Page->date_updated->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_jdh_test_costs_date_updated"><?= $Page->date_updated->caption() ?></span></td>
        <td data-name="date_updated"<?= $Page->date_updated->cellAttributes() ?>>
<span id="el_jdh_test_costs_date_updated">
