...
$Page->showMessage();
?>
<form name="fjdh_medicine_categoriesadd" id="fjdh_medicine_categoriesadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post" novalidate autocomplete="off">
