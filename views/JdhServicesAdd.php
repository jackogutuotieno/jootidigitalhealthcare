...
$Page->showMessage();
?>
<form name="fjdh_servicesadd" id="fjdh_servicesadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post" novalidate autocomplete="on">
...
<script>
loadjs.ready(["fjdh_servicesadd", "editor"], function() {
    ew.createEditor("fjdh_servicesadd", "x_service_description", 35, 4, <?= $Page->service_description->ReadOnly || false ? "true" : "false" ?>);
});
</script>
</span>
</div></div>
