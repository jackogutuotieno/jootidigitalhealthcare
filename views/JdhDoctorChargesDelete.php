...
$Page->showMessage();
?>
<form name="fjdh_doctor_chargesdelete" id="fjdh_doctor_chargesdelete" class="ew-form ew-delete-form" action="<?= CurrentPageUrl(false) ?>" method="post" novalidate autocomplete="off">
