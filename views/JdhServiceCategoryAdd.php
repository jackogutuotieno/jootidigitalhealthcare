...
$Page->showMessage();
?>
<form name="fjdh_service_categoryadd" id="fjdh_service_categoryadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post" novalidate autocomplete="on">
...
<script>
loadjs.ready(["fjdh_service_categoryadd", "editor"], function() {
    ew.createEditor("fjdh_service_categoryadd", "x_category_description", 35, 4, <?= $Page->category_description->ReadOnly || false ? "true" : "false" ?>);
});
</script>
</span>
</div></div>
