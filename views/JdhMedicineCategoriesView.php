...
// Page object
$JdhMedicineCategoriesView = &$Page;
?>
...
?>
<main class="view">
<form name="fjdh_medicine_categoriesview" id="fjdh_medicine_categoriesview" class="ew-form ew-view-form overlay-wrapper" action="<?= CurrentPageUrl(false) ?>" method="post" novalidate autocomplete="off">
<?php if (!$Page->isExport()) { ?>
<script>
...
var currentForm;
var fjdh_medicine_categoriesview;
loadjs.ready(["wrapper", "head"], function () {
    ...
    let form = new ew.FormBuilder()
        .setId("fjdh_medicine_categoriesview")
        .setPageId("view")
        .build();
    window[form.id] = form;
    currentForm = form;
...
<?php if ($Page->category_id->Visible) { // category_id ?>
    <tr id="r_category_id"<?= $Page->category_id->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_jdh_medicine_categories_category_id"><?= $Page->category_id->caption() ?></span></td>
...
<?php if ($Page->category_name->Visible) { // category_name ?>
    <tr id="r_category_name"<?= $Page->category_name->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_jdh_medicine_categories_category_name"><?= $Page->category_name->caption() ?></span></td>
...
<?php if ($Page->category_description->Visible) { // category_description ?>
    <tr id="r_category_description"<?= $Page->category_description->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_jdh_medicine_categories_category_description"><?= $Page->category_description->caption() ?></span></td>
