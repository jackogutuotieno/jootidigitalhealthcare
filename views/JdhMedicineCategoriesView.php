...
?>
<main class="view">
<form name="fjdh_medicine_categoriesview" id="fjdh_medicine_categoriesview" class="ew-form ew-view-form overlay-wrapper" action="<?= CurrentPageUrl(false) ?>" method="post" novalidate autocomplete="on">
<?php if (!$Page->isExport()) { ?>
<script>
