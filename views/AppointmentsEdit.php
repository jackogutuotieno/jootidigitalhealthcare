...
?>
<main class="edit">
<form name="fAppointmentsedit" id="fAppointmentsedit" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post" novalidate autocomplete="on">
<script>
...
<input type="hidden" data-table="Appointments" data-field="x_appointment_id" data-hidden="1" name="x_appointment_id" id="x_appointment_id" value="<?= HtmlEncode($Page->appointment_id->CurrentValue) ?>">
</span>
</div></div>
    </div>
<?php } ?>
...
loadjs.ready(["fAppointmentsedit", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("fAppointmentsedit", "x_submission_date", jQuery.extend(true, {"useCurrent":false,"display":{"sideBySide":false}}, options));
});
</script>
<?php } ?>
</span>
...
loadjs.ready(["fAppointmentsedit", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("fAppointmentsedit", "x_appointment_end_date", jQuery.extend(true, {"useCurrent":false,"display":{"sideBySide":false}}, options));
});
</script>
<?php } ?>
</span>
...
loadjs.ready(["fAppointmentsedit", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("fAppointmentsedit", "x_appointment_start_date", jQuery.extend(true, {"useCurrent":false,"display":{"sideBySide":false}}, options));
});
</script>
<?php } ?>
</span>
...
<button class="btn btn-primary ew-btn" name="btn-action" id="btn-action" type="submit" form="fAppointmentsedit"><?= $Language->phrase("SaveBtn") ?></button>
<?php if (IsJsonResponse()) { ?>
<button class="btn btn-default ew-btn" name="btn-cancel" id="btn-cancel" type="button" data-bs-dismiss="modal"><?= $Language->phrase("CancelBtn") ?></button>
<?php } else { ?>
<button class="btn btn-default ew-btn" name="btn-cancel" id="btn-cancel" type="button" form="fAppointmentsedit" data-href="<?= HtmlEncode(GetUrl($Page->getReturnUrl())) ?>"><?= $Language->phrase("CancelBtn") ?></button>
<?php } ?>
    </div><!-- /buttons offset -->
