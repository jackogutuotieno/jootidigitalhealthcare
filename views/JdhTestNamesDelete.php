...
$Page->showMessage();
?>
<form name="fjdh_test_namesdelete" id="fjdh_test_namesdelete" class="ew-form ew-delete-form" action="<?= CurrentPageUrl(false) ?>" method="post" novalidate autocomplete="on">
...
<?php if ($Page->test_id->Visible) { // test_id ?>
        <th class="<?= $Page->test_id->headerCellClass() ?>"><span id="elh_jdh_test_names_test_id" class="jdh_test_names_test_id"><?= $Page->test_id->caption() ?></span></th>
<?php } ?>
<?php if ($Page->patient_id->Visible) { // patient_id ?>
        <th class="<?= $Page->patient_id->headerCellClass() ?>"><span id="elh_jdh_test_names_patient_id" class="jdh_test_names_patient_id"><?= $Page->patient_id->caption() ?></span></th>
<?php } ?>
<?php if ($Page->test_name->Visible) { // test_name ?>
        <th class="<?= $Page->test_name->headerCellClass() ?>"><span id="elh_jdh_test_names_test_name" class="jdh_test_names_test_name"><?= $Page->test_name->caption() ?></span></th>
<?php } ?>
<?php if ($Page->test_category_id->Visible) { // test_category_id ?>
        <th class="<?= $Page->test_category_id->headerCellClass() ?>"><span id="elh_jdh_test_names_test_category_id" class="jdh_test_names_test_category_id"><?= $Page->test_category_id->caption() ?></span></th>
<?php } ?>
<?php if ($Page->test_subcategory_id->Visible) { // test_subcategory_id ?>
        <th class="<?= $Page->test_subcategory_id->headerCellClass() ?>"><span id="elh_jdh_test_names_test_subcategory_id" class="jdh_test_names_test_subcategory_id"><?= $Page->test_subcategory_id->caption() ?></span></th>
<?php } ?>
<?php if ($Page->test_cost->Visible) { // test_cost ?>
        <th class="<?= $Page->test_cost->headerCellClass() ?>"><span id="elh_jdh_test_names_test_cost" class="jdh_test_names_test_cost"><?= $Page->test_cost->caption() ?></span></th>
<?php } ?>
<?php if ($Page->date_submitted->Visible) { // date_submitted ?>
        <th class="<?= $Page->date_submitted->headerCellClass() ?>"><span id="elh_jdh_test_names_date_submitted" class="jdh_test_names_date_submitted"><?= $Page->date_submitted->caption() ?></span></th>
<?php } ?>
<?php if ($Page->date_updated->Visible) { // date_updated ?>
        <th class="<?= $Page->date_updated->headerCellClass() ?>"><span id="elh_jdh_test_names_date_updated" class="jdh_test_names_date_updated"><?= $Page->date_updated->caption() ?></span></th>
<?php } ?>
    </tr>
    </thead>
    <tbody>
...
<?php } ?>
<?php if ($Page->test_name->Visible) { // test_name ?>
        <td<?= $Page->test_name->cellAttributes() ?>>
