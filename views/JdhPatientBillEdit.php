...
<span id="el_jdh_patient_bill_patient_id">
    <select
        ...
        data-select2-id="fjdh_patient_billedit_x_patient_id"
...
<script>
loadjs.ready("fjdh_patient_billedit", function() {
    var options = { name: "x_patient_id", selectId: "fjdh_patient_billedit_x_patient_id" },
        el = document.querySelector("select[data-select2-id='" + options.selectId + "']");
    options.closeOnSelect = !options.multiple;
    options.dropdownParent = el.closest("#ew-modal-dialog, #ew-add-opt-dialog");
    if (fjdh_patient_billedit.lists.patient_id?.lookupOptions.length) {
        options.data = { id: "x_patient_id", form: "fjdh_patient_billedit" };
    } else {
        options.ajax = { id: "x_patient_id", form: "fjdh_patient_billedit", limit: ew.LOOKUP_PAGE_SIZE };
    }
