...
?>
<main class="view">
<form name="fjdh_service_subcategoryview" id="fjdh_service_subcategoryview" class="ew-form ew-view-form overlay-wrapper" action="<?= CurrentPageUrl(false) ?>" method="post" novalidate autocomplete="on">
<?php if (!$Page->isExport()) { ?>
<script>
