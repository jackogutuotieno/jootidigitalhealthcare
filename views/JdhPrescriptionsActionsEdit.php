...
?>
<main class="edit">
<form name="fjdh_prescriptions_actionsedit" id="fjdh_prescriptions_actionsedit" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post" novalidate autocomplete="off">
<script>
