...
<textarea data-table="jdh_vitals" data-field="x_patient_status" name="x<?= $Page->RowIndex ?>_patient_status" id="x<?= $Page->RowIndex ?>_patient_status" cols="35" rows="4" placeholder="<?= HtmlEncode($Page->patient_status->getPlaceHolder()) ?>"<?= $Page->patient_status->editAttributes() ?>><?= $Page->patient_status->EditValue ?></textarea>
<div class="invalid-feedback"><?= $Page->patient_status->getErrorMessage() ?></div>
</span>
<input type="hidden" data-table="jdh_vitals" data-field="x_patient_status" data-hidden="1" data-old name="o<?= $Page->RowIndex ?>_patient_status" id="o<?= $Page->RowIndex ?>_patient_status" value="<?= HtmlEncode($Page->patient_status->OldValue) ?>">
<?php } ?>
<?php if ($Page->RowType == ROWTYPE_VIEW) { // View record ?>
<span id="el<?= $Page->RowCount ?>_jdh_vitals_patient_status" class="el_jdh_vitals_patient_status">
